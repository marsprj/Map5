GeoBeans.WMSStyleManager = GeoBeans.Class({
	name 		: "",
	server 		: null,
	styles 		: null,
	service 	: "ims",
	...
	readStyleType : function(type){
		...
		switch(type){
			case "point":
			styleType = GeoBeans.WMSStyle.FeatureStyle.GeomType.Point;
			break;
			case "linestring":
			styleType = GeoBeans.WMSStyle.FeatureStyle.GeomType.LineString;
			break;
			case "polygon":
			styleType = GeoBeans.WMSStyle.FeatureStyle.GeomType.Polygon;
			break;
			default:
			break;
		} 
