...
//	},
	...
	computeTileBound : function(){
		...
		var col_min = Math.floor((ve.xmin - this.FULL_EXTENT.xmin) / tile_map_size)-1;
		var col_max = Math.ceil ((ve.xmax - this.FULL_EXTENT.xmin) / tile_map_size)+1;
		var row_min = Math.floor((this.FULL_EXTENT.ymax - ve.ymax) / tile_map_size)-1;
		var row_max = Math.ceil ((this.FULL_EXTENT.ymax - ve.ymin) / tile_map_size)+1;
