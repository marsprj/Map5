GeoBeans.Layer.RangeSymbolChartLayer = GeoBeans.Class(GeoBeans.Layer.ChartLayer,{
	...
	cleanup : function(){
		this.rangeBaseLayerName = null;
		this.rangeBaseLayerField = null;
		this.rangeChartField = null;
		this.rangeOption = null;
		this.symbolBaseLayerName = null;
		this.symbolBaseLayerField = null;
		this.symbolChartField = null;
		this.symbolOption = null;
		this.style = null;
		this.maxSymbolRadius = null;
		this.levelMap = null;
	...
	load : function(){
		...
		if(this.flag == GeoBeans.Layer.Flag.READY){
			this.drawLegend();
		}else{
			this.decideDrawLegend();
		}
				...
				if(rbFieldValue == sbFieldValue){
					...
					for(var k = 0; k < tableFeatures.length;++k){
						...
						if(tFieldValue == rbFieldValue){
							...
							if(rMax == null){
								rMax = rChartFieldValue;
							}else{
								rMax = (rMax > rChartFieldValue) ? rMax : rChartFieldValue;rmax = rChartFieldValue;
							}
	...
	drawRangeLegend : function(){
		...
		var html = "<div class='chart-legend chart-legend-range-symbol' id='" + this.name 
	...
	setRangeBaseLayer : function(rangeBaseLayerName){
		if(rangeBaseLayerName != null && rangeBaseLayerName != this.rangeBaseLayerName){
			this.rangeBaseLayerName = rangeBaseLayerName;
			this.getFeatures();
	...
	setRangeBaseLayerField : function(rangeBaseLayerField){
		if(rangeBaseLayerField != null && rangeBaseLayerField != this.rangeBaseLayerField){
			this.rangeBaseLayerField = rangeBaseLayerField;
			this.getFeatures();
			this.flag = GeoBeans.Layer.Flag.READY;
		}
	...
	setSymbolBaseLayer : function(symbolBaseLayerName){
		if(symbolBaseLayerName != null && symbolBaseLayerName != this.symbolBaseLayerName){
			this.symbolBaseLayerName = symbolBaseLayerName;
			this.getFeatures();
			this.flag = GeoBeans.Layer.Flag.READY;
		}
	...
	setSymbolBaseLayerField : function(symbolBaseLayerField){
		if(symbolBaseLayerField != null && symbolBaseLayerField != this.symbolBaseLayerField){
			this.symbolBaseLayerField = symbolBaseLayerField;
			this.getFeatures();
			this.flag = GeoBeans.Layer.Flag.READY;
		}
	...
	setRangeChartField : function(rangeChartField){
		if(rangeChartField != null && rangeChartField != this.rangeChartField){
			this.rangeChartField = rangeChartField;
			this.getFeatures();
			this.flag = GeoBeans.Layer.Flag.READY;
		}
	...
	setSymbolChartField : function(symbolChartField){
		if(symbolChartField != null && symbolChartField != this.symbolChartField){
			this.symbolChartField = symbolChartField;
			this.getFeatures();
			this.flag = GeoBeans.Layer.Flag.READY;
		}
