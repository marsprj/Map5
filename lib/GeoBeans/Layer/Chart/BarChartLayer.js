GeoBeans.Layer.BarChartLayer = GeoBeans.Class(GeoBeans.Layer.ChartLayer,{
	...
	// initialize : function(name,chartFeatureType,chartFeatures,chartFields,chartOption){
	// 	GeoBeans.Layer.ChartLayer.prototype.initialize.apply(this, arguments);
	// 	this.chartFeatureType = chartFeatureType;
	...
	drawLayer : function(){
		// if(this.chartFeatures == null || this.features == null
		// 	|| this.chartFeatureType == null){
		// 	return;
		// }
		...
		// var geomFieldIndex = this.featureType.getFieldIndex(geomField);
		var geomtry = null;
		...
		for(var i = 0; i < this.chartFeatures.length; ++i){
			...
			option = {
						grid:{
					            // x  : this.chartOption.left   + 'px',
					            // y  : this.chartOption.top    + 'px',
					            // x2 : this.chartOption.right  + 'px',
					            // y2 : this.chartOption.bottom + 'px',	
            ...
            // var heightPadding = this.chartOption.top + this.chartOption.bottom;
