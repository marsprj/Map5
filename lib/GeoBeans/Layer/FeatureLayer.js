	...
	getDefaultStyle : function(){
		...
		switch(geomType){
			...
			case GeoBeans.Geometry.Type.MULTIPOINT:{
				style = new GeoBeans.WMSStyle.FeatureStyle("default",
					GeoBeans.WMSStyle.FeatureStyle.GeomType.Point);
			...
			case GeoBeans.Geometry.Type.MULTILINESTRING:{
				style = new GeoBeans.WMSStyle.FeatureStyle("default",
					GeoBeans.WMSStyle.FeatureStyle.GeomType.LineString);
				var rule = new GeoBeans.Rule();
			...
			case GeoBeans.Geometry.Type.MULTIPOLYGON:{
				style = new GeoBeans.WMSStyle.FeatureStyle("default",
					GeoBeans.WMSStyle.FeatureStyle.GeomType.Polygon);
				var rule = new GeoBeans.Rule();
