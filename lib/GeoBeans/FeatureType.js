GeoBeans.FeatureType = GeoBeans.Class({
	...
	getFields : function(callback){
		...
		var params = "service=" + this.workspace.service + "&version=" + this.workspace.version + "&request=describeFeatureType" + "&typeName=" + this.name;
	...
	getFeatures : function(callback){
		...
		var params = "service=" + this.workspace.service + "&version=" + this.workspace.version + "&request=getFeature" + "&typeName=" + this.name;
	...
	getFeaturesBBox : function(callback,viewer){
