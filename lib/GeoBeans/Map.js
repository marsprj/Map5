...
GeoBeans.Map = GeoBeans.Class({
	...
	initialize: function (server,id,name,extent,srid) {
		...
		// //queryCanvas
		// this.queryCanvas = document.createElement("canvas");
		// this.queryCanvas.height = this.height;
		// this.queryCanvas.width = this.width;
		// this.queryRenderer = new GeoBeans.Renderer(this.queryCanvas);
