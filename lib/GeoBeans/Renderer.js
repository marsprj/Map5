GeoBeans.Renderer = GeoBeans.Class({
	...
	/*	Draw Geometry											*/
	/************************************************************/
	clear : function(geometry, fill_color, transformation){
		
		switch(geometry.type){
		case GeoBeans.Geometry.Type.POINT:
			this.clearPoint(geometry,fill_color, transformation);
			break;
		case GeoBeans.Geometry.Type.MULTIPOINT:
			this.clearMultiPoint(geometry,fill_color, transformation);
			break;
		case GeoBeans.Geometry.Type.LINESTRING:
	...
	clearPoint : function(point, symbolizer, transformation){
		var spt;
		var r = symbolizer.size;
	...
	clearLineString : function(line, symbolizer, transformation){
...
//		context.closePath();
	...
	clearMultiPoint : function(geometry,fill_color, transformation){
		points = geometry.points;
		
		var pt = null;
		for(var i=0, len=points.length; i<len; i++){
			pt = points[i];
			this.clearPoint(pt, symbolizer,transformation);
		}
	},
