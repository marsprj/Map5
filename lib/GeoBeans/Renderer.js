...
//	},
	...
	drawTip : function(point,text,transformation,rule){
		if(point == null || transformation == null || text == null
			|| rule == null){
			return;
		}
		...
		context.lineTo(point_4_1.x,point_4_1.y);
		context.arcTo(point_4.x,point_4.y,point_4_2.x,point_4_2.y,arc);
		...
		var textPos_y = point_s.y - space - 4;
