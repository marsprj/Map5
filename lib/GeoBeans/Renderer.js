GeoBeans.Renderer = GeoBeans.Class({
	...
	drawPolygon : function(polygon, symbolizer, transformation){
		...
		// 		}
		// 	}else{
		// 		var clockwise_2 = GeoBeans.Utility._getClockDirection(ring.points);
		// 		if(clockwise_2 == clockwise){
		...
		// 	clockwise = GeoBeans.Utility._getClockDirection(ring.points);
		// }
