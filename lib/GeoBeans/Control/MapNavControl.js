		...
		var onMouseDown = function(evt){
			...
			var onMouseMove = function(evt){
				...
				if(sliderDragging){
					...
					// if(topMove < 0){
					// 	$(".map-nav-zoom-slider-bar").css("top","0px");	
					// 	$(".map-nav-zoom-slider-bottom").css("top","0px");
					// 	$(".map-nav-zoom-slider-bottom").css("height",sliderHeight + "px");
					// }else if(topMove > $(".map-nav-zoom-slider").height()){
					// 	$(".map-nav-zoom-slider-bar").css("top",$(".map-nav-zoom-slider").height() + "px");	
					// 	$(".map-nav-zoom-slider-bottom").css("top",$(".map-nav-zoom-slider").height() + "px");
					// 	$(".map-nav-zoom-slider-bottom").css("height","0px");
					// }else{
