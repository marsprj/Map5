...
GeoBeans.Layer.RangeChartLayer=GeoBeans.Class(GeoBeans.Layer.ChartLayer,{chartOption:null,style:null,styleMgr:null,colors:null,minMaxValue:null,labelLayerName:null,labelLayerField:null,changeLegend:!0,initialize:function(e,t,a,l,r,i,n,s,o,h){GeoBeans.Layer.ChartLayer.prototype.initialize.apply(this,arguments),this.chartOption=s,this.type=GeoBeans.Layer.ChartLayer.Type.RANGE,this.labelLayerName=o,this.labelLayerField=h},cleanup:function(){GeoBeans.Layer.ChartLayer.prototype.cleanup.apply(this,arguments),this.unRegisterHitEvent()},setVisiable:function(e){GeoBeans.Layer.prototype.setVisiable.apply(this,arguments),this.visible?null==this.hitEvent&&this.registerHitEvent(this.onFeatureHit):null!=this.hitEvent&&this.unRegisterHitEvent()},setChartOption:function(e){GeoBeans.Layer.ChartLayer.prototype.setChartOption.apply(this,arguments),this.style=this.getStyle(),this.changeLegend=!0,this.flag=GeoBeans.Layer.Flag.READY},setChartFields:function(e){this.chartFields=e,this.changeLegend=!0},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments),this.getFeatures();var t=this.map.server.slice(0,this.map.server.lastIndexOf("/mgr"));this.styleMgr=new GeoBeans.StyleManager(t),this.registerHitEvent(this.onFeatureHit)},onFeatureHit:function(e,t,a){if(console.log(t.length),"pointer"==document.body.style.cursor)return void e.map.closeInfoWindow();if(0==t.length)e.map.closeInfoWindow();else{var l=t[0],r=l.chartValue,i=e.featureType;if(null==i)return;var n=l.values;if(null==n)return;var s=i.getFieldIndex(e.baseLayerField),o=n[s];null==r&&(r="空");var h="<div>"+r+"</div>",u={title:o,width:100,height:40},c=new GeoBeans.InfoWindow(h,u);e.map.openInfoWindow(c,a)}},getChartFeatureValue:function(e){for(var t=this.chartFields[0],a=this.chartFeatureType.getFieldIndex(t),l=this.tableField,r=this.chartFeatureType.getFieldIndex(l),i=null,n=0;n<this.chartFeatures.length;++n)if(i=this.chartFeatures[n],null!=i){var s=i.gid;if(s==e){var o=i.values;if(null!=o){var h=o[a],u=o[r];return{value:h,table:u}}}}return""},load:function(){var e=this.map.viewer;if(null!=e&&null!=this.viewer&&e.equal(this.viewer)&&null!=this.features&&this.flag==GeoBeans.Layer.Flag.LOADED)return void this.drawLegend();this.viewer=new GeoBeans.Envelope(e.xmin,e.ymin,e.xmax,e.ymax),null==this.style&&(this.style=this.getStyle());var t=this;t.flag=GeoBeans.Layer.Flag.READY,t.setTransformation(t.map.transformation),t.drawLayerSnap(),t.drawLegend(),t.renderer.clearRect();new Date;t.drawLayer(),t.flag=GeoBeans.Layer.Flag.LOADED},drawLegend:function(){this.changeLegend&&(this.removeLegend(),this.addLegend(),this.changeLegend=!1)},addLegend:function(){if(null!=this.minMaxValue&&null!=this.minMaxValue.min&&null!=this.minMaxValue.max){var e="",t=this.map.mapDiv.find(".chart-legend"),a=0;if(t.length>0){var l=t.last(),r=l.css("left"),i=l.css("width");r=parseInt(r.replace("px","")),i=parseInt(i.replace("px","")),a=r+i+5}else a=10;var e="<div class='chart-legend chart-legend-range' id='"+this.name+"' style='left:"+a+"px'>";e+="<div class='chart-legend-title'><h5>"+this.chartFields[0]+"</h5></div>",e+="<div class='chart-legend-canvas'>	<canvas width='20' height='200'></canvas></div><div class='chart-legend-value'><div class='chart-legend-max'>"+this.minMaxValue.max+"</div><div class='chart-legend-min'>"+this.minMaxValue.min+"</div></div>",e+="</div>",this.map.mapDiv.append(e);var n=this.map.mapDiv.find("#"+this.name+" .chart-legend-canvas canvas"),s=n[0].getContext("2d"),o=new Image;o.src=this.colorMap.url,o.onload=function(){var e=n.width()/2,t=n.height()/2,a=o.width,l=o.height;s.clearRect(0,0,a,l),s.translate(e,t),s.rotate(270*Math.PI/180),s.drawImage(o,-a/2,-l/2,a,l),s.rotate(-270*Math.PI/180),s.translate(-e,-t)}}},getChartStyle:function(){if(null==this.chartFeatures||null==this.chartOption)return null;var e=this.getMinMaxValue();if(null==e)return null;this.minMaxValue=e;var t=this.chartFeatures.length,a=this.chartOption.colorMapID,l=this.styleMgr.getColorMapByID(a);this.colorMap=l;for(var r=new GeoBeans.ColorRangeMap(this.colorMap.startColor,this.colorMap.endColor,e.min,e.max),i=this.chartFields[0],n=this.chartFeatureType.getFieldIndex(i),s=this.tableField,o=this.chartFeatureType.getFieldIndex(s),h=new GeoBeans.Style.FeatureStyle("chart",GeoBeans.Style.FeatureStyle.GeomType.Polygon),u=[],c=null,d=0;t>d;++d)if(c=this.chartFeatures[d],null!=c){var y=c.values;if(null!=y){var p=y[n];if(p=parseFloat(p),null!=p){var g=y[o],v=r.getValue(p),f=new GeoBeans.Symbolizer.PolygonSymbolizer;null!=this.chartOption.opacity?v.setOpacity(this.chartOption.opacity):v.setOpacity(1),f.fill.color=v,v=new GeoBeans.Color,null!=this.chartOption.border&&v.setByHex(this.chartOption.border,1),null!=this.chartOption.borderOpacity?v.setOpacity(this.chartOption.borderOpacity):v.setOpacity(1),f.stroke.color=v;var m=new GeoBeans.IDFilter;m.addID(c.gid);var v=new GeoBeans.Color,F=new GeoBeans.Fill;F.color=v;var w=new GeoBeans.Rule;w.filter=m,w.name=g,w.symbolizer=f,u.push(w)}}}return h.rules=u,h},getLabelLayer:function(){var e=this.map.getLayer(this.labelLayerName);if(null==e)return null;var t=e.featureType,a=t.geomFieldName,l=[this.labelLayerField,a],r=t.getFeaturesFilter(this.map.name,null,null,null,null,l),i=t.getFieldIndex(this.labelLayerField),n=null,s=this.chartFeatureType.getFieldIndex(this.tableField),o=this.chartFeatureType.getFieldIndex(this.chartFields[0]),h=new GeoBeans.Layer.FeatureLayer("label");h.features=[];for(var u=new GeoBeans.Style.FeatureStyle("label",GeoBeans.Style.FeatureStyle.GeomType.Point),c=[],d=0;d<r.length;++d)if(n=r[d],null!=n){var y=n.values;if(null!=y)for(var p=y[i],g=0;g<this.chartFeatures.length;++g){var v=this.chartFeatures[g];if(null!=v){var f=v.values;if(null!=f){var m=f[s];if(m==p){h.addFeature(n);var F=f[o],w=new GeoBeans.Rule,B=new GeoBeans.Symbolizer.TextSymbolizer;B.labelText=F;var L=new GeoBeans.Font;L.family="SimSun",L.style="normal",L.weight="normal",L.size="18",B.font=L;var b=new GeoBeans.Color;b.setByHex("#f500c0",1);var G=new GeoBeans.Fill;G.color=b,B.fill=G,B.stroke=null;var x=new GeoBeans.IDFilter;x.addID(n.fid),w.textSymbolizer=B,w.filter=x,c.push(w)}}}}}return u.rules=c,h.style=u,h},getFeatures:function(){if(null!=this.baseLayerName&&null!=this.baseLayerField&&null!=this.dbName&&null!=this.tableName&&null!=this.tableField){var e=this.map.getLayer(this.baseLayerName);if(null!=e){var t=new GeoBeans.WFSWorkspace("tmp",this.map.server,"1.0.0"),a=new GeoBeans.FeatureType(t,this.tableName);this.chartFeatureType=a;var l=(a.getFields(null,this.dbName),a.getFeaturesFilter(null,this.dbName,null,null,null,[this.tableField].concat(this.chartFields))),r=a.getFieldIndex(this.tableField);if(-1!=r){var i=a.getFieldIndex(this.chartFields[0]),n=e.getFeatureType(),s=n.geomFieldName,o=[this.baseLayerField,s],h=n.getFeaturesFilter(this.map.name,null,null,null,null,o),u=(e.getFields(),n.getFieldIndex(this.baseLayerField));if(-1!=u){for(var c=0;c<h.length;++c){var d=h[c];if(null!=d){var y=d.values;if(null!=y)for(var p=y[u],g=0;g<l.length;++g){var v=l[g];if(null!=v){var f=v.values;if(null!=f){var m=f[r];if(p==m){var F=f[i];d.chartValue=F}}}}}}this.features=h,this.featureType=n}}}}},getStyle:function(){if(null==this.features||null==this.chartOption)return null;var e=this.getMinMaxValue();if(null==e)return null;this.minMaxValue=e;var t=this.features.length,a=this.chartOption.colorMapID,l=this.styleMgr.getColorMapByID(a);this.colorMap=l;for(var r=new GeoBeans.ColorRangeMap(this.colorMap.startColor,this.colorMap.endColor,e.min,e.max),i=new GeoBeans.Style.FeatureStyle("chart",GeoBeans.Style.FeatureStyle.GeomType.Polygon),n=[],s=0;t>s;++s){var o=this.features[s];if(null!=o){var h=o.chartValue,u=new GeoBeans.Symbolizer.PolygonSymbolizer,c=null;null==h?(c=new GeoBeans.Color,c.setByHex("#ffffff",1)):(h=parseFloat(h),c=r.getValue(h)),null!=this.chartOption.opacity?c.setOpacity(this.chartOption.opacity):c.setOpacity(1),u.fill.color=c,c=new GeoBeans.Color,null!=this.chartOption.border&&c.setByHex(this.chartOption.border,1),null!=this.chartOption.borderOpacity?c.setOpacity(this.chartOption.borderOpacity):c.setOpacity(1),u.stroke.color=c;var d=new GeoBeans.IDFilter;d.addID(o.fid);var c=new GeoBeans.Color,y=new GeoBeans.Fill;y.color=c;var p=new GeoBeans.Rule;p.filter=d,p.name=h,p.symbolizer=u,n.push(p)}}return i.rules=n,i},getMinMaxValue:function(){if(null==this.features)return null;for(var e=null,t=null,a=null,l=0;l<this.features.length;++l)if(a=this.features[l],null!=a){var r=a.chartValue;null!=r&&(r=parseFloat(r),e=null==e?r:e>r?r:e,t=null==t?r:r>t?r:t)}return{min:e,max:t}}});
GeoBeans.Layer.RangeSymbolChartLayer=GeoBeans.Class(GeoBeans.Layer.ChartLayer,{rangeBaseLayerName:null,rangeBaseLayerField:null,rangeChartField:null,rangeOption:null,symbolBaseLayerName:null,symbolBaseLayerField:null,symbolChartField:null,symbolOption:null,style:null,maxSymbolRadius:30,levelMap:null,legendPadding:4,initialize:function(e,l,a,t,i,n,s,r,o,h,d,u){GeoBeans.Layer.prototype.initialize.apply(this,arguments),this.name=e,this.rangeBaseLayerName=l,this.rangeBaseLayerField=a,this.rangeChartField=t,this.symbolBaseLayerName=i,this.symbolBaseLayerField=n,this.symbolChartField=s,this.dbName=r,this.tableName=o,this.tableField=h,this.chartFields=[this.rangeChartField,this.symbolChartField],this.rangeOption=d,this.symbolOption=u,this.type=GeoBeans.Layer.ChartLayer.Type.RANGESYMBOL},cleanup:function(){GeoBeans.Layer.ChartLayer.prototype.cleanup.apply(this,arguments),this.unRegisterHitEvent()},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments),this.getFeatures();var l=this.map.server.slice(0,this.map.server.lastIndexOf("/mgr"));this.styleMgr=new GeoBeans.StyleManager(l),this.registerHitEvent(this.onFeatureHit)},load:function(){var e=this.map.viewer;null!=e&&null!=this.viewer&&e.equal(this.viewer)&&null!=this.features&&this.flag==GeoBeans.Layer.Flag.LOADED||(this.viewer=new GeoBeans.Envelope(e.xmin,e.ymin,e.xmax,e.ymax),this.renderer.clearRect(),this.drawRangChart(),this.drawSymbolChart(),this.drawLegend(),this.flag=GeoBeans.Layer.Flag.LOADED)},drawLegend:function(){null!=this.minMax&&null!=this.rangeOption&&null!=this.symbolOption&&(this.removeLegend(),this.drawRangeLegend(),this.drawSymbolLegend(),this.resizeLegend())},getFeatures:function(){if(null!=this.rangeBaseLayerName&&null!=this.rangeBaseLayerField&&null!=this.symbolBaseLayerName&&null!=this.symbolBaseLayerField&&null!=this.dbName&&null!=this.tableName&&null!=this.tableField){var e=new GeoBeans.WFSWorkspace("tmp",this.map.server,"1.0.0"),l=new GeoBeans.FeatureType(e,this.tableName);l.getFields(null,this.dbName);var a=l.getFieldIndex(this.tableField);if(-1!=a){var t=l.getFeaturesFilter(null,this.dbName,null,null,null,[this.tableField].concat(this.chartFields)),i=this.map.getLayer(this.rangeBaseLayerName),n=i.getFeatureType(),s=n.getFieldIndex(this.rangeBaseLayerField);if(-1!=s){var r=n.geomFieldName,o=[this.rangeBaseLayerField,r],h=n.getFeaturesFilter(this.map.name,null,null,null,null,o),d=this.map.getLayer(this.symbolBaseLayerName),u=d.getFeatureType(),m=u.getFieldIndex(this.symbolBaseLayerField);if(-1!=m){for(var y=u.geomFieldName,o=[this.symbolBaseLayerField,y],g=u.getFeaturesFilter(this.map.name,null,null,null,null,o),p=l.getFieldIndex(this.rangeChartField),c=l.getFieldIndex(this.symbolChartField),v=null,f=null,b=null,x=null,B=null,L=null,F=null,w=null,O=null,S=null,G=null,M=null,C=null,R=null,D=null,I=0;I<h.length;++I)if(v=h[I],null!=v&&(f=v.values,null!=f)){F=f[s];for(var z=0;z<g.length;++z)if(b=g[z],null!=b&&(x=b.values,null!=x&&(w=x[m],F==w))){v.symbolGeomtry=b.geometry;for(var P=0;P<t.length;++P)if(B=t[P],null!=B&&(L=B.values,null!=L&&(O=L[a],O==F))){S=L[p],G=L[c],S=parseFloat(S),G=parseFloat(G),v.rValue=S,v.sValue=G,M=null==M?S:S>M?M:S,null==C&&(C=C>S?C:S),R=null==R?G:G>R?R:G,D=null==D?G:D>G?D:G;break}break}v.tValue=F}this.features=h,this.minMax={range:{min:M,max:C},symbol:{min:R,max:D}}}}}}},drawRangChart:function(){this.style=this.getRangeStyle(),null!=this.style&&this.drawLayer()},getRangeStyle:function(){if(null==this.features||null==this.rangeOption||null==this.minMax)return null;var e=this.features.length,l=this.rangeOption.colorMapID,a=this.styleMgr.getColorMapByID(l);this.colorMap=a;for(var t=this.minMax.range,i=new GeoBeans.ColorRangeMap(this.colorMap.startColor,this.colorMap.endColor,t.min,t.max),n=new GeoBeans.Style.FeatureStyle("chart",GeoBeans.Style.FeatureStyle.GeomType.Polygon),s=[],r=0;e>r;++r){var o=this.features[r];if(null!=o){var h=o.rValue,d=new GeoBeans.Symbolizer.PolygonSymbolizer,u=null;null==h?(u=new GeoBeans.Color,u.setByHex("#ffffff",1)):(h=parseFloat(h),u=i.getValue(h)),null!=this.rangeOption.opacity?u.setOpacity(this.rangeOption.opacity):u.setOpacity(1),d.fill.color=u,u=new GeoBeans.Color,null!=this.rangeOption.border&&u.setByHex(this.rangeOption.border,1),null!=this.rangeOption.borderOpacity?u.setOpacity(this.rangeOption.borderOpacity):u.setOpacity(1),d.stroke.color=u;var m=new GeoBeans.IDFilter;m.addID(o.fid);var u=new GeoBeans.Color,y=new GeoBeans.Fill;y.color=u;var g=new GeoBeans.Rule;g.filter=m,g.name=h,g.symbolizer=d,s.push(g)}}return n.rules=s,n},drawSymbolChart:function(){if(null!=this.minMax&&null!=this.symbolOption&&null!=this.features){var e=this.symbolOption.byLevel;e?this.drawSymbolLayerByLevel():this.drawSymbolLayerByValue()}},drawSymbolLayerByLevel:function(){if(null!=this.features&&null!=this.minMax&&null!=this.symbolOption){var e=this.symbolOption.level,l=this.minMax.symbol,a=l.min,t=l.max,i=this.symbolOption.maxsize,n=this.getSymbolizer();this.renderer.setSymbolizer(n);var s=null,r=null,o=null,h=null,d=this.getLevelMap(i,e,a,t);this.levelMap=d;for(var u=0;u<this.features.length;++u)feature=this.features[u],null!=feature&&(s=feature.sValue,r=feature.symbolGeomtry,o=this.getRadiusByLevelMap(parseFloat(s),d),h=new GeoBeans.Geometry.Circle(r,o),feature.circle=h,this.renderer.drawGeometry(h,n,this.map.transformation))}},getLevelMap:function(e,l,a,t){if(null!=e&&null!=l&&null!=a&&null!=t){for(var i=(t-a)/l,n=[],s=0;l>s;++s){var r=a+s*i,o=a+(s+1)*i,h=Math.pow(1.2,s+1-l)*e,d={min:r,max:o,radius:h};n.push(d)}return n}},drawSymbolLayerByValue:function(){if(null!=this.minMax&&null!=this.features&&null!=this.symbolOption){var e=this.minMax.symbol,l=(e.min,e.max),a=this.getSymbolizer();this.renderer.setSymbolizer(a);for(var t=null,i=null,n=null,s=null,r=null,o=0;o<this.features.length;++o)t=this.features[o],null!=t&&(i=t.sValue,null!=i&&(n=t.symbolGeomtry,s=parseFloat(i)/l*this.symbolOption.maxsize,r=new GeoBeans.Geometry.Circle(n,s),t.circle=r,this.renderer.drawGeometry(r,a,this.map.transformation)))}},getSymbolizer:function(){var e=new GeoBeans.Symbolizer.PolygonSymbolizer,l=this.symbolOption.color;null!=l&&e.fill.color.setByHex(l,1);var a=this.symbolOption.opacity;null!=a?e.fill.color.setOpacity(a):e.fill.color.setOpacity(1);var t=this.symbolOption.border;null!=t&&e.stroke.color.setByHex(t,1);var i=this.symbolOption.borderOpacity;return null!=i?e.stroke.color.setOpacity(i):e.stroke.color.setOpacity(1),e},getRadiusByLevelMap:function(e,l){if(null==e||null==l)return null;for(var a=null,t=null,i=null,n=0;n<l.length;++n)if(a=l[n],null!=a){if(t=a.min,i=a.max,0==n&&e==t)return a.radius;if(e>t&&i>=e)return a.radius}return null},onFeatureHit:function(e,l,a){if(console.log(l.length),"pointer"==document.body.style.cursor)return void e.map.closeInfoWindow();if(0==l.length)e.map.closeInfoWindow();else{var t=l[0];if(null==t)return;var i=t.tValue,n=t.rValue,s=t.sValue,r=e.rangeChartField,o=e.symbolChartField,h="<div><div>"+r+" : "+(null==n?"":n)+"</div><div>"+o+" : "+(null==s?"":s)+"</div></div>",d={title:i,width:100,height:40},u=new GeoBeans.InfoWindow(h,d);e.map.openInfoWindow(u,a)}},drawRangeLegend:function(){if(null!=this.minMax&&null!=this.rangeOption){var e="",l=this.map.mapDiv.find(".chart-legend"),a=0;if(l.length>0){var t=l.last(),i=t.css("left"),n=t.css("width");i=parseInt(i.replace("px","")),n=parseInt(n.replace("px","")),a=i+n+5}else a=10;var e="<div class='chart-legend chart-legend-range-symbol' id='"+this.name+"' style='left:"+a+"px'>";e+="<div class='chart-legend-item chart-legend-rs-range'><div class='chart-legend-title'><h5>"+this.rangeChartField+"</h5></div>",e+="<div class='chart-legend-canvas'>	<canvas width='20' height='200'></canvas></div><div class='chart-legend-value'><div class='chart-legend-label'>"+this.minMax.range.max+"</div><div class='chart-legend-label' style='padding-top:180px'>"+this.minMax.range.min+"</div></div></div>",e+="</div>",this.map.mapDiv.append(e);var s=this.map.mapDiv.find("#"+this.name+" .chart-legend-canvas canvas"),r=s[0].getContext("2d"),o=new Image;o.src=this.colorMap.url,o.onload=function(){var e=s.width()/2,l=s.height()/2,a=o.width,t=o.height;r.clearRect(0,0,a,t),r.translate(e,l),r.rotate(270*Math.PI/180),r.drawImage(o,-a/2,-t/2,a,t),r.rotate(-270*Math.PI/180),r.translate(-e,-l)}}},drawSymbolLegend:function(){if(null==this.symbolOption)return"";var e=this.symbolOption.byLevel;return e?this.drawSymbolLegendByLevel():this.drawSymbolLegendByValue()},drawSymbolLegendByLevel:function(){if(null!=this.symbolOption){var e=this.symbolOption.maxsize,l=(this.symbolOption.level,2*this.maxSymbolRadius),a=this.getLegendCanvasHeightByLevel(this.levelMap,this.maxSymbolRadius,e);if(null!=a){var t="<div class='chart-legend-item chart-legend-rs-symbol'>";t+="<div class='chart-legend-title'<h5>"+this.symbolChartField+"</h5></div>",t+="<div class='chart-legend-canvas'><canvas width='"+l+"' height='"+a+"'></canvas></div>",t+="<div class='chart-legend-value' style='font-size:12px;ling-height:12px'></div>",t+="</div>",this.map.mapDiv.find("#"+this.name).prepend(t);var i=this.map.mapDiv.find("#"+this.name+" .chart-legend-rs-symbol .chart-legend-title").height(),n=i+a+20;this.map.mapDiv.find("#"+this.name+" .chart-legend-rs-symbol").css("height",n+"px");var s="",r=this.map.mapDiv.find("#"+this.name+" .chart-legend-rs-symbol canvas"),o=new GeoBeans.Renderer(r[0]),h=this.getSymbolizer();o.setSymbolizer(h);for(var d=o.context,u=0,m=null,y=null,g=null,p=null,c=null,v=null,f=0,b=null,x=0;x<this.levelMap.length;++x)if(m=this.levelMap[x],null!=m){p=m.min,c=m.max,p=p.toFixed(2),c=c.toFixed(2),v=p+"~"+c,y=m.radius,g=y/e*this.maxSymbolRadius,u+=g,null==b&&(b=-8.495),f=u-b-16.99,b=u,s+="<div class='chart-legend-label' style='padding-top:"+f+"px'>"+v+"</div>";var B=new GeoBeans.Geometry.Point(this.maxSymbolRadius,u);u+=g+this.legendPadding,d.beginPath(),d.arc(B.x,B.y,g,0,2*Math.PI,!0),null!=h.fill&&d.fill(),null!=h.stroke&&d.stroke(),d.closePath()}this.map.mapDiv.find("#"+this.name+" .chart-legend-rs-symbol .chart-legend-value").html(s)}}},getLegendCanvasHeightByLevel:function(e,l,a){if(null==e||null==l||null==a)return null;for(var t=0,i=null,n=null,s=e.length-1;s>=0;--s)if(i=e[s],null!=i){n=i.radius;var r=n/a*l;t+=2*r+this.legendPadding}return t=Math.ceil(t)},drawSymbolLegendByValue:function(){if(null!=this.symbolOption){var e=this.minMax.symbol,l=e.min,a=e.max,t=(this.symbolOption.maxsize,l/a*this.maxSymbolRadius),i=t;8.5>t&&(i=8.5);var n=2*this.maxSymbolRadius,s=2*(this.maxSymbolRadius+i)+this.legendPadding,r=this.map.mapDiv.find(".chart-legend"),o=0;if(r.length>0){var h=r.last(),d=h.css("left"),u=h.css("width");d=parseInt(d.replace("px","")),u=parseInt(u.replace("px","")),o=d+u+5}else o=10;var m="<div class='chart-legend-item chart-legend-rs-symbol'>";m+="<div class='chart-legend-title'><h5>"+this.symbolChartField+"</h5></div>",m+="<div class='chart-legend-canvas'><canvas width='"+n+"' height='"+s+"'></canvas></div>",m+="<div class='chart-legend-value' style='font-size:12px;ling-height:12px'></div>",m+="</div>",this.map.mapDiv.find("#"+this.name).prepend(m);var y=this.map.mapDiv.find("#"+this.name+" .chart-legend-rs-symbol .chart-legend-title").height(),g=y+s+20;this.map.mapDiv.find("#"+this.name+" .chart-legend-rs-symbol").css("height",g+"px");var p=this.map.mapDiv.find("#"+this.name+" .chart-legend-rs-symbol canvas"),c=new GeoBeans.Renderer(p[0]),v=this.getSymbolizer();c.setSymbolizer(v);var f=c.context,b=new GeoBeans.Geometry.Point(this.maxSymbolRadius,i);f.beginPath(),f.arc(b.x,b.y,t,0,2*Math.PI,!0),null!=v.fill&&f.fill(),null!=v.stroke&&f.stroke(),f.closePath(),f.beginPath();var x=this.maxSymbolRadius+2*i+this.legendPadding,B=new GeoBeans.Geometry.Point(this.maxSymbolRadius,x);f.arc(B.x,B.y,this.maxSymbolRadius,0,2*Math.PI,!0),null!=v.fill&&f.fill(),null!=v.stroke&&f.stroke(),f.closePath();var L="",F=i-8.5,w=B.y-b.y-16.99;L+="<div class='chart-legend-label' style='padding-top:"+F+"px'>"+l+"</div>",L+="<div class='chart-legend-label' style='padding-top:"+w+"px'>"+a+"</div>",this.map.mapDiv.find("#"+this.name+" .chart-legend-rs-symbol .chart-legend-value").html(L)}},resizeLegend:function(){var e=this.map.mapDiv.find(".chart-legend-rs-range .chart-legend-value"),l=e.width(),a=this.map.mapDiv.find(".chart-legend#"+this.name).width();if(a>l+40){var t=a-l-30,i=t/2;e.css("margin-right",i+"px"),this.map.mapDiv.find(".chart-legend-rs-range .chart-legend-canvas").css("margin-left",i+"px")}},setRangeBaseLayer:function(e){null!=e&&(this.rangeBaseLayerName=e)},setRangeBaseLayerField:function(e){null!=e&&(this.rangeBaseLayerField=e)},setSymbolBaseLayer:function(e){null!=e&&(this.symbolBaseLayerName=e)},setSymbolBaseLayerField:function(e){null!=e&&(this.symbolBaseLayerField=e)},setRangeChartField:function(e){null!=e&&(this.rangeChartField=e)},setSymbolChartField:function(e){null!=e&&(this.symbolChartField=e)},setRangeChartOption:function(e){null!=e&&(this.rangeOption=e,this.flag=GeoBeans.Layer.Flag.READY)},setSymbolChartOption:function(e){null!=e&&(this.symbolOption=e,this.flag=GeoBeans.Layer.Flag.READY)}});
GeoBeans.Layer.SymbolChartLayer=GeoBeans.Class(GeoBeans.Layer.ChartLayer,{chartOption:null,levelMap:null,legendPadding:4,maxSymbolRadius:30,minMax:null,initialize:function(e,t,l,a,i,n,s,r){GeoBeans.Layer.ChartLayer.prototype.initialize.apply(this,arguments),this.type=GeoBeans.Layer.ChartLayer.Type.SYMBOL,this.chartOption=r},setMap:function(e){GeoBeans.Layer.ChartLayer.prototype.setMap.apply(this,arguments),this.registerHitEvent(this.onFeatureHit)},cleanup:function(){GeoBeans.Layer.ChartLayer.prototype.cleanup.apply(this,arguments),this.unRegisterHitEvent(),this.chartOption=null,this.levelMap=null,this.minMax=null},load:function(){null==this.features&&(this.features=this.chartFeatures),this.renderer.clearRect(),this.drawLayer(),this.removeLegend(),this.addLegend(),this.visible?this.showLegend():this.hideLegend(),this.flag=GeoBeans.Layer.Flag.LOADED},getSymbolizer:function(){var e=new GeoBeans.Symbolizer.PolygonSymbolizer,t=this.chartOption.color;null!=t&&e.fill.color.setByHex(t,1);var l=this.chartOption.opacity;null!=l?e.fill.color.setOpacity(l):e.fill.color.setOpacity(1);var a=this.chartOption.border;null!=a&&e.stroke.color.setByHex(a,1);var i=this.chartOption.borderOpacity;return null!=i?e.stroke.color.setOpacity(i):e.stroke.color.setOpacity(1),e},drawLayer:function(){if(null!=this.chartOption){var e=this.chartOption.byLevel;e?this.drawLayerByLevel():this.drawLayerByValue()}},drawLayerByLevel:function(){if(null!=this.chartOption){var e=this.chartOption.level,t=this.getMinMaxValue();this.minMax=t;var l=t.min,a=t.max,i=this.chartOption.maxsize,n=(this.chartFields[0],this.chartFeatureType),s=n.getFieldIndex(this.chartFields),r=this.getSymbolizer();this.renderer.setSymbolizer(r);var h=null,o=null,u=null,d=null,c=null,p=null,v=this.getLevelMap(i,e,l,a);this.levelMap=v;for(var m=0;m<this.chartFeatures.length;++m)h=this.chartFeatures[m],null!=h&&(o=h.values,null!=o&&(u=o[s],null!=u&&(d=h.geometry,c=this.getRadiusByLevelMap(parseFloat(u),v),console.log(c),p=new GeoBeans.Geometry.Circle(d,c),h.circle=p,this.renderer.drawGeometry(p,r,this.map.transformation))))}},drawLayerByValue:function(){var e=this.getMinMaxValue();this.minMax=e;var t=(e.min,e.max),l=(this.chartFields[0],this.chartFeatureType),a=l.getFieldIndex(this.chartFields),i=this.getSymbolizer();this.renderer.setSymbolizer(i);for(var n=null,s=null,r=null,h=null,o=null,u=null,d=0;d<this.chartFeatures.length;++d)n=this.chartFeatures[d],null!=n&&(s=n.values,null!=s&&(r=s[a],null!=r&&(h=n.geometry,o=parseFloat(r)/t*this.chartOption.maxsize,u=new GeoBeans.Geometry.Circle(h,o),n.circle=u,this.renderer.drawGeometry(u,i,this.map.transformation))))},getMinMaxValue:function(){if(null==this.chartFeatures)return null;for(var e=null,t=(this.chartFields[0],this.chartFeatureType),l=t.getFieldIndex(this.chartFields[0]),a=null,i=null,n=null,s=null,r=0;r<this.chartFeatures.length;++r)e=this.chartFeatures[r],null!=e&&(a=e.values,null!=a&&(s=a[l],null!=s&&(s=parseFloat(s),i=null==i?s:i>s?s:i,n=null==n?s:s>n?s:n)));return{min:i,max:n}},getLevelMap:function(e,t,l,a){if(null!=e&&null!=t&&null!=l&&null!=a){for(var i=(a-l)/t,n=[],s=0;t>s;++s){var r=l+s*i,h=l+(s+1)*i,o=Math.pow(1.2,s+1-t)*e,u={min:r,max:h,radius:o};n.push(u)}return n}},getRadiusByLevelMap:function(e,t){if(null==e||null==t)return null;for(var l=null,a=null,i=null,n=0;n<t.length;++n)if(l=t[n],null!=l){if(a=l.min,i=l.max,0==n&&e==a)return l.radius;if(e>a&&i>=e)return l.radius}return null},addLegend:function(){if(null!=this.chartOption){var e=this.chartOption.byLevel;e?this.addLegendByLevel():this.addLegendByValue()}},addLegendByLevel:function(){if(null!=this.chartOption){var e=this.chartOption.maxsize,t=(this.chartOption.level,2*this.maxSymbolRadius),l=this.getLegendCanvasHeightByLevel(this.levelMap,this.maxSymbolRadius,e);if(null!=l){var a=this.map.mapDiv.find(".chart-legend"),i=0;if(a.length>0){var n=a.last(),s=n.css("left"),r=n.css("width");s=parseInt(s.replace("px","")),r=parseInt(r.replace("px","")),i=s+r+5}else i=10;var h="<div class='chart-legend chart-symbol-legend' id='"+this.name+"' style='left:"+i+"px'>";h+="<div class='chart-legend-title'<h5>"+this.name+"</h5></div>",h+="<div class='chart-legend-canvas'><canvas width='"+t+"' height='"+l+"'></canvas></div>",h+="<div class='chart-legend-value' style='font-size:12px;ling-height:12px'></div>",h+="</div>",this.map.mapDiv.append(h);var o="",u=this.map.mapDiv.find("#"+this.name+" canvas"),d=new GeoBeans.Renderer(u[0]),c=this.getSymbolizer();d.setSymbolizer(c);for(var p=d.context,v=0,m=null,y=null,g=null,f=null,x=null,L=null,b=0,F=null,B=0;B<this.levelMap.length;++B)if(m=this.levelMap[B],null!=m){f=m.min,x=m.max,f=f.toFixed(2),x=x.toFixed(2),L=f+"~"+x,y=m.radius,g=y/e*this.maxSymbolRadius,v+=g,null==F&&(F=-8.495),b=v-F-16.99,F=v,o+="<div class='chart-legend-label' style='padding-top:"+b+"px'>"+L+"</div>";var w=new GeoBeans.Geometry.Point(this.maxSymbolRadius,v);v+=g+this.legendPadding,p.beginPath(),p.arc(w.x,w.y,g,0,2*Math.PI,!0),null!=c.fill&&p.fill(),null!=c.stroke&&p.stroke(),p.closePath()}this.map.mapDiv.find("#"+this.name+".chart-legend .chart-legend-value").html(o)}}},getLegendCanvasHeightByLevel:function(e,t,l){if(null==e||null==t||null==l)return null;for(var a=0,i=null,n=null,s=e.length-1;s>=0;--s)if(i=e[s],null!=i){n=i.radius;var r=n/l*t;a+=2*r+this.legendPadding}return a=Math.ceil(a)},addLegendByValue:function(){if(null!=this.chartOption){var e=this.minMax;if(null!=e){var t=e.min,l=e.max,a=(this.chartOption.maxsize,t/l*this.maxSymbolRadius),i=a;8.5>a&&(i=8.5);var n=2*this.maxSymbolRadius,s=2*(this.maxSymbolRadius+i)+this.legendPadding,r=this.map.mapDiv.find(".chart-legend"),h=0;if(r.length>0){var o=r.last(),u=o.css("left"),d=o.css("width");u=parseInt(u.replace("px","")),d=parseInt(d.replace("px","")),h=u+d+5}else h=10;var c="<div class='chart-legend chart-symbol-legend' id='"+this.name+"' style='left:"+h+"px'>";c+="<div class='chart-legend-title'><h5>"+this.name+"</h5></div>",c+="<div class='chart-legend-canvas'><canvas width='"+n+"' height='"+s+"'></canvas></div>",c+="<div class='chart-legend-value' style='font-size:12px;ling-height:12px'></div>",c+="</div>",this.map.mapDiv.append(c);var p=this.map.mapDiv.find("#"+this.name+" canvas"),v=new GeoBeans.Renderer(p[0]),m=this.getSymbolizer();v.setSymbolizer(m);var y=v.context,g=new GeoBeans.Geometry.Point(this.maxSymbolRadius,i);y.beginPath(),y.arc(g.x,g.y,a,0,2*Math.PI,!0),null!=m.fill&&y.fill(),null!=m.stroke&&y.stroke(),y.closePath(),y.beginPath();var f=this.maxSymbolRadius+2*i+this.legendPadding,x=new GeoBeans.Geometry.Point(this.maxSymbolRadius,f);y.arc(x.x,x.y,this.maxSymbolRadius,0,2*Math.PI,!0),null!=m.fill&&y.fill(),null!=m.stroke&&y.stroke(),y.closePath();var L="",b=i-8.5,F=x.y-g.y-16.99;L+="<div class='chart-legend-label' style='padding-top:"+b+"px'>"+t+"</div>",L+="<div class='chart-legend-label' style='padding-top:"+F+"px'>"+l+"</div>",this.map.mapDiv.find("#"+this.name+".chart-legend .chart-legend-value").html(L)}}},onFeatureHit:function(e,t,l){if(console.log(t.length),"pointer"==document.body.style.cursor)return void e.map.closeInfoWindow();if(0==t.length)e.map.closeInfoWindow();else{var a=t[0],i=(a.chartValue,e.chartFeatureType);if(null==i)return;var n=a.values;if(null==n)return;var s=i.getFieldIndex(e.chartFields[0]),r=n[s],h=i.getFieldIndex(e.tableField),o=n[h],u="<div>"+r+"</div>",d={title:o,width:100,height:40},c=new GeoBeans.InfoWindow(u,d),p=a.circle.center;e.map.openInfoWindow(c,p)}},hit:function(e,t,l){if(null!=this.chartFeatures){this.map.renderer,this.map.transformation;this.selection=[];var a=0,i=null,n=null,s=this.features.length;for(a=0;s>a;a++)i=this.features[a],n=i.circle,null!=n&&n.hit(e,t,this.map.tolerance)&&this.selection.push(i);if(this.hitRenderer.clearRect(0,0,this.hitCanvas.height,this.hitCanvas.width),this.map.drawLayersAll(),void 0!=l){var r=new GeoBeans.Geometry.Point(e,t);l(this,this.selection,r)}}}});
