...
GeoBeans.FeatureType=GeoBeans.Class({workspace:null,name:null,title:null,keywords:null,srs:null,extent:null,fields:null,geomFieldName:null,count:null,minMaxValue:null,callback_obj:null,initialize:function(e,t){this.workspace=e,this.name=t},destory:function(){this.workspace=null,this.name=null,this.title=null,this.keywords=null,this.srs=null,this.extent=null,this.geomFieldName=null},setName:function(e){this.name=e},setTitle:function(e){this.title=e},setKeywords:function(e){this.keywords=e},setSrs:function(e){this.srs=e},setExtent:function(e){this.extent=e},getFields:function(){return this.fields},getFieldsAsync:function(e,t){if(null!=this.fields&&0!=this.fields.length)return void(null!=t&&t(e,this.fields));var n=this,s=this.workspace.server,r="service="+this.workspace.service+"&version="+this.workspace.version+"&request=describeFeatureType&typeName="+this.name;$.ajax({type:"get",url:s,data:encodeURI(r),dataType:"xml",async:!0,beforeSend:function(e){},success:function(s,r){n.fields=n.parseFields(s),null!=t&&t(e,n.fields)},complete:function(e,t){},error:function(){}})},getFieldIndex:function(e){for(var t=this.getFields(),n=0,s=t.length;n<s;n++){var r=t[n];if(r.name==e)return n}return-1},parseFields:function(e){if(0!=$(e).find("ExceptionText").length){var t=$(e).find("ExceptionText").text();return t}var n=this,s=null,r=new Array;return $(e).find("sequence").children().each(function(){s=n.parseField(this),r.push(s)}),r},parseField:function(e){var t=$(e).attr("name"),n=($(e).attr("nillable"),$(e).attr("type")),s=this.parseFieldType(n),r=$(e).attr("length"),i=new GeoBeans.Field(t,s,this,r);if(s==GeoBeans.FieldType.GEOMETRY){var a=this.parseGeometryType(n);i.setGeomType(a),this.geomFieldName=t}return i},parseFieldType:function(e){return"gml"==e.substr(0,3)?GeoBeans.FieldType.GEOMETRY:e.substring(4,e.length)},parseGeometryType:function(e){return e.substr(4,e.length-16)},getFeaturesAsync:function(e,t,n,s,r){var i=this,a=this.workspace.server,o="service="+this.workspace.service+"&version="+this.workspace.version+"&request=getFeature&typeName="+this.name;null!=e&&(o+="&maxFeatures="+e),null!=t&&(o+="&offset="+t);var l="";if(null!=n)for(var u=0;u<n.length;++u)l+=n[u],u<n.length-1&&(l+=",");if(0!=l.length&&(o+="&fields="+l),null!=this.fields){var c=$.ajax({type:"get",url:a,data:encodeURI(encodeURI(o)),dataType:"xml",async:!0,beforeSend:function(e){},success:function(e,t){var n=i.parseFeatures(e);void 0!=r&&r(s,n)},complete:function(e,t){},error:function(e,t,n){console.log("textStatus:"+t),console.log("error:"+n)}});return c}},getFeatureBBoxGet:function(e,t,n,s,r){var i=this,a=this.workspace.server,o="service="+this.workspace.service+"&version="+this.workspace.version+"&request=getFeature&typeName="+this.name;if(null!=e&&(o+="&mapName="+e),null!=t&&(o+="&sourceName="+t),null!=n){var l=n.xmin,u=n.xmax,c=n.ymin,p=n.ymax,f="";f=u-l<.01?n.toString():l.toFixed(6)+","+c.toFixed(6)+","+u.toFixed(6)+","+p.toFixed(6),o+="&bbox="+f}return null!=s&&(o+="&maxFeatures="+s),null!=r&&(o+="&offset="+r),i.fields=i.getFields(e,t),$.ajax({type:"get",url:a,data:encodeURI(o),dataType:"xml",async:!1,beforeSend:function(e){},success:function(e,t){var n=i.parseFeatures(e);i.features=n},complete:function(e,t){},error:function(){}}),i.features},getFeaturesBBox:function(e,t,n){var s=t.xmin,r=t.xmax,i=t.ymin,a=t.ymax,o=(s.toFixed(2)+","+i.toFixed(2)+","+r.toFixed(2)+","+a.toFixed(2),this),l=this.workspace.server,u=this.buildGetFeatureXMLBboxFilter(t,n);$.ajax({type:"post",url:l,data:u,contentType:"text/xml",dataType:"xml",async:!0,beforeSend:function(e){},success:function(t,n){var s=o.parseFeatures(t);void 0!=e&&e(o,s)},complete:function(e,t){},error:function(){}})},parseFeatures:function(e){var t=this,n=null,s=new Array,r=new GeoBeans.Geometry.GML.Reader(GeoBeans.Geometry.GML.Version.v_2_0);return $(e).find("featureMember").each(function(){n=t.parseFeature($(this).children()[0],r),s.push(n)}),s},parseFeature:function(e,t){for(var n=this.parseFID($(e).attr("fid")),s=(this.getFields(),new Array),r=null,i=null,a=this.fields.length,o=0;o<a;o++)if(i=this.fields[o],i.type==GeoBeans.FieldType.GEOMETRY){var l=$(e).find(i.name+":first").children()[0];null==l?s.push(null):(r=t.read(l),s.push(r))}else{var u=$(e).find(i.name+":first");s.push(null==u||0==u.length?null:u.text())}return new GeoBeans.Feature(this,n,r,s)},parseFID:function(e){var t=e.indexOf(".");return e.substring(t+1,e.length)},buildGetFeatureXMLBboxFilter:function(e,t){var n="",s=this.workspace.workspaceName,r='xmlns:wfs="http://www.opengis.net/wfs"',i="xmlns:"+s+'="'+this.workspace.xmlnsWorkspace+'"',a='xmlns:gml="http://www.opengis.net/gml"',o='xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"',l='xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.0.0/WFS-basic.xsd"',u='xmlns:ogc="http://www.opengis.net/ogc" ';n+='<wfs:GetFeature service="WFS" version="1.0.0"  '+r+" "+u+" "+i+" "+a+" "+o+" "+l+'><wfs:Query typeName="'+this.name+'"><ogc:Filter>';var c="",p="";if(null!=e&&void 0!=e&&(p+="<ogc:BBOX><gml:Box><gml:coordinates>"+e.xmin+","+e.ymin+" "+e.xmax+","+e.ymax+"</gml:coordinates></gml:Box></ogc:BBOX>"),null!=t&&void 0!=t){var f=t.field,d=t.value;c+="<ogc:PropertyIsEqualTo><ogc:PropertyName>"+f+"</ogc:PropertyName><ogc:Literal>"+d+"</ogc:Literal></ogc:PropertyIsEqualTo>"}return""!=c&&""!=p?n+="<And>"+c+p+"</And>":""!=c&&""==p?n+=c:""==c&&""!=p&&(n+=p),n+="</ogc:Filter></wfs:Query></wfs:GetFeature>"},getFeaturesWithin:function(e,t,n){var s=this,r=this.workspace.server,i=this.buildGetFeaturesXMLWithin(e,t,n);return $.ajax({type:"post",url:r,contentType:"text/xml",dataType:"xml",data:i,async:!1,beforeSend:function(e){},success:function(e,t){var n=s.parseFeatures(e);s.features=n},complete:function(e,t){},error:function(){}}),s.features},getFeaturesWithinAsync:function(e,t,n,s,r,i){var a=this,o=this.workspace.server,l=this.buildGetFeaturesXMLWithin(e,t,n,r);$.ajax({type:"post",url:o,contentType:"text/xml",dataType:"xml",data:l,async:!0,beforeSend:function(e){},success:function(e,t){var n=a.parseFeatures(e);void 0!=s&&s(i,n)},complete:function(e,t){},error:function(){}})},buildGetFeaturesXMLWithin:function(e,t,n,s){var r="";r+='<wfs:GetFeature service="WFS" version="1.1.0" ',null!=e&&(r+='mapName="'+e+'" '),null!=t&&(r+='sourceName="'+t+'" ');var i="";if(null!=s)for(var a=0;a<s.length;++a){var o=s[a];null!=o&&(i+="<wfs:PropertyName>"+o+"</wfs:PropertyName>")}var l=new GeoBeans.Geometry.GML.Writer(GeoBeans.Geometry.GML.Version.v_2_0),u=l.write(n);return r+='xmlns:world="www.world.ac.cn" xmlns:wfs="http://www.opengis.net/wfs" xmlns:gml="http://www.opengis.net/gml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.1.0/wfs.xsd"><wfs:Query typeName="'+this.name+'">'+i+"\t<Filter>\t\t<Within>\t\t\t<PropertyName>"+this.geomFieldName+"</PropertyName>"+u+"\t\t</Within>\t</Filter></wfs:Query></wfs:GetFeature>"},getFeaturesFilter:function(e,t,n,s,r,i,a){var o=this,l=this.workspace.server,u=this.buildGetFeatureFilterXML(e,t,n,s,r,i,a);return this.fields=this.getFields(e,t),$.ajax({type:"post",url:l,data:u,contentType:"text/xml",dataType:"xml",async:!1,beforeSend:function(e){},success:function(e,t){var n=o.parseFeatures(e);o.features=n},complete:function(e,t){},error:function(){}}),o.features},getFeaturesFilterAsync:function(e,t,n,s,r,i,a,o){var l=this,u=this.workspace.server,c=this.buildGetFeatureFilterXML(e,t,n,s,r,i,a);this.fields=this.getFields(e,t),$.ajax({type:"post",url:u,data:c,contentType:"text/xml",dataType:"xml",async:!0,beforeSend:function(e){},success:function(e,t){var n=l.parseFeatures(e);void 0!=o&&o(n)},complete:function(e,t){},error:function(e,t,n){console.log("textStatus:"+t),console.log("error:"+n)}})},getFeaturesFilterAsync2:function(e,t,n,s,r,i,a,o,l){var u=this,c=this.workspace.server,p=this.buildGetFeatureFilterXML(e,t,n,s,r,i);this.fields=this.getFields(e,t),this.callback_obj=o;var f=$.ajax({type:"post",url:c,data:p,contentType:"text/xml",dataType:"xml",async:!0,beforeSend:function(e){},success:function(e,t){var n=u.parseFeatures(e);void 0!=l&&l(u.callback_obj,n)},complete:function(e,t){},error:function(e,t,n){}});return f},buildGetFeatureFilterXML:function(e,t,n,s,r,i,a){var o='<?xml version="1.0" encoding="UTF-8"?><wfs:GetFeature service="WFS" version="1.0.0" outputFormat="GML2" xmlns:wfs="http://www.opengis.net/wfs" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.1.0/wfs.xsd" ';null!=e&&(o+='mapName="'+e+'" '),null!=t&&(o+='sourceName="'+t+'" '),null!=s&&(o+='maxFeatures="'+s+'" '),null!=r&&(o+='offset="'+r+'" '),o+="/>";var l=$.parseXML(o),u=l.createElement("wfs:Query");if($(u).attr("typeName",this.name),null!=i)for(var c=0;c<i.length;++c){var p=l.createElement("wfs:PropertyName");$(p).text(i[c]),$(u).append(p)}var f=new GeoBeans.FilterWriter,d=f.write(l,n);if($(u).append(d),null!=a){var h=this.buildOrderbyXML(l,a);$(u).append(h)}$("GetFeature",l).append(u);var m=(new XMLSerializer).serializeToString(l);return m},buildOrderbyXML:function(e,t){if(null==t)return"";var n=e.createElement("ogc:OrderBy"),s=t.isAsc();s?$(n).attr("order","asc"):$(n).attr("order","desc");for(var r=t.getFieldCount(),i=null,a=null,o=0;o<r;++o)a=t.getField(o),null!=a&&(i=e.createElement("wfs:PropertyName"),$(i).text(a),$(n).append(i));return n}});
...
GeoBeans.Transformation=GeoBeans.Class({map:null,win_w:null,win_h:null,win_cx:null,win_cy:null,view_w:null,view_h:null,view_c:null,scale:null,initialize:function(t){this.map=t},toMapPoint:function(t,i){var e=((t-this.win_cx)*Math.cos(this.map.rotateAngle*Math.PI/180)-(this.win_cy-i)*Math.sin(this.map.rotateAngle*Math.PI/180))/this.scale+this.view_c.x,h=((t-this.win_cx)*Math.sin(this.map.rotateAngle*Math.PI/180)+(this.win_cy-i)*Math.cos(this.map.rotateAngle*Math.PI/180))/this.scale+this.view_c.y;return new GeoBeans.Geometry.Point(e,h)},toScreenPoint:function(t,i){var e=this.scale*((t-this.view_c.x)*Math.cos(this.map.rotateAngle*Math.PI/180)+(i-this.view_c.y)*Math.sin(this.map.rotateAngle*Math.PI/180))+this.win_cx,h=this.scale*((t-this.view_c.x)*Math.sin(this.map.rotateAngle*Math.PI/180)-(i-this.view_c.y)*Math.cos(this.map.rotateAngle*Math.PI/180))+this.win_cy;return new GeoBeans.Geometry.Point(e,h)},update:function(){var t=this.map.viewer,i=this.map.width,e=this.map.height;this.win_w=parseFloat(i),this.win_h=parseFloat(e),this.win_cx=i/2,this.win_cy=e/2,this.view_w=t.getWidth(),this.view_h=t.getHeight(),this.view_c=t.getCenter();var h=this.win_w/this.view_w,s=this.win_h/this.view_h;this.scale=h<s?h:s,this.map.tolerance=this.map.TOLERANCE/this.scale}});
...
GeoBeans.Control.TrackOverlayControl=GeoBeans.Class(GeoBeans.Control.TrackControl,{drawing:!1,initialize:function(){this.type=GeoBeans.Control.Type.TRACKOVERLAY},destory:function(){},cleanup:function(){this.map.canvas.removeEventListener("mousedown",this.onMouseDown),this.map.canvas.removeEventListener("mouseup",this.onMouseUp),this.map.canvas.removeEventListener("mousemove",this.onMouseMove),this.map.canvas.removeEventListener("dblclick",this.onMouseDBclick),this.onmousedown=null,this.onMouseUp=null,this.onMouseDBclick=null,this.onMouseMove=null},trackMarker:function(e,a){this.map.overlayLayer.setHitOverlayCallback(a);var n=this;this.map.saveSnap(),this.map.enableDrag(!1),this.cleanup();var t=function(t){if(t.preventDefault(),n.map.canvas.style.cursor="default",n.map.enableDrag(!0),null!=a&&void 0!=a){var o=n.map.transformation.toMapPoint(t.layerX,t.layerY),r=n.map.overlayLayer._getOverlayIDByIdentity(),i=new GeoBeans.Overlay.Marker(r,o,e);n.map.addOverlay(i),n.map.draw(),a(i),n.drawing=!0}var s=function(e){e.preventDefault(),n.map.canvas.removeEventListener("mouseup",n.onMouseUp),n.map.canvas.removeEventListener("mousedown",n.onMouseDown),n.map.canvas.style.cursor="default",n.drawing=!1};n.onMouseUp=s,n.map.canvas.addEventListener("mouseup",n.onMouseUp)};this.onMouseDown=t,this.map.canvas.addEventListener("mousedown",this.onMouseDown)},trackLine:function(e,a){this.map.overlayLayer.setHitOverlayCallback(a);var n=this,t=[],o=[],r=!1;this.map.saveSnap(),this.map.enableDrag(!1),this.cleanup();var i=function(i){i.preventDefault();for(var s=!1,l=0;l<t.length;++l){var v=t[l],m=v.x,p=v.y;m==i.layerX&&p==i.layerY&&(s=!0)}n.drawing=!0;var u=function(e){n.map.restoreSnap();var a=n.map.transformation.toMapPoint(e.layerX,e.layerY);n.drawLine(t,a.x,a.y),n.drawPoints(t,a.x,a.y),n.drawingEvent=function(){var a=n.map.transformation.toMapPoint(e.layerX,e.layerY);n.drawLine(t,a.x,a.y),n.drawPoints(t,a.x,a.y)}},y=function(i){if(n.map.enableDrag(!0),n.map.canvas.removeEventListener("mousedown",n.onMouseDown),n.map.canvas.removeEventListener("mousemove",u),n.map.canvas.removeEventListener("dblclick",y),o.length!=t.length){if(0==o.length&&t.forEach(function(e,a){o.push(e)}),i.preventDefault(),n.map.restoreSnap(),null!=a&&"undefined"!=a){var s=n.buildLineString(t),l=n.map.overlayLayer._getOverlayIDByIdentity(),v=new GeoBeans.Overlay.Polyline(l,s,e);n.map.addOverlay(v),n.map.draw(),a(v)}if(null==a)return n.buildLineString(t);o=[],t=[],r=!1,n.drawing=!1}};if(0==s){var c=n.map.transformation.toMapPoint(i.layerX,i.layerY);t.push({x:i.layerX,y:i.layerY,mapX:c.x,mapY:c.y})}r||(console.log("add-mousemove"),n.map.canvas.addEventListener("mousemove",u),n.map.canvas.addEventListener("dblclick",y),r=!0),n.onMouseDClick=y,n.onMouseMove=u};this.map.canvas.addEventListener("mousedown",i),this.onMouseDown=i},trackPolygon:function(e,a){this.map.overlayLayer.setHitOverlayCallback(a);var n=this,t=[],o=[];this.map.saveSnap(),this.map.enableDrag(!1),this.cleanup();var r=function(r){r.preventDefault();for(var i=!1,s=0;s<t.length;++s){var l=t[s],v=l.x,m=l.y;v==r.layerX&&m==r.layerY&&(i=!0)}if(0==i){var p=n.map.transformation.toMapPoint(r.layerX,r.layerY);t.push({x:r.layerX,y:r.layerY,mapX:p.x,mapY:p.y})}n.drawing=!0;var u=function(e){n.map.restoreSnap();var a=n.map.transformation.toMapPoint(e.layerX,e.layerY);t.length>1?(n.drawPolygon(t,a.x,a.y),n.drawPoints(t,a.x,a.y)):(n.drawLine(t,a.x,a.y),n.drawPoints(t,a.x,a.y)),n.drawingEvent=function(){var a=n.map.transformation.toMapPoint(e.layerX,e.layerY);t.length>1?(n.drawPolygon(t,a.x,a.y),n.drawPoints(t,a.x,a.y)):(n.drawLine(t,a.x,a.y),n.drawPoints(t,a.x,a.y))}},y=function(r){if(r.preventDefault(),n.map.canvas.removeEventListener("mousemove",u),n.map.canvas.removeEventListener("dblclick",y),n.map.canvas.removeEventListener("mousedown",n.onMouseDown),n.map.enableDrag(!0),o.length!=t.length){if(0==o.length&&t.forEach(function(e,a){o.push(e)}),null!=a&&"undefined"!=a&&t.length>=3){var i=n.map.overlayLayer._getOverlayIDByIdentity(),s=n.buildPolygon(t),l=new GeoBeans.Overlay.Polygon(i,s,e);n.map.addOverlay(l),n.map.draw(),a(l)}o=[],t=[],n.drawing=!1}};n.map.canvas.addEventListener("mousemove",u),n.map.canvas.addEventListener("dblclick",y),n.onMouseMove=u,n.onMouseDBclick=y};this.map.canvas.addEventListener("mousedown",r),this.onMouseDown=r},drawLine:function(e,a,n){var t=this.map.renderer.context;t.save(),t.strokeStyle="rgba(255,0,0,0.25)",t.lineWidth=3,t.beginPath();var o=this.map.transformation.toScreenPoint(a,n);t.moveTo(o.x,o.y);for(var r=e.length,i=r-1;i>=0;i--){var o=this.map.transformation.toScreenPoint(e[i].mapX,e[i].mapY);t.lineTo(o.x,o.y)}t.stroke(),t.restore()},drawPoints:function(e,a,n){var t=this.map.renderer.context;t.save();var o=5;t.fillStyle="rgba(255,0,0,0.25)",t.strokeStyle="rgba(255,0,0,0.25)",t.lineWidth=.5,t.beginPath();var r=this.map.transformation.toScreenPoint(a,n);t.arc(r.x,r.y,o,0,2*Math.PI,!1),t.closePath(),t.fill(),t.stroke();for(var i=e.length,s=0;s<i;s++){t.beginPath();var r=this.map.transformation.toScreenPoint(e[s].mapX,e[s].mapY);t.arc(r.x,r.y,o,0,2*Math.PI,!1),t.closePath(),t.fill(),t.stroke()}t.restore()},drawPolygon:function(e,a,n){var t=this.map.renderer.context;t.save(),t.fillStyle="rgba(255,255,255,0.25)",t.strokeStyle="rgba(0,0,0,1)",t.lineWidth=.5;var o=e.length;t.beginPath();var r=this.map.transformation.toScreenPoint(a,n);for(t.moveTo(r.x,r.y),i=0;i<o;i++){var r=this.map.transformation.toScreenPoint(e[i].mapX,e[i].mapY);t.lineTo(r.x,r.y)}t.closePath(),t.fill(),t.stroke(),t.restore()},buildLineString:function(e){for(var a=null,n=[],t=e.length,o=0;o<t;o++)a=new GeoBeans.Geometry.Point(e[o].mapX,e[o].mapY),n.push(a);return new GeoBeans.Geometry.LineString(n)},buildPolygon:function(e){for(var a=null,n=[],t=e.length,o=0;o<t;o++)a=new GeoBeans.Geometry.Point(e[o].mapX,e[o].mapY),n.push(a);n.push(n[0]);var r=new GeoBeans.Geometry.LinearRing(n);return new GeoBeans.Geometry.Polygon([r])}});
...
GeoBeans.WFSWorkspace=GeoBeans.Class(GeoBeans.Workspace,{server:null,service:"wfs",version:"1.0.0",featureTypes:null,xmlns:null,xmlnsWorkspace:null,workspaceName:null,initialize:function(e,t,s){GeoBeans.Workspace.prototype.initialize.apply(this,arguments),this.server=t,this.version=s,this.featureTypes=null;var n=t.lastIndexOf("/"),r=t.substr(0,n),a=r.lastIndexOf("/");this.workspaceName=r.substr(a+1,r.length)},destory:function(){this.server=null,this.version=null,this.featureTypes=null,GeoBeans.Workspace.prototype.destory.apply(this,arguments)},getFeatureTypes:function(e){if(null!=this.featureTypes)return this.featureTypes;var t=this,s="service="+this.service+"&version="+this.version+"&request=getCapabilities";return $.ajax({type:"get",url:this.server,data:encodeURI(s),dataType:"xml",async:!1,beforeSend:function(e){},success:function(e,s){t.featureTypes=t.parseFeatureTypes(e),t.xmlns=$(e).children("WFS_Capabilities").attr("xmlns");var n="xmlns:"+t.workspaceName;t.xmlnsWorkspace=$(e).children("WFS_Capabilities").attr(n)},complete:function(e,t){},error:function(){}}),this.featureTypes},getFeatureTypesAsync:function(e,t){if(null!=this.featureTypes)return void(null!=t&&t(this.featureTypes));var s=this,n="service="+this.service+"&version="+this.version+"&request=getCapabilities";return $.ajax({type:"get",url:this.server,data:encodeURI(n),dataType:"xml",async:!0,beforeSend:function(e){},success:function(n,r){s.featureTypes=s.parseFeatureTypes(n),s.xmlns=$(n).children("WFS_Capabilities").attr("xmlns");var a="xmlns:"+s.workspaceName;s.xmlnsWorkspace=$(n).children("WFS_Capabilities").attr(a),t(e,s.featureTypes)},complete:function(e,t){},error:function(){}}),this.featureTypes},getFeatureType:function(e,t,s){return null==e?void(null!=s&&s(null)):(this.getFeatureType_obj=t,this.getFeatureType_callback_u=s,void this.getFeatureTypesAsync(this,this.getFeatureType_callback))},getFeatureType_callback:function(e,t){if(null!=e&&null!=t){for(var s=e.getFeatureType_callback_u,n=e.getFeatureType_obj,r=t.length,a=null,i=0;i<r;i++){var l=t[i];l.name==n.typeName&&(a=l)}null!=s&&s(n,a)}},parseFeatureTypes:function(e){var t=null,s=new Array,n=this;return $(e).find("FeatureType").each(function(){t=n.parseFeatureType(this),s.push(t)}),s},parseFeatureType:function(e){var t=$(e).children("Name:first").text(),s=$(e).children("Title:first").text(),n=$(e).children("Keywords:first").text(),r=$(e).children("SRS:first").text(),a=$(e).children("LatLongBoundingBox:first"),i=parseFloat($(a).attr("minx")),l=parseFloat($(a).attr("maxx")),o=parseFloat($(a).attr("miny")),u=parseFloat($(a).attr("maxy")),c=new GeoBeans.Envelope(i,o,l,u),p=new GeoBeans.FeatureType(this);return p.setName(t),p.setTitle(s),p.setKeywords(n),p.setSrs(r),p.setExtent(c),p},transaction:function(e,t,s,n){var r=this.server,a=this.buildTransactionXML(e,t,s);$.ajax({type:"post",url:r,data:a,dataType:"xml",contentType:"text/xml",async:!1,beforeSend:function(e){},success:function(e,t){var s=$(e),r=s.find("SUCCESS");if(0!=r.length){var a=s.find("InsertResult");if(0!=a.length){var i=a.find("FeatureId").attr("fid");return i=i.substr(i.lastIndexOf(".")+1,i.length),n(i),that.features=null,void that.map.draw()}}var l=s.find("ServiceExceptionReport");if(0!=l.length){var o=s.find("ServiceException").text();return void n(o)}},complete:function(e,t){},error:function(){}})},buildTransactionXML:function(e,t,s){if(null!=e&&null!=t&&null!=s){for(var n="",r=e.name,a=this.workspaceName,i='xmlns:wfs="http://www.opengis.net/wfs"',l="xmlns:"+a+'="'+this.xmlnsWorkspace+'"',o='xmlns:gml="http://www.opengis.net/gml"',u='xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"',c='xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.0.0/WFS-basic.xsd"',p="",f=0;f<s.length;++f){var h=s[f],y=h.field,d=h.value;e.getFieldIndex(y)!=-1&&(p+="<"+a+":"+y+">",p+=d,p+="</"+a+":"+y+">")}var m=new GeoBeans.Geometry.GML.Writer(GeoBeans.Geometry.GML.Version.v_2_0),v=m.write(t),x="";return x+="<"+a+":"+e.geomFieldName+">",x+=v,x+="</"+a+":"+e.geomFieldName+">",n+='<wfs:Transaction service="WFS" version="1.0.0"  '+i+" "+l+" "+o+" "+u+" "+c+">",n+="<wfs:Insert>",n+="<"+r+">",n+=p,n+=x,n+="</"+r+">",n+="</wfs:Insert>",n+="</wfs:Transaction>"}}});
