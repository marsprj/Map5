...
GeoBeans.TileState={LOADED:1,LOADING:2},GeoBeans.Tile=GeoBeans.Class({map:null,image:null,url:null,row:null,col:null,level:null,layer:null,state:null,initialize:function(e,t,a,i,l,s){this.map=e,this.url=t,this.row=i,this.col=l,this.level=s,this.layer=a},loading:function(e,t,a,i){if(null==this.image&&(this.image=new Image,this.image.crossOrigin="anonymous",this.image.src=this.url),this.image.complete&&0!=this.image.height&&0!=this.width)return this.state=GeoBeans.TileState.LOADED,void t(this,e,a,i);var l=this;this.image.onload=function(){l.layer.flag!=GeoBeans.Layer.Flag.LOADED&&(l.state=GeoBeans.TileState.LOADED,t(l,e,a,i))}},draw:function(e,t,a,a){this.layer.imageScale;if(console.log(e,t),this.map.level==this.level&&this.layer.visible){if(this.layer.renderer.save(),null!=this.map.rotateAngle){var i=this.map.width,l=this.map.height;this.layer.renderer.context.translate(i/2,l/2),this.layer.renderer.context.rotate(this.map.rotateAngle*Math.PI/180),this.layer.renderer.context.translate(-i/2,-l/2)}if(this.layer.renderer.context.clearRect(e,t,a,a),this.layer.renderer.drawImage(this.image,e,t,a,a),this.layer.renderer.restore(),null!=this.map.rotateAngle){var s=this.layer.getRotateCanvas();if(null!=s){var r=s.getContext("2d");r.clearRect(0,0,s.width,s.height),r.save();var i=s.width,l=s.height;r.translate(i/2,l/2),r.rotate(-this.map.rotateAngle*Math.PI/180),r.translate(-i/2,-l/2);var h=i/2-this.layer.canvas.width/2,n=l/2-this.layer.canvas.height/2;r.drawImage(this.layer.canvas,0,0,this.layer.canvas.width,this.layer.canvas.height,h,n,this.layer.canvas.width,this.layer.canvas.height),r.restore()}}this.map._updateTile(this.layer,e,t,a,a)}}});
...
GeoBeans.Layer.QSLayer=GeoBeans.Class(GeoBeans.Layer.TileLayer,{AMP_URL:"/QuadServer/maprequest?services=world_image",IMG_WIDTH:256,IMG_HEIGHT:256,MIN_ZOOM_LEVEL:2,MAX_ZOOM_LEVEL:17,FULL_EXTENT:{xmin:-256,ymin:-256,xmax:256,ymax:256},RESOLUTIONS:[1,.5,.25,.125,.0625,.03125,.015625,.0078125,.00390625,.001953125,976563e-9,488281e-9,244141e-9,12207e-8,6103515625e-14,30517578125e-15,152587890625e-16,762939453125e-17,3814697265625e-18,19073486328125e-19],resolution:null,rows:null,cols:null,offset_x:0,offset_y:0,lrow:0,urow:0,lcol:0,rcol:0,initialize:function(e,i){GeoBeans.Layer.TileLayer.prototype.initialize.apply(this,arguments),this.type=GeoBeans.Layer.TileLayer.Type.QS},destroy:function(){GeoBeans.Layer.TileLayer.prototype.destroy.apply(this,arguments)},updateTileCache:function(e){var i,t,a,s,l=e.rmin,o=e.rmax,n=e.cmin,r=e.cmax,h=null,c=this.map.level;for(a=l;a<o;a++)for(s=n;s<r;s++)i=this.getTileID(a,s,c),t=this.url+"&"+i,null==this.cache.getTile(t)&&(h=new GeoBeans.Tile(this.map,t,this,a,s,c,0,0),this.cache.putTile(h))},preDraw:function(){var e=this.map.level,i=this.getMaxLevel(),t=this.getMinLevel();if(e>i||e<t)return this.tiles=[],this.renderer.clearRect(),void(this.snap=null);var a=this.computeTileBound();console.log(a),this.updateTileCache(a);var s=a.rmin,l=a.rmax,o=a.cmin,n=a.cmax,r=this.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymin);r.x=Math.floor(r.x+.5),r.y=Math.floor(r.y+.5);var h=this.IMG_WIDTH*this.imageScale;if(this!=this.map.baseLayer){var c=this.map.resolution,m=this.getResolutionByLevel(this.map.level);c!=m&&(h=this.IMG_WIDTH*this.imageScale*m/c)}var u,T,y,f,L;this.tiles=[];var e=this.map.level;for(T=r.y-(s+1)*h,y=s;y<l;y++){for(u=r.x+o*h,f=o;f<n;f++){tid=this.getTileID(y,f,e),turl=this.url+"&"+tid,L=this.cache.getTile(turl);var x=new Object;x.tile=L,x.img_size=h,x.x=u,x.y=T,this.tiles.push(x),u+=h}T-=h}},loadingTiles:function(e){for(var i=0;i<this.tiles.length;++i){var t=this.tiles[i].tile;if(null!=t)if(t.state!=GeoBeans.TileState.LOADED)t.loading(e,this.loadTileCallback,this.tiles,i),this.state=GeoBeans.TileLayerState.LOADING;else if(t.state==GeoBeans.TileState.LOADED){var a=this.tiles[i],s=a.img_size,l=a.x,o=a.y;t.draw(l,o,s,s)}}},loadTileCallback:function(e,i,t,a){var s=t[a],l=s.img_size,o=s.x,n=s.y;e.draw(o,n,l,l)},draw:function(){for(var e=0;e<this.tilesLoaded.length;++e){var i=this.tilesLoaded[e],t=i.tile,a=i.img_size,s=i.x,l=i.y;null!=t&&t.draw(s,l,a,a)}},drawCache:function(){var e=this.computeTileBound(),i=e.rmin,t=e.rmax,a=e.cmin,s=e.cmax,l=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymin);l.x=Math.floor(l.x+.5),l.y=Math.floor(l.y+.5);var o,n,r,h,c,m=this.IMG_WIDTH*this.scale,u=this.map.level;for(n=l.y-(i+1)*m,r=i;r<t;r++){for(o=l.x+a*m,h=a;h<s;h++)tid=this.getTileID(r,h,u),turl=this.url+"&"+tid,c=this.cache.getTile(turl),null!=c&&c.draw(o,n,m,m),o+=m;n-=m}},getRows:function(){},getCols:function(){},computeExtent:function(){},computeCenterTileOffset:function(){var e=this.map.center,i=(e.x-this.ORIGIN.x,e.y-this.ORIGIN.y,Math.floor((e.x-this.ORIGIN.x)/this.resolution)),t=Math.floor((e.y-this.ORIGIN.y)/this.resolution);offset_x=i,offset_y=t},getTileID:function(e,i,t){return"col="+i+"&row="+e+"&level="+t},computeTileBound:function(){var e=this.map,i=e.level,t=this.getResolutionByLevel(i),a=t*this.IMG_WIDTH,s=this.getValidView(),l=Math.floor((s.xmin-this.FULL_EXTENT.xmin)/a),o=Math.ceil((s.xmax-this.FULL_EXTENT.xmin)/a),n=Math.floor((s.ymin-this.FULL_EXTENT.ymin)/a),r=Math.ceil((s.ymax-this.FULL_EXTENT.ymin)/a);return{rmin:n-1,rmax:r+1,cmin:l-1,cmax:o+1}},toScreenPoint:function(e,i){var t=this.map.transformation,a=t.scale*(e-t.view_c.x)+t.win_cx,s=t.win_cy-t.scale*(i-t.view_c.y);return new GeoBeans.Geometry.Point(a,s)}});
