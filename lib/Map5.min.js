...
GeoBeans.Layer.QSLayer=GeoBeans.Class(GeoBeans.Layer.TileLayer,{AMP_URL:"/QuadServer/maprequest?services=world_image",IMG_WIDTH:256,IMG_HEIGHT:256,MIN_ZOOM_LEVEL:2,MAX_ZOOM_LEVEL:17,FULL_EXTENT:{xmin:-256,ymin:-256,xmax:256,ymax:256},RESOLUTIONS:[1,.5,.25,.125,.0625,.03125,.015625,.0078125,.00390625,.001953125,976563e-9,488281e-9,244141e-9,12207e-8,6103515625e-14,30517578125e-15,152587890625e-16,762939453125e-17,3814697265625e-18,19073486328125e-19],resolution:null,rows:null,cols:null,offset_x:0,offset_y:0,lrow:0,urow:0,lcol:0,rcol:0,initialize:function(e,t){GeoBeans.Layer.TileLayer.prototype.initialize.apply(this,arguments),this.type=GeoBeans.Layer.TileLayer.Type.QS},destroy:function(){GeoBeans.Layer.TileLayer.prototype.destroy.apply(this,arguments)},updateTileCache:function(e){var t,i,a,l,s=e.rmin,o=e.rmax,n=e.cmin,r=e.cmax,h=null,m=this.map.level;for(a=s;o>a;a++)for(l=n;r>l;l++)t=this.getTileID(a,l,m),i=this.url+"&"+t,null==this.cache.getTile(i)&&(h=new GeoBeans.Tile(this.map,i,this,a,l,m,0,0),this.cache.putTile(h))},preDraw:function(){var e=this.computeTileBound();console.log(e),console.log(this.map.level),this.updateTileCache(e);var t=e.rmin,i=e.rmax,a=e.cmin,l=e.cmax,s=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymin);s.x=Math.floor(s.x+.5),s.y=Math.floor(s.y+.5);var o,n,r,h,m,c=this.IMG_WIDTH*this.imageScale;this.map.transformation.toMapPoint(s.x,s.y);this.tiles=[];var u=this.map.level;for(n=s.y-(t+1)*c,r=t;i>r;r++){for(o=s.x+a*c,h=a;l>h;h++){tid=this.getTileID(r,h,u),turl=this.url+"&"+tid,m=this.cache.getTile(turl);var T=new Object;T.tile=m,T.img_size=c,T.x=o,T.y=n,this.tiles.push(T),o+=c}n-=c}},loadingTiles:function(e){for(var t=0;t<this.tiles.length;++t){var i=this.tiles[t].tile;if(null!=i)if(i.state!=GeoBeans.TileState.LOADED)i.loading(e,this.loadTileCallback,this.tiles,t),this.state=GeoBeans.TileLayerState.LOADING;else if(i.state==GeoBeans.TileState.LOADED){var a=this.tiles[t],l=a.img_size,s=a.x,o=a.y;i.draw(s,o,l,l)}}},loadTileCallback:function(e,t,i,a){var l=i[a],s=l.img_size,o=l.x,n=l.y;e.draw(o,n,s,s)},draw:function(){for(var e=0;e<this.tilesLoaded.length;++e){var t=this.tilesLoaded[e],i=t.tile,a=t.img_size,l=t.x,s=t.y;null!=i&&i.draw(l,s,a,a)}},drawCache:function(){var e=this.computeTileBound(),t=e.rmin,i=e.rmax,a=e.cmin,l=e.cmax,s=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymin);s.x=Math.floor(s.x+.5),s.y=Math.floor(s.y+.5);var o,n,r,h,m,c=this.IMG_WIDTH*this.scale,u=this.map.level;for(n=s.y-(t+1)*c,r=t;i>r;r++){for(o=s.x+a*c,h=a;l>h;h++)tid=this.getTileID(r,h,u),turl=this.url+"&"+tid,m=this.cache.getTile(turl),null!=m&&m.draw(o,n,c,c),o+=c;n-=c}},getRows:function(){},getCols:function(){},computeExtent:function(){},computeCenterTileOffset:function(){var e=this.map.center,t=(e.x-this.ORIGIN.x,e.y-this.ORIGIN.y,Math.floor((e.x-this.ORIGIN.x)/this.resolution)),i=Math.floor((e.y-this.ORIGIN.y)/this.resolution);offset_x=t,offset_y=i},getTileID:function(e,t,i){return"col="+t+"&row="+e+"&level="+i},computeTileBound:function(){var e=this.map,t=e.level,i=this.getResolutionByLevel(t),a=i*this.IMG_WIDTH,l=this.getValidView(),s=Math.floor((l.xmin-this.FULL_EXTENT.xmin)/a),o=Math.ceil((l.xmax-this.FULL_EXTENT.xmin)/a),n=Math.floor((l.ymin-this.FULL_EXTENT.ymin)/a),r=Math.ceil((l.ymax-this.FULL_EXTENT.ymin)/a);return{rmin:n-1,rmax:r+1,cmin:s-1,cmax:o+1}}});
