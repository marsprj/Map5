...
GeoBeans.Control.DragMapControl=GeoBeans.Class(GeoBeans.Control,{onmousedown:null,initialize:function(e){GeoBeans.Control.prototype.initialize.apply(this,arguments),this.map=e,this.type="DragMapControl";var t=this,o=function(e){if(t.enabled&&"CANVAS"==e.target.tagName.toUpperCase()){e.preventDefault();var o,n,a,r,i=t.map,s=i.saveSnap(),p=0,l=0;i.width,i.height;o=e.layerX,n=e.layerY;var d=i.transformation.toMapPoint(o,n),u=!0,v=function(e){if(e.preventDefault(),u){t.map.closeTooltip(),t.draging=!0,document.body.style.cursor="pointer",p+=e.layerX-o,l+=e.layerY-n,i.drawBackground(),i.putSnap(p,l);var s=i.transformation.toMapPoint(e.layerX,e.layerY);a=d.x-s.x,r=d.y-s.y,i.offset(a,r);var v=i.infoWindow;if(null!=v){var m=i.mapDiv.find(".popover");if(1==m.length){var y=(v.attr("x"),v.attr("y"),i.width),f=i.height,c=v.css("left"),h=v.css("top");c=parseInt(c.slice(0,c.indexOf("px"))),h=parseInt(h.slice(0,h.indexOf("px"))),c+=e.layerX-o,h+=e.layerY-n;var g=m.css("width"),x=m.css("height");g=parseInt(g.slice(0,g.indexOf("px"))),x=parseInt(x.slice(0,x.indexOf("px"))),0>c-g/2||c+g/2>y||0>h-x||h>f?(v.popover("hide"),i.queryLayer.clearFeatures()):(v.css("left",c+"px"),v.css("top",h+"px"),v.popover("hide").popover("show"),m.find(".popover-title").append('<button type="button" class="close">&times;</button>'),m.find(".popover-title").find(".close").click(function(){$(this).parents(".popover").popover("hide")}))}}o=e.layerX,n=e.layerY}},m=function(e){e.preventDefault(),s=null,u=!1,t.draging=!1;var o=i.transformation.toMapPoint(e.layerX,e.layerY);a=d.x-o.x,r=d.y-o.y,i.draw(),i.cleanupSnap(),document.body.style.cursor="default",i.mapDiv[0].removeEventListener("mousemove",v),i.mapDiv[0].removeEventListener("mouseup",m)};i.mapDiv[0].addEventListener("mousemove",v),i.mapDiv[0].addEventListener("mouseup",m)}};this.onmousedown=o,this.map.mapDiv[0].addEventListener("mousedown",this.onmousedown)},destory:function(){this.map.mapDiv[0].removeEventListener("mousedown",this.onmousedown),GeoBeans.Control.prototype.destory.apply(this,arguments)}});
...
GeoBeans.Layer.HeatMapLayer=GeoBeans.Class(GeoBeans.Layer,{name:null,container:null,data:null,layer:null,field:null,uniqueValue:null,heatmapInstance:null,div:null,config:null,initialize:function(e,a){this.name=e,this.config=a},setMap:function(e){if(null!=e){this.map=e,this.div=document.createElement("div"),this.div.className="heatmap";var a=e.canvas,n=a.height,t=a.width;this.div.style.cssText="height:"+n+"px;width:"+t+"px;";var i=null;null!=this.config&&null!=this.config.gradient&&(i=this.config.gradient),this.heatmapInstance=h337.create({container:this.div,gradient:i,radius:30})}},destory:function(){this.name=null,this.layer=null,this.field=null,this.heatmapInstance=null},setLayer:function(e,a,n){null!=e&&(null!=a||null!=n)&&(this.layer=e,this.field=a,this.uniqueValue=n)},getField:function(){return this.field},getUniqueValue:function(){return this.uniqueValue},load:function(){var e=this.layer.featureType;if(null==e)return void(this.flag=GeoBeans.Layer.Flag.LOADED);var a=e.getFieldIndex(this.field);if(0>a&&null==this.uniqueValue)return void(this.flag=GeoBeans.Layer.Flag.LOADED);var n,t,i=null,l=null,u=[],s=null,r=this.layer.map.transformation,h=this.map.getViewer();if(null==h)return void(this.flag=GeoBeans.Layer.Flag.LOADED);var o=this.layer.getFeatureBBoxGet(h);if(null==o)return void(this.flag=GeoBeans.Layer.Flag.LOADED);for(var d=0;d<o.length;++d){var f=o[d],c=f.geometry;c instanceof GeoBeans.Geometry.Point&&(s=r.toScreenPoint(c.x,c.y)),0>a&&null!=this.uniqueValue?(n=this.uniqueValue,l=n,i=n):a>=0&&(n=f.values[a],0==d&&(i=n,l=n),i=Math.max(n,i),l=Math.min(n,l)),t={x:s.x,y:s.y,value:n},u.push(t)}var g={max:i,min:l,data:u};this.heatmapInstance.setData(g),this.canvas=this.div.children[0],this.flag=GeoBeans.Layer.Flag.LOADED}});
...
GeoBeans.Layer.AQIChartLayer=GeoBeans.Class(GeoBeans.Layer.ChartLayer,{chartField:null,labelField:null,timeField:null,timePoint:null,styleMgr:null,featuresAll:null,tipInfos:null,flagField:null,changeLegend:!0,colorMap:null,isTimeline:!1,initialize:function(e,t,a,i,n,l,s,r,o){this.name=e,this.dbName=t,this.tableName=a,this.chartField=i,this.labelField=n,this.flagField=l,this.timeField=s,this.timePoint=r,this.chartOption=o,this.type=GeoBeans.Layer.ChartLayer.Type.AQI},setChartOption:function(e){this.chartOption=e,this.features=null,this.changeLegend=!0;var t=this.chartOption.colorMapID,a=this.styleMgr.getColorMapByID(t);this.colorMap=a},getChartField:function(){return this.chartField},setChartField:function(e){this.chartField=e,this.features=null,this.changeLegend=!0},getFlagField:function(){return this.flagField},getTimeField:function(){return this.timeField},getTimePoint:function(){return this.timePoint},setTimePoint:function(e){this.timePoint=e,this.features=null},getLableField:function(){return this.labelField},setMap:function(e,t){GeoBeans.Layer.prototype.setMap.apply(this,arguments);var a=new GeoBeans.WFSWorkspace("tmp",this.map.server,"1.0.0"),i=new GeoBeans.FeatureType(a,this.tableName);this.featureType=i;var n=(i.getFields(null,this.dbName),this.map.server.slice(0,this.map.server.lastIndexOf("/mgr")));this.styleMgr=new GeoBeans.StyleManager(n);var l=this.chartOption.colorMapID,s=this.styleMgr.getColorMapByID(l);this.colorMap=s,null!=t&&(this.isTimeline=t),t||e._addLegend(this)},load:function(){var e=this.map.viewer;if(null==this.minMaxValue){var t=this.getMinMaxValue();if(null==t)return;this.minMaxValue=t}return this.drawLegend(),null!=e&&null!=this.viewer&&e.equal(this.viewer)&&null!=this.features?void(this.flag=GeoBeans.Layer.Flag.LOADED):(this.viewer=new GeoBeans.Envelope(e.xmin,e.ymin,e.xmax,e.ymax),this.getFeatures(),void(this.flag=GeoBeans.Layer.Flag.READY))},drawLegend:function(){if(!this.isTimeline){if(this.changeLegend)this.removeLegend(),this.addLegend(),this.changeLegend=!1;else{var e=this.map.mapDiv.find(".chart-legend#"+this.name),t=parseInt(e.attr("lindex"));t!=this.legendIndex&&(this.removeLegend(),this.addLegend())}return this.visible?void this.showLegend():void this.hideLegend()}},getFeatures:function(){var e=new GeoBeans.BinaryLogicFilter;e.operator=GeoBeans.LogicFilter.OperatorType.LogicOprAnd;var t=new GeoBeans.BinaryComparisionFilter;t.operator=GeoBeans.ComparisionFilter.OperatorType.ComOprEqual;var a=new GeoBeans.PropertyName;a.setName(this.timeField);var i=new GeoBeans.Literal;i.setValue(this.timePoint),t.expression1=a,t.expression2=i,e.addFilter(t);var n=this.featureType.geomFieldName,l=this.map.viewer,s=new GeoBeans.BBoxFilter;s.extent=l,a=new GeoBeans.PropertyName,a.setName(n),s.propName=a,e.addFilter(s),this.featureType.getFeaturesFilterAsync2(null,this.dbName,e,null,null,[this.chartField,n,this.labelField,this.flagField],null,this,this.getFeatures_callback)},getFeatures:function(){if(null!=this.features)return void this.draw();var e=new GeoBeans.BinaryComparisionFilter;e.operator=GeoBeans.ComparisionFilter.OperatorType.ComOprEqual;var t=new GeoBeans.PropertyName;t.setName(this.timeField);var a=new GeoBeans.Literal;a.setValue(this.timePoint),e.expression1=t,e.expression2=a;var i=this.featureType.geomFieldName;this.featureType.getFeaturesFilterAsync2(null,this.dbName,e,null,null,[this.chartField,i,this.labelField,this.flagField],null,this,this.getFeatures_callback)},getFeatures_callback:function(e,t){null!=e&&null!=t&&(e.features=t,e.draw())},draw:function(){this.style=this.getStyle(),this.flag=GeoBeans.Layer.Flag.READY,this.setTransformation(this.map.transformation),this.drawLayerSnap(),this.renderer.clearRect(),this.drawAQIChart(),this.drawLegend(),this.flag=GeoBeans.Layer.Flag.LOADED,this.map.drawLayersAll()},drawAQIChart:function(){var e=this.chartOption.type;"point"==e?(this.renderer.context.globalCompositeOperation="lighter",this.drawByValue()):"tip"==e&&(this.renderer.context.globalCompositeOperation="source-over",this.showTips(),this.drawLayer())},showTips:function(){if(null!=this.features&&null!=this.chartOption&&null!=this.colorMap&&null!=this.minMaxValue){this.tipInfos=[];for(var e=new GeoBeans.ColorRangeMap(this.colorMap.startColor,this.colorMap.endColor,this.minMaxValue.min,this.minMaxValue.max),t=this.featureType.getFieldIndex(this.chartField),a=this.featureType.getFieldIndex(this.labelField),i=this.featureType.getFieldIndex(this.flagField),n=null,l=null,s=null,r=0;r<this.features.length;++r)if(l=this.features[r],null!=l&&(s=l.geometry,null!=s)){var o=l.values;if(null!=o){n=o[t],n=parseFloat(n);var h=e.getValue(n),u=new GeoBeans.Rule,d=new GeoBeans.Symbolizer.PolygonSymbolizer,m=new GeoBeans.Fill;m.color=h,d.fill=m;var c=new GeoBeans.Stroke;c.color=h,c.width=.5,d.stroke=c,u.symbolizer=d;var p=new GeoBeans.Symbolizer.TextSymbolizer;p.labelText=n;var f=new GeoBeans.Font;f.family="宋体",f.style="normal",f.weight="normal",f.size="12",p.font=f;var v=new GeoBeans.Color;v.setByHex("#ffffff",1);var m=new GeoBeans.Fill;m.color=v,p.fill=m,u.textSymbolizer=p;var y=o[a],g=new GeoBeans.Rule,w=new GeoBeans.Symbolizer.PolygonSymbolizer,m=new GeoBeans.Fill;v=new GeoBeans.Color,v.setByHex("#ffffff",1),m.color=v,w.fill=m;var c=new GeoBeans.Stroke;c.color=h,c.width=.5,w.stroke=c,g.symbolizer=w;var p=new GeoBeans.Symbolizer.TextSymbolizer;p.labelText=y;var f=new GeoBeans.Font;f.family="宋体",f.style="normal",f.weight="normal",f.size="12",p.font=f;var v=new GeoBeans.Color;v.setByHex("#000000",1);var m=new GeoBeans.Fill;m.color=v,p.fill=m,g.textSymbolizer=p;var F=o[i],x=this.renderer.drawTip(s,this.map.transformation,u,g),B={flag:F,viewer:x,name:y};this.tipInfos.push(B)}}}},getMinMaxValue:function(){var e=this.chartField,t=0,a=500;switch(e){case"aqi":t=0,a=500;break;case"co":t=0,a=90;break;case"co_24h":t=0,a=90;break;case"no2":t=0,a=100;break;case"no2_24h":t=0,a=100;break;case"o3":t=0,a=200;break;case"o3_24h":t=0,a=200;break;case"o3_8h":t=0,a=200;break;case"o3_8h_24h":t=0,a=200;break;case"pm10":t=0,a=500;break;case"pm10_24":t=0,a=500;break;case"pm2_5":t=0,a=300;break;case"pm_2_5_24h":t=0,a=300;break;case"so2":t=0,a=500;break;case"so2_24h":t=0,a=500;break;default:t=0,a=500}return{min:t,max:a}},getStyle:function(){var e=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.Point),t=new GeoBeans.Rule,a=new GeoBeans.Symbolizer.PointSymbolizer,i=new GeoBeans.Color;return i.setByHex("#A4C3F2",1),a.fill.color=i,i=new GeoBeans.Color,i.setByHex("#808000",.1),a.stroke.color=i,a.size=1,t.symbolizer=a,e.addRule(t),e},addLegend:function(){if(null!=this.minMaxValue&&null!=this.minMaxValue.min&&null!=this.minMaxValue.max){var e=0;if(0==this.legendIndex)e=10;else{var t=this.legendIndex-1,a=this.map.mapDiv.find(".chart-legend[lindex='"+t+"']");if(0!=a.length){var i=a.css("left"),n=a.css("width");i=parseInt(i.replace("px","")),n=parseInt(n.replace("px","")),e=i+n+5}}var l="",l="<div class='chart-legend chart-legend-aqi' id='"+this.name+"' style='left:"+e+"px' lindex='"+this.legendIndex+"'>";l+="<div class='chart-legend-title'><h5>"+this.chartField+"</h5></div>",l+="<div class='chart-legend-canvas'>	<canvas width='20' height='200'></canvas></div><div class='chart-legend-value'><div class='chart-legend-max'>"+this.minMaxValue.max+"</div><div class='chart-legend-min'>"+this.minMaxValue.min+"</div></div>",l+="</div>",this.map.mapDiv.append(l);var s=this.map.mapDiv.find("#"+this.name+" .chart-legend-canvas canvas"),r=s[0].getContext("2d"),o=new Image;o.src=this.colorMap.url,o.onload=function(){var e=s.width()/2,t=s.height()/2,a=o.width,i=o.height;r.clearRect(0,0,a,i),r.translate(e,t),r.rotate(270*Math.PI/180),r.drawImage(o,-a/2,-i/2,a,i),r.rotate(-270*Math.PI/180),r.translate(-e,-t)}}},registerHitEvent:function(e,t){var a=this,i=null,n=null,l=3;this.hitEvent=function(s){if(null==i){i=s.layerX,n=s.layerY;var r=new GeoBeans.Geometry.Point(i,n),o=a.map.transformation.toMapPoint(r.x,r.y),h=a.getTipInfo(r);if(null!=h){var u={title:h.name},d=new GeoBeans.InfoWindow(e,u);a.map.openInfoWindow(d,o),null!=t&&t(h.flag,h.name,a)}}else{var m=Math.abs(s.layerX-i)+Math.abs(s.layerY-n);if(m>l){i=s.layerX,n=s.layerY;var r=new GeoBeans.Geometry.Point(i,n),o=a.map.transformation.toMapPoint(r.x,r.y),h=a.getTipInfo(r);if(null!=h){var u={title:h.name},d=new GeoBeans.InfoWindow(e,u);a.map.openInfoWindow(d,o),null!=t&&t(h.flag,h.name,a)}}}};var s=null,r=null;this.moveEvent=function(e){if(null==s)s=e.layerX,r=e.layerY;else{var t=Math.abs(e.layerX-s)+Math.abs(e.layerY-r);if(t>l){s=e.layerX,r=e.layerY;var i=new GeoBeans.Geometry.Point(s,r),n=(a.map.transformation.toMapPoint(i.x,i.y),a.getTipInfo(i));null!=n?document.body.style.cursor="pointer":document.body.style.cursor="default"}}},this.map.canvas.addEventListener("click",this.hitEvent),this.map.canvas.addEventListener("mousemove",this.moveEvent)},unRegisterHitEvent:function(){this.map.canvas.removeEventListener("click",this.hitEvent),this.map.canvas.removeEventListener("mousemove",this.moveEvent),this.hitEvent=null,this.moveEvent=null},setVisiable:function(e){GeoBeans.Layer.prototype.setVisiable.apply(this,arguments),this.visible?null!=this.hitEvent&&(this.map.canvas.addEventListener("click",this.hitEvent),this.map.canvas.addEventListener("mousemove",this.moveEvent)):null!=this.hitEvent&&(this.map.canvas.removeEventListener("click",this.hitEvent),this.map.canvas.removeEventListener("mousemove",this.moveEvent))},getTipInfo:function(e){for(var t=null,a=null,i=null,n=null,l=this.chartOption.type,s=this.tipInfos.length;s>=0;s--)if(t=this.tipInfos[s],null!=t)if("point"==l){i=t.center,n=t.radius;var r=Math.sqrt((i.x-e.x)*(i.x-e.x)+(i.y-e.y)*(i.y-e.y));if(n>r)return t}else if("tip"==l&&(a=t.viewer,a.contain(e.x,e.y)))return t;return null},drawByValue:function(){if(null!=this.features&&null!=this.chartOption&&null!=this.colorMap&&null!=this.minMaxValue){var e=this.featureType.getFieldIndex(this.chartField),t=this.featureType.getFieldIndex(this.labelField),a=this.featureType.getFieldIndex(this.flagField),i=.8,n=this.features,l=null,s=null,r=null,o=null,h=null,u=null,d=null;this.renderer.save(),this.tipInfos=[];for(var m=0;m<n.length;++m)if(s=n[m],null!=s&&(l=s.geometry,null!=l&&(r=s.values,null!=r))){o=r[e],o=parseFloat(o),h=o/10,u=this.colorFunctionByColorMap(o),d=new GeoBeans.Color,d.setByHex(u,i),this.renderer.context.fillStyle=d.getRgba(),spt=this.map.transformation.toScreenPoint(l.x,l.y),this.renderer.context.beginPath(),this.renderer.context.arc(spt.x,spt.y,h,0,2*Math.PI),this.renderer.context.fill(),this.renderer.context.closePath();var c=r[a],p=r[t],f={flag:c,center:spt,radius:h,name:p};this.tipInfos.push(f)}this.renderer.restore()}},colorFunctionByColorMap:function(e){var t=this.minMaxValue,a=t.min,i=t.max,n=(this.colorMap,this.colorMap.startColor),l=this.colorMap.endColor;if(a>e)return n;if(e>i)return l;var s=new GeoBeans.Color;s.setByHex(n,1);var r=s.getHsl(),o=new GeoBeans.Color;o.setByHex(l,1);var h=o.getHsl(),u=r.h+(e-a)*(h.h-r.h)/(i-a),d=r.s+(e-a)*(h.s-r.s)/(i-a),m=r.l+(e-a)*(h.l-r.l)/(i-a),c=new GeoBeans.Color;return c.setByHsl(u,d,m),c.getHex()}});
...
GeoBeans.Service=GeoBeans.Class({name:null,mapName:null,url:null,layers:null,srid:null,extent:null,thumb:null,initialize:function(l,e,n,s,t,i,a){this.name=l,this.mapName=e,this.url=n,this.layers=s,this.srid=t,this.extent=i,this.thumb=a},getWMSLayers:function(){if(!$.isArray(this.layers))return null;for(var l=null,e=[],n=0;n<this.layers.length;++n)l=this.layers[n],null!=l&&e.push(l.name);return e}});
GeoBeans.ServiceManager=GeoBeans.Class({service:"ims",version:"1.0.0",server:null,services:null,initialize:function(e){this.server=e+"/mgr"},describeServices:function(e){var i=this,r="service="+this.service+"&version="+this.version+"&request=DescribeService";$.ajax({type:"get",url:this.server,data:encodeURI(r),dataType:"xml",async:!0,beforeSend:function(e){},success:function(r,t){i.services=i.parseServices(r),void 0!=e&&e(i.services)},complete:function(e,i){},error:function(){}})},describeService:function(e,i){if(null!=e){var r=this,t="service="+this.service+"&version="+this.version+"&request=DescribeService&name="+e;$.ajax({type:"get",url:this.server,data:encodeURI(t),dataType:"xml",async:!0,beforeSend:function(e){},success:function(e,t){var n=r.parseService(e);void 0!=i&&i(n)},complete:function(e,i){},error:function(){}})}},createService:function(e,i,r,t){if(null==e||null==i||null==r)return void(null!=t&&t("params is null"));var n=this,s="service="+this.service+"&version="+this.version+"&request=createService&name="+e+"&mapName="+i+"&uri="+r;$.ajax({type:"get",url:this.server,data:encodeURI(s),dataType:"xml",async:!0,beforeSend:function(e){},success:function(e,i){var r=n.parseCreateService(e);void 0!=t&&t(r)},complete:function(e,i){},error:function(){}})},removeService:function(e,i){if(null==e)return void(null!=i&&i("name is null"));var r=this,t="service="+this.service+"&version="+this.version+"&request=RemoveService&name="+e;$.ajax({type:"get",url:this.server,data:encodeURI(t),dataType:"xml",async:!0,beforeSend:function(e){},success:function(e,t){var n=r.parseRemoveService(e);void 0!=i&&i(n)},complete:function(e,i){},error:function(){}})},parseServices:function(e){if(null==e)return null;var i=$(e).find("ExceptionText").text();if(""!=i)return console.log(i),null;var r=[],t=this;return $(e).find("Service").each(function(){var e=t.parseService(this);null!=e&&r.push(e)}),r},parseService:function(e){if(null==e)return null;var i=$(e).find("ExceptionText").text();if(""!=i)return console.log(i),null;var r=$(e).find("Name").first().text(),t=$(e).find("Map").first().text(),n=$(e).find("BoundingBox"),s=this.parseBoundingBox(n),a=$(e).find("SRID").first().text(),c=$(this).find("Thumbnail").first().text(),o=[],u=this;$(e).find("Layers>Layer").each(function(){var e=($(this).attr("queryable"),$(this).attr("visible")),i=$(this).attr("id"),r=$(this).find("Name").text(),t=$(this).find("CRS").text(),n=$(this).find("Type").text(),s=$(this).find("BoundingBox"),a=u.parseBoundingBox(s),c={name:r,id:i,srid:t,visible:e,type:n,extent:a};o.push(c)});var v=new GeoBeans.Service(r,t,null,o,a,s,c);return v},parseBoundingBox:function(e){if(null==e)return null;var i=parseFloat($(e).attr("minx")),r=parseFloat($(e).attr("miny")),t=parseFloat($(e).attr("maxx")),n=parseFloat($(e).attr("maxy"));return $.isNumeric(i)&&$.isNumeric(t)&&$.isNumeric(r)&&$.isNumeric(n)?new GeoBeans.Envelope(i,r,t,n):null},parseRemoveService:function(e){var i="",r=$(e).find("RemoveService").text();return"SUCCESS"==r.toUpperCase()?i="success":""!=$(e).find("ExceptionText").text()&&(i=$(e).find("ExceptionText").text()),i},parseCreateService:function(e){var i="",r=$(e).find("CreateService").text();return"SUCCESS"==r.toUpperCase()?i="success":""!=$(e).find("ExceptionText").text()&&(i=$(e).find("ExceptionText").text()),i}});