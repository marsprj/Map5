...
GeoBeans.Utility={getDistance:function(t,a,h,M){return Math.sqrt((t-h)*(t-h)+(a-M)*(a-M))},distance2segment:function(t,a,h,M,r,o){var s=0;if(Math.abs(h-r)<Math.ESPLON){var e=o>M?M:o,n=M>o?M:o;a>e&&n>a?s=Math.abs(t-h):e>a?s=Math.sqrt(Math.pow(t-h,2)+Math.pow(a-e,2)):a>n&&(s=Math.sqrt(Math.pow(t-h,2)+Math.pow(a-n,2)))}else if(Math.abs(M-o)<Math.ESPLON){var p=r>h?h:r,w=h>r?h:r;t>p&&w>t?s=Math.abs(a-M):p>t?s=Math.sqrt(Math.pow(a-M,2)+Math.pow(t-p,2)):a>n&&(s=Math.sqrt(Math.pow(a-M,2)+Math.pow(t-w,2)))}else{var i=-(r-h)/(o-M),q=-1/i,u=M-q*h,f=a-i*t,v=i-q,c=(u-f)/v,b=i*c+f,p=r>h?h:r,w=h>r?h:r;if(c>p&&w>c||b>e&&n>b)s=Math.sqrt(Math.pow(a-b,2)+Math.pow(t-c,2));else{var d=Math.sqrt(Math.pow(M-b,2)+Math.pow(h-c,2)),l=Math.sqrt(Math.pow(o-b,2)+Math.pow(r-c,2));s=l>d?d:l}}return s},getRandom:function(t,a){var h=a-t,M=Math.random();return t+Math.round(M*h)}};
...
GeoBeans.Layer.FeatureLayer=GeoBeans.Class(GeoBeans.Layer,{features:null,style:null,geometryType:null,featureType:null,enableHit:!1,selection:null,unselection:null,hitControl:null,hitEvent:null,hitTooltipEvent:null,hitCanvas:null,hitRenderer:null,bufferCanvas:null,bufferRenderer:null,bufferFeatures:null,bufferSymbolizer:null,clickStyle:null,clickFeature:null,clickCanvas:null,clickRenderer:null,bufferTracker:null,initialize:function(e){GeoBeans.Layer.prototype.initialize.apply(this,arguments),this.featureType=null,this.features=null,this.selection=[],this.unselection=[]},destory:function(){this.features=null,this.style=null,this.renderer=null,this.geometryType=null,this.featureType=null,GeoBeans.Layer.prototype.destroy.apply(this,arguments)},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments),this.clickCanvas=document.createElement("canvas"),this.clickCanvas.width=this.canvas.width,this.clickCanvas.height=this.canvas.height,this.clickRenderer=new GeoBeans.Renderer(this.clickCanvas)},addFeature:function(e){null!=e&&(null==this.features&&(this.features=[]),this.features.push(e))},addFeatureObj:function(e,t,r){if(null!=e&&null!=r&&null!=t){var a=new GeoBeans.Feature(this.featureType,e,t,r);this.addFeature(a)}},addFeatures:function(e){if(null!=e&&e instanceof Array)for(var t=0,r=e.length;r>t;t++){var a=e[t];this.features.push(a)}},getFeature:function(e){return 0>e?null:e>=this.features.length?null:this.features[e]},getFeatureByID:function(e){if(null==this.features)return null;for(var t=null,r=0;r<this.features.length;++r)if(t=this.features[r],null!=t&&t.fid==e)return t;return null},setStyle:function(e){this.style=e},count:function(){return this.features.length},draw:function(){var e=this.style;if(null!=e&&(rules=e.rules,0!=rules.length))for(var t=0;t<rules.length;t++){var r=rules[t],a=this.selectFeatures(r.filter);this.drawFeatures(a,r.symbolizer)}},load:function(){this.flag=GeoBeans.Layer.Flag.LOADED,this.renderer.clearRect(),this.drawLayer()},drawLayer:function(){var e=this.style;if(null==e){if(e=this.getDefaultStyle(),null==e)return;this.style=e}if(rules=e.rules,0!=rules.length){for(var t=0;t<rules.length;t++){var r=rules[t],a=this.selectFeaturesByFilter(r.filter,this.features);null!=r.symbolizer&&(null!=r.symbolizer.symbol?this.renderer.drawIcons(a,r.symbolizer,this.map.transformation):this.drawFeatures(a,r.symbolizer)),null!=r.textSymbolizer&&this.labelFeatures(a,r.textSymbolizer)}this.drawClickLayer()}},getGeomType:function(){var e=this.featureType;if(null==e)return null;var t=e.geomFieldName;if(null==t)return null;var r=e.getFieldIndex(t);if(null==r)return null;var a=e.fields[r];if(null==a)return null;var n=a.geomType;return n},getDefaultStyle:function(){var e=this.getGeomType(),t=null;switch(e){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.Point);var r=new GeoBeans.Rule,a=new GeoBeans.Symbolizer.PointSymbolizer;r.symbolizer=a,t.addRule(r);break;case GeoBeans.Geometry.Type.LINESTRING:case GeoBeans.Geometry.Type.MULTILINESTRING:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.LineString);var r=new GeoBeans.Rule,a=new GeoBeans.Symbolizer.LineSymbolizer;r.symbolizer=a,t.addRule(r);break;case GeoBeans.Geometry.Type.POLYGON:case GeoBeans.Geometry.Type.MULTIPOLYGON:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.Polygon);var r=new GeoBeans.Rule,a=new GeoBeans.Symbolizer.PolygonSymbolizer;r.symbolizer=a,t.addRule(r)}return t},drawFeatures:function(e,t){if(0!=e.length){this.renderer.save(),this.renderer.setSymbolizer(t);for(var r=0,a=e.length;a>r;r++)feature=e[r],null!=t&&"undefined"!=t&&this.renderer.draw(feature,t,this.map.transformation);this.renderer.restore()}},labelFeatures:function(e,t){var r=e.length;if(0!=r){this.renderer.save(),this.renderer.setSymbolizer(t);var a=e[0],n=null,i=t.labelText;if(null==i||0==i.length){var s=t.labelProp;if(null!=s)var l=a.featureType.getFieldIndex(s)}else n=i;for(var u=null,o=null,h=null,f=0,r=e.length;r>f;f++)a=e[f],o=a.geometry,null!=o&&(h=new GeoBeans.PointLabel,h.geometry=o,h.textSymbolizer=t,u=null==n?a.values[l]:n,h.text=u,h.computePosition(this.renderer,this.map.transformation),this.renderer.drawLabel(h));this.renderer.restore()}},drawFeature:function(e,t){for(var r=this.selectRules(e),a=r.length,n=0;a>n;n++){var i=r[n];if((null==t||"undefined"==t)&&(t=i.symbolizer),this.map.renderer.save(),this.map.renderer.setSymbolizer(t),t instanceof GeoBeans.Symbolizer.TextSymbolizer){var s=e.featureType.getFieldIndex(t.field);this.map.renderer.label(e.geometry,e.values[s],t,this.map.transformation)}else this.map.renderer.draw(e,t,this.map.transformation);this.map.renderer.restore()}r=null},clearFeature:function(e){switch(e.geometry.type){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:var t=this.getSymbolizer(e);this.map.renderer.clear(e.geometry,this.map.bgColor,t.size,this.map.transformation);break;default:this.map.renderer.clear(e.geometry,this.map.bgColor,0,this.map.transformation)}},selectFeatures:function(e){if(null==e)return this.features;var t=e.type;if(t==GeoBeans.Filter.Type.FilterComparsion){var r=null,a=null,n=e.expression1;null!=n&&(n.type==GeoBeans.Expression.Type.PropertyName?r=n.name:n.type==GeoBeans.Expression.Type.Literal&&(a=n.value));var i=e.expression2;null!=i&&(i.type==GeoBeans.Expression.Type.PropertyName?r=i.name:i.type==GeoBeans.Expression.Type.Literal&&(a=i.value))}if(null==r||null==a)return this.features;var s=[],l=this.featureType.getFieldIndex(r);if(l>=0)for(var u=null,o=this.features.length,h=0;o>h;++h)u=this.features[h],fvalue=u.values[l],fvalue==a&&s.push(u);return s},selectFeaturesByFilter:function(e,t){if(null==e)return t;var r=e.type,a=t;switch(r){case GeoBeans.Filter.Type.FilterID:a=this.selectFeaturesByIDFilter(e);break;case GeoBeans.Filter.Type.FilterComparsion:a=this.selectFeaturesByComparsion(e);break;case GeoBeans.Filter.Type.FilterLogic:break;case GeoBeans.Filter.Type.FilterSpatial:}return a},selectFeaturesByIDFilter:function(e){if(null==e)return this.features;var t=e.ids;if(null==t)return this.features;for(var r=[],a=0;a<this.features.length;++a){var n=this.features[a],i=n.fid;-1!=t.indexOf(i)&&r.push(n)}return r},selectFeaturesByComparsion:function(e){if(null==e)return this.features;var t=e.operator;if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprEqual){var r=null,a=null,n=e.expression1;null!=n&&(n.type==GeoBeans.Expression.Type.PropertyName?r=n.name:n.type==GeoBeans.Expression.Type.Literal&&(a=n.value));var i=e.expression2;if(null!=i&&(i.type==GeoBeans.Expression.Type.PropertyName?r=i.name:i.type==GeoBeans.Expression.Type.Literal&&(a=i.value)),null==r||null==a)return this.features;var s=[],l=this.featureType.getFieldIndex(r);if(l>=0)for(var u=null,o=this.features.length,h=0;o>h;++h)u=this.features[h],fvalue=u.values[l],fvalue==a&&s.push(u);return s}return this.features},selectRules:function(e){var t=[];if(null!=this.style)for(var r=this.style.rules.length,a=0;r>a;a++){var n=this.style.rules[a];if(null!=n.filter){var i=n.filter.field,s=null,l=this.featureType.getFieldIndex(i);s=e.values[l],s==n.filter.value&&t.push(n)}else t.push(n)}return t},getSymbolizer:function(e){for(var t=this.selectRules(e),r=t.length,a=0;r>a;a++){var n=t[a],i=n.symbolizer;if(!(i instanceof GeoBeans.Style.TextSymbolizer))return i}return null},setHitControl:function(e){null!=e&&"undefined"!=e&&(this.hitControl=null,this.hitControl=e)},init:function(){},enableHit:function(e){this.enableHit=e},hit:function(e,t,r){if(null!=this.features){this.map.renderer,this.map.transformation;this.selection=[];var a=0,n=null,i=null,s=this.features.length;for(a=0;s>a;a++)n=this.features[a],i=n.geometry,null!=i&&i.hit(e,t,this.map.tolerance)&&this.selection.push(n);if(this.hitRenderer.clearRect(0,0,this.hitCanvas.height,this.hitCanvas.width),this.map.drawLayersAll(),void 0!=r){var l=new GeoBeans.Geometry.Point(e,t);r(this,this.selection,l)}}},registerHitEvent:function(e){var t=this.map,r=this,a=null,n=null,i=10;this.hitCanvas=document.createElement("canvas"),this.hitCanvas.width=this.canvas.width,this.hitCanvas.height=this.canvas.height,this.hitRenderer=new GeoBeans.Renderer(this.hitCanvas),this.hitEvent=function(s){if(null==a)a=s.layerX,n=s.layerY;else{var l=Math.abs(s.layerX-a)+Math.abs(s.layerY-n);if(l>i){a=s.layerX,n=s.layerY;var u=t.transformation.toMapPoint(s.layerX,s.layerY);r.hit(u.x,u.y,e)}}},t.mapDiv[0].addEventListener("mousemove",this.hitEvent),this.events.addEvent("mousemove",this.hitEvent)},unRegisterHitEvent:function(){this.map.mapDiv[0].removeEventListener("mousemove",this.hitEvent),this.hitRenderer.clearRect(0,0,this.hitCanvas.height,this.hitCanvas.width),this.map.drawLayersAll(),this.hitEvent=null},drawHitFeature:function(e,t){for(var r=this.selectRules(e),a=r.length,n=0;a>n;n++){var i=r[n];if((null==t||"undefined"==t)&&(t=i.symbolizer),this.hitRenderer.save(),this.hitRenderer.setSymbolizer(t),t instanceof GeoBeans.Symbolizer.TextSymbolizer){var s=e.featureType.getFieldIndex(t.field);this.hitRenderer.label(e.geometry,e.values[s],t,this.map.transformation)}else this.hitRenderer.draw(e,t,this.map.transformation);this.hitRenderer.restore()}r=null,this.map.drawLayersAll()},cleanup:function(){this.enableHit=!1,this.map.canvas.removeEventListener("mousemove",this.hitEvent),this.map.canvas.removeEventListener("mousemove",this.hitTooltipEvent)},registerHitTooltipEvent:function(e){var t=this.map,r=this,a=null,n=null,i=10;this.hitTooltipEvent=function(t){if(null==a)a=t.layerX,n=t.layerY;else{var s=Math.abs(t.layerX-a)+Math.abs(t.layerY-n);s>i&&(a=t.layerX,n=t.layerY,r.hitTooltip(t.layerX,t.layerY,e))}},t.canvas.addEventListener("mousemove",this.hitTooltipEvent)},unregisterHitTooltipEvent:function(){this.map.canvas.removeEventListener("mousemove",this.hitTooltipEvent),this.hitTooltipEvent=null},hitTooltip:function(e,t,r){if(null!=this.features&&null!=r){var a=this.map,n=a.transformation.toMapPoint(e,t),i=n.x,s=n.y,l=(this.map.renderer,this.map.transformation,0),u=null,o=null,h=this.features.length;for(l=0;h>l;l++)if(u=this.features[l],o=u.geometry,null!=o&&o.hit(i,s,this.map.tolerance))return void r(this,i,s,u);r(this,i,s,null)}},getBufferTracker:function(){if(null==this.bufferTracker){var e=new GeoBeans.Control.TrackBufferControl,t=this.map.controls.find(e.type);-1==t?(this.bufferTracker=e,this.map.controls.add(this.bufferTracker)):this.bufferTracker=this.map.controls.get(t)}return this.bufferTracker},queryByBufferLine:function(e,t){var r=this.getBufferTracker();r.trackBufferLine(this,e,t,this.callbackQueryByBufferTrack)},queryByBufferCircle:function(e){var t=this.getBufferTracker();t.trackBufferCircle(this,e,this.callbackQueryByBufferTrack)},callbackQueryByBufferTrack:function(e,t,r,a){if(!(null==r||0>t)){var n=e.featureType;if(null!=n){var i=e.workspace;null!=i&&i.queryByBuffer(t,r,n,a)}}},drawBufferFeatures:function(e,t){this.bufferFeatures=e,this.bufferSymbolizer=t,this.drawBufferFeaturesCanvas(),this.map.drawLayersAll()},clearBufferFeatures:function(){this.bufferFeatures=null,this.drawBufferFeaturesCanvas(),this.map.drawLayersAll()},drawBufferFeaturesCanvas:function(){if(null==this.bufferCanvas&&(this.bufferCanvas=document.createElement("canvas"),this.bufferCanvas.width=this.canvas.width,this.bufferCanvas.height=this.canvas.height,this.bufferRenderer=new GeoBeans.Renderer(this.bufferCanvas)),this.bufferRenderer.clearRect(0,0,this.bufferCanvas.width,this.bufferCanvas.height),null!=this.bufferFeatures&&0!=this.bufferFeatures.length){this.bufferRenderer.save(),this.bufferRenderer.setSymbolizer(this.bufferSymbolizer);for(var e=0,t=this.bufferFeatures.length;t>e;e++)feature=this.bufferFeatures[e],null!=this.bufferSymbolizer&&"undefined"!=this.bufferSymbolizer&&this.bufferRenderer.draw(feature,this.bufferSymbolizer,this.map.transformation);this.bufferRenderer.restore()}},beginTransaction:function(e){var t=this.featureType.getFieldIndex(this.featureType.geomFieldName),r=this.featureType.fields[t],a=r.geomType,n=this.getTransactionTracker();switch(a){case GeoBeans.Geometry.Type.POINT:n.trackPoint(this.transactionCallback,e,this);break;case GeoBeans.Geometry.Type.LINESTRING:n.trackLine(this.transactionCallback,e,this,!1);break;case GeoBeans.Geometry.Type.MULTILINESTRING:n.trackLine(this.transactionCallback,e,this,!0);break;case GeoBeans.Geometry.Type.POLYGON:n.trackPolygon(this.transactionCallback,e,this,!1);break;case GeoBeans.Geometry.Type.MULTIPOLYGON:n.trackPolygon(this.transactionCallback,e,this,!0)}},transactionCallback:function(e,t,r){t(e,r)},transaction:function(e,t,r){this.workspace.transaction(this.featureType,e,t,r)},getTransactionTracker:function(){var e=null,t=this.map.controls.find(GeoBeans.Control.Type.TRACKTRANSACTION);return-1==t?(e=new GeoBeans.Control.TrackControl.TrackTransactionControl,this.map.controls.add(e)):e=this.map.controls.get(t),e},CLASS_NAME:"GeoBeans.Layer.FeatureLayer",registerClickEvent:function(e,t){var r=this.map,a=this;null!=e&&(this.clickStyle=e),this.clickEvent=function(e){var n=a.map.controls.find(GeoBeans.Control.Type.DRAG_MAP),i=a.map.controls.get(n);if(i.draging)return void console.log("draging");a.clickRenderer.clearRect(),a.map.drawLayersAll();var s=r.transformation.toMapPoint(e.layerX,e.layerY);a.clickHit(s.x,s.y,t)},r.canvas.addEventListener("mouseup",this.clickEvent)},clickHit:function(e,t,r){if(null==this.features)return void(null!=r&&r(null));var a=[],n=0,i=null,s=null,l=this.features.length;for(n=0;l>n;n++)i=this.features[n],s=i.geometry,null!=s&&s.hit(e,t,this.map.tolerance)&&a.push(i);if(0==a.length)return this.clickFeature=null,void(null!=r&&r(null));for(var u=a[0],o=u.geometry,h=this.getDistance(e,t,o),n=1;n<a.length;++n){var i=a[n],s=i.geometry,f=this.getDistance(e,t,u.geometry);h>f&&(u=i)}null!=r&&(this.clickFeature=u,this.map.drawLayersAll(),r(u))},getDistance:function(e,t,r){var a=this.getGeomType(),n=null;switch(a){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:r.getCentroid();n=GeoBeans.Utility.getDistance(e,t,r.x,r.y);break;case GeoBeans.Geometry.Type.LINESTRING:case GeoBeans.Geometry.Type.MULTILINESTRING:n=r.distance(e,t);break;case GeoBeans.Geometry.Type.POLYGON:case GeoBeans.Geometry.Type.MULTIPOLYGON:r.getCentroid();n=GeoBeans.Utility.getDistance(e,t,r.x,r.y)}return n},unRegisterClickEvent:function(){this.map.canvas.removeEventListener("mouseup",this.clickEvent),this.clickEvent=null,this.clickRenderer.clearRect(),this.clickFeature=null,this.map.drawLayersAll()},drawClickLayer:function(){if(this.clickRenderer.clearRect(),null!=this.clickFeature){var e=this.clickStyle;if(null==e&&(e=this.getDefaultStyle()),null!=e){var t=e.rules;if(0!=t.length){for(var r=0;r<t.length;r++){var a=t[r],n=this.selectFeaturesByFilter(a.filter,[this.clickFeature]);null!=a.symbolizer&&(null!=a.symbolizer.symbol?this.clickRenderer.drawIcons(n,a.symbolizer,this.map.transformation):this.drawClickFeatures(n,a.symbolizer)),null!=a.textSymbolizer&&this.labelClickFeatures(n,a.textSymbolizer)}this.renderer.drawImage(this.clickCanvas,0,0,this.clickCanvas.width,this.clickCanvas.height)}}}},drawClickFeatures:function(e,t){if(null!=e){this.clickRenderer.save(),this.clickRenderer.setSymbolizer(t);for(var r=0,a=e.length;a>r;r++)feature=e[r],null!=t&&"undefined"!=t&&this.clickRenderer.draw(feature,t,this.map.transformation);this.clickRenderer.restore()}},labelClickFeatures:function(e,t){var r=e.length;if(0!=r){this.clickRenderer.save(),this.clickRenderer.setSymbolizer(t);var a=e[0],n=null,i=t.labelText;if(null==i||0==i.length){var s=t.labelProp;if(null!=s)var l=a.featureType.getFieldIndex(s)}else n=i;for(var u=null,o=null,h=null,f=0,r=e.length;r>f;f++)a=e[f],o=a.geometry,null!=o&&(h=new GeoBeans.PointLabel,h.geometry=o,h.textSymbolizer=t,u=null==n?a.values[l]:n,h.text=u,h.computePosition(this.clickRenderer,this.map.transformation),this.clickRenderer.drawLabel(h));this.clickRenderer.restore()}}});
...
GeoBeans.Layer.AirLineLayer=GeoBeans.Class(GeoBeans.Layer,{dbName:null,typeName:null,symbolizer:null,pointSymbolizer:null,option:null,featureType:null,initialize:function(e,t,r,a,l,n){GeoBeans.Layer.prototype.initialize.apply(this,arguments),this.dbName=t,this.typeName=r,this.symbolizer=a,this.pointSymbolizer=l,this.option=n},load:function(){var e=this.map.viewer;return null!=e&&null!=this.viewer&&e.equal(this.viewer)&&null!=this.features?void(this.flag=GeoBeans.Layer.Flag.LOADED):(this.viewer=new GeoBeans.Envelope(e.xmin,e.ymin,e.xmax,e.ymax),this.flag=GeoBeans.Layer.Flag.READY,this.renderer.clearRect(),void this.getFeatures())},getFeatures:function(){if(null!=this.features)return void this.drawLayer();var e=this.getFeatureType();if(null==e)return void(this.flag=GeoBeans.Layer.Flag.ERROR);var t=[this.featureType.geomFieldName];this.featureType.getFeaturesFilterAsync2(null,this.dbName,null,null,null,t,null,this,this.getFeatures_callback)},getFeatureType:function(){if(null!=this.featureType)return this.featureType;if(null!=this.map){var e=new GeoBeans.WFSWorkspace("tmp",this.map.server,"1.0.0");return this.featureType=new GeoBeans.FeatureType(e,this.typeName),null==this.featureType.fields&&(this.featureType.fields=this.featureType.getFields(null,this.dbName)),this.featureType}return null},getFeatures_callback:function(e,t){null!=e&&null!=t&&(e.features=t,e.drawLayer())},drawLayer:function(){var e=this.renderer,t=this.filterFeatures(),r=this.pointSymbolizer;e.setSymbolizer(r);for(var a=0;a<t.length;++a){var l=t[a];if(null!=l){var n=l.geometry;e.drawGeometry(n,r,this.map.transformation)}}e.setSymbolizer(this.symbolizer);for(var i=this.option.curveness,s=null,u=null,o=null,y=null,h=null,a=0;a<t.length;++a)if(s=t[a],null!=s&&(u=s.geometry,null!=u))for(var f=a+1;f<t.length;++f)a>=f||(o=t[f],null!=o&&(y=o.geometry,null!=y&&(h=this.getBezierControlPoint(u,y,i),e.drawBezierLine(u,y,h,mapObj.transformation))));this.flag=GeoBeans.Layer.Flag.LOADED,this.map.drawLayersAll()},getBezierControlPoint:function(e,t,r){if(null==e||null==t)return null;var a=new GeoBeans.Geometry.Point(e.x/2+t.x/2,e.y/2+t.y/2),l=Math.sqrt((e.x-t.x)*(e.x-t.x)+(e.y-t.y)*(e.y-t.y)),n=(e.x-t.x)/(e.y-t.y),i=Math.atan(n);i=Math.PI/2-i;var s=l*r,u=Math.sin(i)*s,o=Math.cos(i)*s,y=a.x+u,h=a.y-o,f=new GeoBeans.Geometry.Point(y,h);return f},filterFeatures:function(){for(var e=[],t=this.features,r=0;r<t.length;++r)r%60==0&&e.push(t[r]);return e}});
