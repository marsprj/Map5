...
GeoBeans.Layer.ChartLayer=GeoBeans.Class(GeoBeans.Layer.FeatureLayer,{baseLayerName:null,baseLayerField:null,option:null,baseLayer:null,initialize:function(e,a,t,n){this.name=e,this.baseLayerName=a,this.baseLayerField=t,this.option=n},cleanup:function(){},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments);var a=this.getFeatures();this.features=a},showLegend:function(){},getFeatures:function(){var e=this.map.getLayer(this.baseLayerName);if(null==e)return null;this.baseLayer=e,this.featureType=this.baseLayer.featureType;var a=e.getFeatures();return a},getMinMaxValue:function(){if(null==this.features)return null;for(var e=null,a=null,t=null,n=this.featureType.getFieldIndex(this.baseLayerField),s=0;s<this.features.length;++s)if(t=this.features[s],null!=t){var r=t.values,l=r[n];null!=l&&(l=parseFloat(l),e=null==e?l:e>l?l:e,a=null==a?l:l>a?l:a)}return{min:e,max:a}}});
...
GeoBeans.Layer.RangeChartLayer=GeoBeans.Class(GeoBeans.Layer.ChartLayer,{initialize:function(e,t,o,a){GeoBeans.Layer.ChartLayer.prototype.initialize.apply(this,arguments)},setMap:function(e){GeoBeans.Layer.FeatureLayer.prototype.setMap.apply(this,arguments);var t=this.getFeatures();this.features=t,this.style=this.getStyle()},getStyle:function(){if(null==this.features||null==this.option)return null;var e=this.getMinMaxValue();if(null==e)return null;for(var t=new GeoBeans.ColorRangeMap(this.option.startColor,this.option.endColor,e.min,e.max),o=new GeoBeans.Style.FeatureStyle,a=this.featureType.getFieldIndex(this.baseLayerField),r=this.features.length,i=0;r>i;++i){var n=this.features[i];if(null!=n){var l=n.values;if(null!=l){var s=l[a];console.log(s);var u=new GeoBeans.Symbolizer.PolygonSymbolizer,y=null;null==s?(y=new GeoBeans.Color,y.setByHex("#ffffff",1)):(s=parseFloat(s),y=t.getValue(s)),null!=this.option.opacity?y.setOpacity(this.option.opacity):y.setOpacity(1),u.fill.color=y,console.log(y.getRgba());var p=this.option.borderWidth;0==p?u.stroke=null:(y=new GeoBeans.Color,null!=this.option.border&&y.setByHex(this.option.border,1),null!=this.option.borderOpacity?y.setOpacity(this.option.borderOpacity):y.setOpacity(1),u.stroke.color=y,u.stroke.width=this.option.borderWidth);var h=new GeoBeans.IDFilter;h.addID(n.fid);var y=new GeoBeans.Color,f=new GeoBeans.Fill;f.color=y;var d=new GeoBeans.Rule;d.filter=h,d.name=s,d.symbolizer=u,o.addRule(d)}}}return o}});
...
GeoBeans.Symbol=GeoBeans.Class({name:null,icon:null,icon_height:null,icon_width:null,icon_offset_x:null,icon_offset_y:null,initialize:function(i,n){this.name=i,this.icon=n},clone:function(){var i=new GeoBeans.Symbol;return null!=this.name&&(i.name=this.name),null!=this.icon&&(i.icon=this.icon),null!=this.icon_height&&(i.icon_height=this.icon_height),null!=this.icon_width&&(i.icon_width=this.icon_width),null!=this.icon_offset_x&&(i.icon_offset_x=this.icon_offset_x),null!=this.icon_offset_y&&(i.icon_offset_y=this.icon_offset_y),i}});
