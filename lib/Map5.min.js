...
GeoBeans.Control.SrollMapControl=GeoBeans.Class(GeoBeans.Control,{onmousewheel:null,count:0,userHandler:null,initialize:function(e){GeoBeans.Control.prototype.initialize.apply(this,arguments),this.map=e;var a=this;this.type=GeoBeans.Control.Type.SCROLL_MAP;var r=function(a,r){if(a.preventDefault(),null!=e.baseLayer){var n=e.level;if(a.wheelDelta>0){var s=new Date;if(console.profile("scroll"),1!=e.baseLayer.imageScale){var l=1/(1+.2*r);e.viewer.scale(l),n=e.getLevel(viewer),e.saveSnap(),e.drawBackground(),e.drawLayersSnap(l),e._setLevel(n),e.draw()}else n+=r,n>e.baseLayer.MAX_ZOOM_LEVEL&&(n=e.baseLayer.MAX_ZOOM_LEVEL),e.saveSnap(),e.drawBackground(),e.drawBaseLayerSnap(n),e.setLevel(n),e.draw();console.log(new Date-s)}else if(1!=e.baseLayer.imageScale){var l=1+.2*r;e.viewer.scale(l),n=e.getLevel(viewer),e.saveSnap(),e.drawBackground(),e.drawLayersSnap(l),e._setLevel(n),e.draw()}else n-=r,n<e.baseLayer.MIN_ZOOM_LEVEL&&(n=e.baseLayer.MIN_ZOOM_LEVEL),e.saveSnap(),e.drawBackground(),e.drawBaseLayerSnap(n),e.setLevel(n),e.draw()}else if(a.wheelDelta>0){var l=1/(1+.2*r);e.saveSnap(),e.drawBackground(),e.drawLayersSnap(l),e.viewer.scale(l),e.transformation.update(),e.draw()}else{var l=1+.2*r;e.saveSnap(),e.drawBackground(),e.drawLayersSnap(l),e.viewer.scale(l),e.transformation.update(),e.draw()}};this.mousewheel=function(n){a.count=a.count+1;var s=a.count;setTimeout(function(){a.count==s&&(r(n,a.count),a.count=0,null!=a.userHandler&&a.userHandler({level:e.level}))},200)},e.mapDiv[0].addEventListener("mousewheel",this.mousewheel)},destory:function(){this.map.mapDiv[0].removeEventListener("mousewheel",this.mousewheel),GeoBeans.Control.prototype.destory.apply(this,arguments)}});
