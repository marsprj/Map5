...
GeoBeans.Layer.ClusterLayer=GeoBeans.Class(GeoBeans.Layer.FeatureLayer,{sourceLayer:null,distance:20,clusters:null,symbolizer:null,initialize:function(e,t,r){GeoBeans.Layer.FeatureLayer.prototype.initialize.apply(this,arguments),this.sourceLayer=t,this.sourceLayer.visible=!1,this.symbolizer=r},setName:function(e){this.name=e},setMap:function(e){this.map=e,this.canvas=this.sourceLayer.canvas,this.renderer=this.sourceLayer.renderer},setLayer:function(e){null!=e&&(this.sourceLayer.visible=!0,this.sourceLayer=e,this.sourceLayer.visible=!1,this.features=null)},setSymbolizer:function(e){this.symbolizer=e},load:function(){this.renderer.clearRect(),null==this.features?this.getFeatures():(this.cluster(),this.flag=GeoBeans.Layer.Flag.LOADED)},getFeatures:function(){var e=this.sourceLayer.getFeatureType(),t=e.geomFieldName,r=[t];this.sourceLayer.getFeatures(r,this,this.getFeatures_callback)},getFeatures_callback:function(e,t){e.flag=GeoBeans.Layer.Flag.LOADED,e.features=t,e.cluster(),e.map.drawLayersAll()},cluster:function(){if(null!=this.features){for(var e=null,t=null,r=null,s=!1,l=[],a=0;a<this.features.length;++a)if(e=this.features[a],null!=e&&(t=e.geometry,null!=t)){s=!1;for(var n=0;n<l.length;++n)if(r=l[n],this.shouldCluster(r,t)){this.addToCluster(r,e),s=!0;break}s||l.push(this.createCluster(e))}console.log(l.length),this.drawClusters(l)}},createCluster:function(e){var t={features:[]};t.features.push(e);var r=e.geometry;return t.geometry=r,t},shouldCluster:function(e,t){var r=e.geometry,s=this.map.transformation.toScreenPoint(r.x,r.y),l=this.map.transformation.toScreenPoint(t.x,t.y),a=Math.sqrt(Math.pow(s.x-l.x,2)+Math.pow(s.y-l.y,2));return a<this.distance},addToCluster:function(e,t){e.features.push(t)},drawClusters:function(e){for(var t=null,r=null,s=0;s<e.length;++s)if(t=e[s],null!=t){r=t.geometry;var l=this.getClusterCenter(t);l=r;var a=(new GeoBeans.Geometry.Circle(l,2),null);a=null==this.symbolizer?new GeoBeans.Symbolizer.PolygonSymbolizer:this.symbolizer,this.renderer.setSymbolizer(a);var n=this.renderer.context;n.beginPath();var i=10,o=this.map.transformation.toScreenPoint(l.x,l.y);n.arc(o.x,o.y,i,0,2*Math.PI,!0),null!=a.fill&&n.fill(),null!=a.stroke&&n.stroke(),n.closePath();var u=new GeoBeans.Symbolizer.TextSymbolizer,h=new GeoBeans.Color;h.setByHex("#ffffff",1),u.fill.color=h,this.renderer.setSymbolizer(u);var y=t.features.length,c=n.measureText(y).width;null!=a.fill&&n.fillText(y,o.x-c/2,o.y+4)}},getClusterCenter:function(e){for(var t=e.features,r=null,s=null,l=0,a=0,n=0;n<t.length;++n)r=t[n],null!=r&&(s=r.geometry,null!=s&&(l+=s.x,a+=s.y));return new GeoBeans.Geometry.Point(l/t.length,a/t.length)}});
