...
GeoBeans.KMLReader=GeoBeans.Class({incrementID:0,styles:null,initialize:function(){},read:function(e,l){return this.layerName=e,this.styles=[],this.load(l),this.layer},load:function(e){var l=this;$.ajax({url:e,dataType:"xml",async:!1,beforeSend:function(e){},success:function(e,r){l.readXML(e)},complete:function(e,l){},error:function(e,l){console.log(l)}})},readXML:function(e){var l=$(e).find("Document");if(0==l.length)return null;var r=new GeoBeans.FeatureType(null,this.layerName),n=[],t=new GeoBeans.Field("name","string",r,null);n.push(t);var t=new GeoBeans.Field("shape","geometry",r,null);n.push(t),r.geomFieldName="shape",r.fields=n;var a=new GeoBeans.Layer.FeatureLayer(this.layerName);a.featureType=r,a.features=[],this.layer=a;var i=new GeoBeans.Style.FeatureStyle;a.setStyle(i);var s=this;l.children().each(function(){var e=this.tagName;switch(e){case"Folder":s.parseFolder(this);break;case"Style":s.parseStyle(this);break;case"Placemark":var l=s.parsePlacemark(this);s.layer.addFeature(l)}})},getFid:function(){if(null==this.layer)return null;for(var e=this.layerName+"_"+this.incrementID;null!=this.layer.getFeatureByID(e);)this.incrementID++,e=this.layerName+"_"+this.incrementID;return e},addRule:function(e){if(null!=this.layer&&null!=e){var l=this.layer.style;null!=l&&l.addRule(e)}},getRule:function(e){if(null==e||null==this.layer||null==this.layer.style)return null;for(var l=this.layer.style.rules,r=0;r<l.length;++r){var n=l[r];if(null!=n&&n.name==e)return n}return null},addFilterByID:function(e,l){if(null!=e&&null!=l){var r=e.filter;null==r&&(r=new GeoBeans.IDFilter,e.filter=r),r.addID(l)}},parseFolder:function(e){},parseStyle:function(e){if(null!=e){var l=$(e).attr("id"),r={};r.name=l;var n=this;$(e).children().each(function(){var e=this.tagName;switch(e){case"IconStyle":var l=n.parseIconStyle(this);null!=l&&(r.pointSymbolizer=l);break;case"LabelStyle":var t=n.parseLabelStyle(this);null!=t&&(r.textSymbolizer=t);break;case"LineStyle":var a=n.parseLineStyle(this);null!=a&&(r.lineSymbolizer=a);break;case"PolyStyle":var i=n.parsePolyStyle(this);null!=i&&(r.polygonSymbolizer=i)}}),this.styles.push(r)}},parseIconStyle:function(e){if(null==e)return null;var l=this,r=this.getDefaultSymbolizer(GeoBeans.Geometry.Type.POINT);return $(e).children().each(function(){var e=this.tagName;switch(e){case"Icon":var n=l.parseIcon(this);null!=n&&(r.symbol.icon=n);break;case"scale":var t=l.parseScale(this);null!=t&&(r.symbol.scale=t)}}),r},parseLabelStyle:function(e){if(null==e)return null;var l=this,r=new GeoBeans.Symbolizer.TextSymbolizer;return r.fill.color.set(255,0,0,1),r.stroke=null,$(e).children().each(function(){var e=this.tagName;switch(e){case"color":var n=l.parseColor(this);r.fill.color=n;break;case"scale":var t=l.parseScale(this);r.font.size=r.font.size*t}}),r.labelProp="name",r},parseLineStyle:function(e){if(null==e)return null;var l=this,r=this.getDefaultSymbolizer(GeoBeans.Geometry.Type.LINESTRING);return $(e).children().each(function(){var e=this.tagName;switch(e){case"color":var n=l.parseColor(this);r.stroke.color=n;break;case"width":var t=l.parseWidth(this);r.stroke.width=t}}),r},parsePolyStyle:function(e){if(null==e)return null;var l=this,r=this.getDefaultSymbolizer(GeoBeans.Geometry.Type.POLYGON);return $(e).children().each(function(){var e=this.tagName;switch(e){case"color":var n=l.parseColor(this);r.fill.color=n;break;case"fill":var t=l.parseFill(this);t||(r.fill=null);break;case"outline":var a=l.parseOutline(this);a||(r.stroke=null)}}),r},parseColor:function(e){if(null==e)return null;var l=$(e).text();if(8==l.length){var r=new GeoBeans.Color;return r.setByABGR(l),r}return new GeoBeans.Color},parseIcon:function(e){if(null==e)return null;var l=$(e).find("href").text();return l},parseScale:function(e){if(null==e)return null;var l=$(e).text();return parseFloat(l)},parseWidth:function(e){if(null==e)return null;var l=$(e).text();return parseFloat(l)},parseFill:function(e){if(null==e)return null;var l=$(e).text(),r=parseInt(l);return 1==r?!0:!1},parseOutline:function(e){if(null==e)return null;var l=$(e).text(),r=parseInt(l);return 1==r?!0:!1},parsePlacemark:function(e){if(null==e)return null;var l=null,r=this,n=null,t=null;$(e).children().each(function(){var e=this.tagName;switch(e){case"name":l=$(this).text();break;case"styleUrl":n=r.parseStyleUrl(this);break;case"Point":t=r.parsePoint(this);break;case"LineString":t=r.parseLineString(this);break;case"Polygon":t=r.parsePolygon(this)}});var a=$(this).attr("id");if(null==a&&(a=this.getFid()),null==a)return null;var i=(180*Math.random(),90*Math.random(),[l,t]),s=new GeoBeans.Feature(this.layer.featureType,a,t,i);if(null!=n&&null!=t){var o=t.type,u=this.getLayerRule(n,o);null==u?(u=this.getRuleByStyle(n,o),null!=u&&(this.addRule(u),this.addFilterByID(u,a))):this.addFilterByID(u,a)}return s},getLayerRule:function(e,l){if(null==this.layer||null==this.layer.style||null==l)return null;for(var r=this.layer.style.rules,n=0;n<r.length;++n){var t=r[n];if(null!=t&&t.name==e){var a=t.symbolizer;if(null!=a){var i=a.type;switch(l){case GeoBeans.Geometry.Type.POINT:if(i==GeoBeans.Symbolizer.Type.Point)return t;break;case GeoBeans.Geometry.Type.LINESTRING:if(i==GeoBeans.Symbolizer.Type.Line)return t;break;case GeoBeans.Geometry.Type.POLYGON:if(i==GeoBeans.Symbolizer.Type.Polygon)return t}}}}return null},getRuleByStyle:function(e,l){if(null==e||null==l)return null;for(var r=null,n=null,t=null,a=null,i=null,s=0;s<this.styles.length;++s)if(r=this.styles[s],null!=r)switch(l){case GeoBeans.Geometry.Type.POINT:n=r.pointSymbolizer,t=r.textSymbolizer;var o=new GeoBeans.Rule;return o.name=e,null!=n?o.symbolizer=n:o.symbolizer=this.getDefaultSymbolizer(l),null!=t&&(o.textSymbolizer=t),o;case GeoBeans.Geometry.Type.LINESTRING:a=r.lineSymbolizer;var o=new GeoBeans.Rule;return o.name=e,null!=a?o.symbolizer=a:o.symbolizer=this.getDefaultSymbolizer(l),o;case GeoBeans.Geometry.Type.POLYGON:i=r.polygonSymbolizer,a=r.lineSymbolizer;var o=new GeoBeans.Rule;return o.name=e,null!=i?(null!=i.stroke&&null!=a&&(i.stroke=a.stroke),o.symbolizer=i):(o.symbolizer=this.getDefaultSymbolizer(l),null!=a&&(o.symbolizer.stroke=a.stroke)),o}return null},parseStyleUrl:function(e){if(null==e)return null;var l=$(e).text();return 0==l.indexOf("#")?l.slice(1,l.length):null},parsePoint:function(e){if(null==e)return null;var l=$(e).find("coordinates").text(),r=this.parsePointCoords(l);return r},parseLineString:function(e){if(null==e)return null;var l=$(e).find("coordinates").text(),r=this.parseLineStringCoords(l);return r},parsePointCoords:function(e){if(null==e||""==e.trim())return null;var l=e.split(","),r=parseFloat(l[0].trim()),n=parseFloat(l[1].trim());return null!=r&&null!=n?new GeoBeans.Geometry.Point(r,n):null},parseLineStringCoords:function(e){if(null==e||""==e.trim())return null;for(var l=[],r=e.replace(/\n/g," ").trim().split(/[ ]+/),n=0;n<r.length;++n){var t=this.parsePointCoords(r[n]);null!=t&&l.push(t)}if(l.length<=1)return null;var a=new GeoBeans.Geometry.LineString(l);return a},parsePolygon:function(e){if(null==e)return null;var l=$(e).find("outerBoundaryIs>LinearRing>coordinates").text(),r=this.parseLineStringCoords(l),n=$(e).find("innerBoundaryIs>LinearRing>coordinates").text(),t=this.parseLineStringCoords(n),a=[];return null!=r&&a.push(r),null!=t&&a.push(t),0==a.length?null:new GeoBeans.Geometry.Polygon(a)},getDefaultRule:function(e){},getDefaultSymbolizer:function(e){var l=null;switch(e){case GeoBeans.Geometry.Type.POINT:l=new GeoBeans.Symbolizer.PointSymbolizer;var r=new GeoBeans.Symbol;r.icon="images/marker.png",l.symbol=r;break;case GeoBeans.Geometry.Type.LINESTRING:l=new GeoBeans.Symbolizer.LineSymbolizer,l.stroke.color.set(255,0,0,1);break;case GeoBeans.Geometry.Type.POLYGON:l=new GeoBeans.Symbolizer.PolygonSymbolizer,l.fill.color.set(255,0,0,1),l.stroke.color.set(0,0,255,1)}return l}});
...
GeoBeans.FilterWriter=GeoBeans.Class({initialize:function(){},write:function(e,r){if(null==r)return null;var t=e.createElement("ogc:Filter"),i=this.writeFilter(e,r);return $(t).append(i),t},writeFilter:function(e,r){var t=r.type,i=null;return t==GeoBeans.Filter.Type.FilterID?i=this.writeIDFilter(e,r):t==GeoBeans.Filter.Type.FilterComparsion?i=this.writeComparsionFilter(e,r):t==GeoBeans.Filter.Type.FilterLogic?i=this.writeLogicFilter(e,r):t==GeoBeans.Filter.Type.FilterSpatial&&(i=this.writeSpatialFilter(e,r)),i},writeIDFilter:function(e,r){},writeComparsionFilter:function(e,r){var t=r.operator,i=null;if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprEqual){i=e.createElement("ogc:PropertyIsEqualTo");var n=r.expression1,a=r.expression2,o=this.writeExpression(e,n),p=this.writeExpression(e,a);$(i).append(o),$(i).append(p)}else if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprNotEqual){i=e.createElement("ogc:PropertyIsNotEqual");var n=r.expression1,a=r.expression2,o=this.writeExpression(e,n),p=this.writeExpression(e,a);$(i).append(o),$(i).append(p)}else if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprLessThan){i=e.createElement("ogc:PropertyIsLessThan");var n=r.expression1,a=r.expression2,o=this.writeExpression(e,n),p=this.writeExpression(e,a);$(i).append(o),$(i).append(p)}else if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprGreaterThan){i=e.createElement("ogc:PropertyIsGreaterThan");var n=r.expression1,a=r.expression2,o=this.writeExpression(e,n),p=this.writeExpression(e,a);$(i).append(o),$(i).append(p)}else if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprLessThanOrEqual){i=e.createElement("ogc:PropertyIsLessThanOrEqualTo");var n=r.expression1,a=r.expression2,o=this.writeExpression(e,n),p=this.writeExpression(e,a);$(i).append(o),$(i).append(p)}else if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprGreaterThanOrEqual){i=e.createElement("ogc:PropertyIsGreaterThanOrEqualTo");var n=r.expression1,a=r.expression2,o=this.writeExpression(e,n),p=this.writeExpression(e,a);$(i).append(o),$(i).append(p)}else if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprIsLike){i=e.createElement("ogc:PropertyIsLike"),$(i).attr("escapeChar","!"),$(i).attr("singleChar","#"),$(i).attr("wildCard","*");var n=r.expression1,a=r.expression2,o=this.writeExpression(e,n),p=this.writeExpression(e,a);$(i).append(o),$(i).append(p)}else if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprIsNull)i=e.createElement("ogc:PropertyIsIsNull");else if(t==GeoBeans.ComparisionFilter.OperatorType.ComOprIsBetween){i=e.createElement("ogc:PropertyIsBetween");var s=r.expression,l=this.writeExpression(e,s);$(i).append(l);var c=r.lowerBound,m=this.writeExpression(e,c),E=r.upperBound,x=this.writeExpression(e,E),u=e.createElement("ogc:LowerBoundary");$(u).append(m);var w=e.createElement("ogc:UpperBoundary");$(w).append(x),$(i).append(u),$(i).append(w)}return i},writeExpression:function(e,r){if(null==e||null==r)return"";var t=null,i=r.type;if(i==GeoBeans.Expression.Type.Arithmetic);else if(i==GeoBeans.Expression.Type.PropertyName){t=e.createElement("ogc:PropertyName");var n=r.name;$(t).text(n)}else if(i==GeoBeans.Expression.Type.Literal){t=e.createElement("ogc:Literal");var a=r.value;$(t).text(a)}else i==GeoBeans.Expression.Type.Function;return t},writeLogicFilter:function(e,r){var t=r.operator,i=null;if(t==GeoBeans.LogicFilter.OperatorType.LogicOprAnd)i=e.createElement("ogc:And");else if(t==GeoBeans.LogicFilter.OperatorType.LogicOprOr)i=e.createElement("ogc:Or");else if(t==GeoBeans.LogicFilter.OperatorType.LogicOprNot){i=e.createElement("ogc:Not");var n=r.filters[0],a=this.writeFilter(e,n);return $(i).append(a),i}for(var o=r.filters,p=0;p<o.length;++p){var n=o[p],a=this.writeFilter(e,n);$(i).append(a)}return i},writeSpatialFilter:function(e,r){var t=r.operator,i=null;switch(t){case GeoBeans.SpatialFilter.OperatorType.SpOprBBox:i=this.writeBBoxFilter(e,r);break;case GeoBeans.SpatialFilter.OperatorType.SpOprIntersects:i=this.writeSpatialFilterIntersects(e,r);break;case GeoBeans.SpatialFilter.OperatorType.SpOprDWithin:i=this.writeSpatialFilterDWithin(e,r)}return i},writeBBoxFilter:function(e,r){var t=e.createElement("ogc:BBOX"),i=r.propName,n=new GeoBeans.PropertyName;n.setName(i);var a=this.writeExpression(e,n);$(t).append(a);var o=r.extent,p=this.writeEnvelope(e,o);return $(t).append(p),t},writeEnvelope:function(e,r){var t=e.createElement("gml:Box"),i=e.createElement("gml:coordinates"),n=r.xmin+","+r.ymin+" "+r.xmax+","+r.ymax;return $(i).text(n),$(t).append(i),t},writeSpatialFilterIntersects:function(e,r){var t=e.createElement("Intersects"),i=r.geometry,n=r.propName,a=new GeoBeans.Geometry.GML.Writer(GeoBeans.Geometry.GML.Version.v_2_0),o=a.write(i),p=e.createElement("PropertyName");return $(p).text(n),$(t).append(p),$(t).append(o),t},writeSpatialFilterDWithin:function(e,r){var t=e.createElement("DWithin"),i=r.geometry,n=r.distance,a=r.propName,o=new GeoBeans.Geometry.GML.Writer(GeoBeans.Geometry.GML.Version.v_2_0),p=o.write(i),s=e.createElement("PropertyName");$(s).text(a);var l=e.createElement("Distance");return $(l).text(n),$(t).append(s),$(t).append(p),$(t).append(l),t}});
...
GeoBeans.BBoxFilter=GeoBeans.Class(GeoBeans.SpatialFilter,{extent:null,initialize:function(e,t){GeoBeans.SpatialFilter.prototype.initialize.apply(this,arguments),this.operator=GeoBeans.SpatialFilter.OperatorType.SpOprBBox,this.propName=e,this.extent=t},setExtent:function(e,t,i,a){}});
...
GeoBeans.Geometry.MultiLineString=GeoBeans.Class(GeoBeans.Geometry,{lines:null,type:GeoBeans.Geometry.Type.MULTILINESTRING,initialize:function(e){this.lines=e,this.extent=this.computeExtent()},destory:function(){this.lines=null},hit:function(e,n,t){if(!this.extent.contain(e,n))return!1;for(var i=this.lines.length,s=0;i>s;s++){var r=this.lines[s];if(r.hit(e,n,t))return!0}return!1},computeExtent:function(){var e=null,n=this.lines.length;if(1>n)return null;var t=this.lines[0];e=new GeoBeans.Envelope(t.extent.xmin,t.extent.ymin,t.extent.xmax,t.extent.ymax);for(var i=1;n>i;i++)t=this.lines[i],e.union(t.extent);return e},distance:function(e,n){for(var t=this.lines.length,i=null,s=null,r=0,l=0,o=0;t>o;++o)for(var a=this.lines[o],h=a.points,u=h.length-1,x=0;u>x;x++)i=h[x],s=h[x+1],l=GeoBeans.Utility.distance2segment(e,n,i.x,i.y,s.x,s.y),r>l&&(l=r);return r},getCentroid:function(){for(var e=0,n=0,t=0,i=0;i<this.lines.length;++i){var s=this.lines[i],r=s.points;t+=r.length;for(var l=0;l<r.length;++l){var o=r[l];e+=o.x,n+=o.y}}e/=t,n/=t;var o=new GeoBeans.Geometry.Point(e,n);return o}});
GeoBeans.Geometry.MultiPoint=GeoBeans.Class(GeoBeans.Geometry,{points:null,type:GeoBeans.Geometry.Type.MULTIPOINT,initialize:function(t){this.points=t,this.extent=this.computeExtent(this.points)},destory:function(){this.points=null},hit:function(t,n,e){for(var i=this.points.length,o=0;i>o;o++){var s=this.points[o];if(s.hit(t,n,e))return truel}return!1},computeExtent:function(t){var n=t.length;if(0==n)return null;for(var e=t[0],i=e.x,o=e.y,s=e.x,r=e.y,h=1;n>h;h++)e=t[h],e.x<i&&(i=e.x),e.x>s&&(s=e.x),e.y<o&&(o=e.y),e.y>r&&(r=e.y);return new GeoBeans.Envelope(i,o,s,r)},getCentroid:function(){for(var t=0,n=0,e=0;e<this.points.length;++e){var i=this.points[e];t+=i.x,n+=i.y}return t/=this.points.length,n/=this.points.length,new GeoBeans.Geometry.Point(t,n)}});
...
GeoBeans.Layer.FeatureDBLayer=GeoBeans.Class(GeoBeans.Layer.DBLayer,{styleName:null,geomType:null,featureLayer:null,initialize:function(e,t,a,r,l,n,i){GeoBeans.Layer.DBLayer.prototype.initialize.apply(this,arguments),void 0!=i&&(this.styleName=i),this.type=GeoBeans.Layer.DBLayer.Type.Feature},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments);var t=new GeoBeans.Layer.FeatureLayer("tmp");t.setMap(e),this.featureLayer=t,this.featureLayer.renderer.context.globalCompositeOperation="lighter"},setStyle:function(e){null!=e&&(this.style=e,this.styleName=e.name)},getFeatureType:function(){if(null!=this.featureType)return this.featureType;if(null!=this.map){var e=new GeoBeans.WFSWorkspace("tmp",this.map.server,"1.0.0");return this.featureType=new GeoBeans.FeatureType(e,this.name),null==this.featureType.fields&&(this.featureType.fields=this.featureType.getFields(this.map.name,null)),this.featureType}return null},getFeatureBBoxGet:function(e,t,a){var r=this.getFeatureType(),l=null;return null!=r&&(l=r.getFeatureBBoxGet(this.map.name,null,e,t,a)),l},getFeautureBBoxGetOutput:function(e,t,a){var r=null,l=this.getFeatureType();return null!=l&&(r=l.getFeatureBBoxGetOutput(this.map.name,null,e,t,a)),r},getFeatureCount:function(e,t){var a=this.getFeatureType();if(null!=a){var r=a.getCount(this.map.name,null,e);if(null==t)return r;t(this,r)}else{if(null==t)return 0;t(0)}},getFields:function(){var e=this.getFeatureType(),t=null;return null!=e&&(t=e.getFields(this.map.name,null)),t},getHeatMapLayer:function(){return this.heatMapLayer},addHeatMap:function(e,t,a){if(null!=e||null!=t){var r=this.getFeatureType(),l=r.getFieldIndex(e);if(!(0>l&&null==t)){if(0>l&&null!=t)return this.heatMapLayer=new GeoBeans.Layer.HeatMapLayer(this.name+"-heatMap",a),this.heatMapLayer.setMap(this.map),void this.heatMapLayer.setLayer(this,null,t);this.heatMapLayer=new GeoBeans.Layer.HeatMapLayer(this.name+"-heatMap",a),this.heatMapLayer.setMap(this.map),this.heatMapLayer.setLayer(this,e,null)}}},removeHeatMap:function(){null!=this.heatMapLayer&&(this.heatMapLayer.destory(),this.heatMapLayer=null)},setHeatMapVisible:function(e){null!=this.heatMapLayer&&(this.heatMapLayer.visible=e)},getFeaturesWithin:function(e){var t=null,a=this.getFeatureType();return null!=a&&(t=a.getFeaturesWithin(this.map.name,null,e)),t},getFeatureFilter:function(e,t,a,r){var l=this.getFeatureType();return null!=l&&(features=l.getFeaturesFilter(this.map.name,null,e,t,a,r)),features},getFeatureFilterCount:function(e){var t=0,a=this.getFeatureType();return null!=a&&(t=a.getFeatureFilterCount(this.map.name,null,e)),t},getFeatureFilterCountAsync:function(e,t){var a=this.getFeatureType();null!=a?a.getFeatureFilterCountAsync(this.map.name,null,e,this,t):null!=t&&t(0)},getFeatureFilterOutput:function(e,t,a){var r=null,l=this.getFeatureType();return null!=l&&(r=l.getFeatureFilterOutput(this.map.name,null,e,t,a)),r},getFeatures:function(e,t,a){var r=this.getFeatureType();return null==r?void(null!=a&&a(null)):void r.getFeaturesFilterAsync2(this.map.name,null,null,null,null,e,null,t,a)},loadLocal:function(){var e=this.map.viewer;if(null!=e&&null!=this.viewer&&e.equal(this.viewer)&&null!=this.features&&null!=this.style&&this.flag==GeoBeans.Layer.Flag.LOADED)return this.renderer.clearRect(),void this.renderer.drawImage(this.featureLayer.canvas,0,0,this.map.width,this.map.height);if(null==this.xhr&&(this.features=[],this.viewer=new GeoBeans.Envelope(e.xmin,e.ymin,e.xmax,e.ymax),null==this.featureType&&(this.featureType=this.getFeatureType()),null!=this.featureType)){var t=this;t.flag=GeoBeans.Layer.Flag.READY;var a=new GeoBeans.BBoxFilter;a.extent=this.viewer,a.propName=this.featureType.geomFieldName;var r=[this.featureType.geomFieldName],l=this.featureType.getFeaturesFilterAsync2(this.map.name,null,a,null,null,r,null,this,this.getFeatures_callback);this.xhr=l}},getFeatures_callback:function(e,t){null!=e&&null!=t&&(e.setTransformation(e.map.transformation),e.features=t,e.featureLayer.features=t,e.renderer.clearRect(),e.featureLayer.renderer.clearRect(),e.getStyle())},drawLayer:function(){this.xhr=null;var e=this.style,t=this.features;if(null!=e&&null!=t&&(rules=e.rules,0!=rules.length)){for(var a=(new Date,0);a<rules.length;a++){var r=rules[a],t=this.featureLayer.selectFeaturesByFilter(r.filter,this.features);null!=r.symbolizer&&(null!=r.symbolizer.icon_url||this.featureLayer.drawFeatures(t,r.symbolizer)),null!=r.textSymbolizer&&this.featureLayer.labelFeatures(t,r.textSymbolizer)}this.renderer.drawImage(this.featureLayer.canvas,0,0,this.map.width,this.map.height),this.flag=GeoBeans.Layer.Flag.LOADED,this.map.drawLayersAll()}},getStyle:function(){if(null!=this.style)return void this.drawLayer();if(null==this.styleName||""==this.styleName){this.featureLayer.featureType=this.getFeatureType();var e=this.featureLayer.getDefaultStyle();return null!=e?(this.style=e,void this.drawLayer()):void(this.flag=GeoBeans.Layer.Flag.ERROR)}var t=this.map.server;t=t.replace("/mgr","");var a=new GeoBeans.StyleManager(t);a.getStyleXML(this.styleName,this.getStyle_callback,this)},getStyle_callback:function(e,t){null!=e&&null!=t&&(t.style=e,t.drawLayer())}});
GeoBeans.Layer.FeatureLayer=GeoBeans.Class(GeoBeans.Layer,{features:null,style:null,geometryType:null,featureType:null,enableHit:!1,selection:null,unselection:null,hitControl:null,hitEvent:null,hitTooltipEvent:null,hitCanvas:null,hitRenderer:null,bufferCanvas:null,bufferRenderer:null,bufferFeatures:null,bufferSymbolizer:null,clickStyle:null,clickFeature:null,clickCanvas:null,clickRenderer:null,bufferTracker:null,initialize:function(e){GeoBeans.Layer.prototype.initialize.apply(this,arguments),this.featureType=null,this.features=null,this.selection=[],this.unselection=[]},destroy:function(){this.features=null,this.style=null,this.renderer=null,this.geometryType=null,this.featureType=null,this.unRegisterClickEvent(),GeoBeans.Layer.prototype.destroy.apply(this,arguments)},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments),this.clickCanvas=document.createElement("canvas"),this.clickCanvas.width=this.canvas.width,this.clickCanvas.height=this.canvas.height,this.clickRenderer=new GeoBeans.Renderer(this.clickCanvas)},addFeature:function(e){null!=e&&(null==this.features&&(this.features=[]),this.features.push(e))},addFeatureObj:function(e,t,r){if(null!=e&&null!=r&&null!=t){var l=new GeoBeans.Feature(this.featureType,e,t,r);this.addFeature(l)}},addFeatures:function(e){if(null!=e&&e instanceof Array)for(var t=0,r=e.length;r>t;t++){var l=e[t];this.features.push(l)}},getFeatures:function(){return this.features},getFeature:function(e){return 0>e?null:e>=this.features.length?null:this.features[e]},getFeatureByID:function(e){if(null==this.features)return null;for(var t=null,r=0;r<this.features.length;++r)if(t=this.features[r],null!=t&&t.fid==e)return t;return null},setStyle:function(e){this.style=e,this.flag=GeoBeans.Layer.Flag.READY},count:function(){return this.features.length},draw:function(){var e=this.style;if(null!=e&&(rules=e.rules,0!=rules.length))for(var t=0;t<rules.length;t++){var r=rules[t],l=this.selectFeatures(r.filter);this.drawFeatures(l,r.symbolizer)}},load:function(){var e=this.map.viewer;if(null!=e&&null!=this.viewer&&e.equal(this.viewer)&&this.flag==GeoBeans.Layer.Flag.LOADED)return this.flag=GeoBeans.Layer.Flag.LOADED,void this.drawClickLayer();this.viewer=new GeoBeans.Envelope(e.xmin,e.ymin,e.xmax,e.ymax),this.renderer.clearRect();var t=new GeoBeans.BBoxFilter(this.featureType.geomFieldName,this.viewer),r=this.selectFeaturesByFilter(t,this.features);console.log("count:"+r.length),this.drawLayerFeatures(r),this.drawClickLayer(),this.flag=GeoBeans.Layer.Flag.LOADED},drawLayerFeatures:function(e){var t=this.style;if(null==t){if(t=this.getDefaultStyle(),null==t)return;this.style=t}if(rules=t.rules,0!=rules.length)for(var r=0;r<rules.length;r++){var l=rules[r],n=this.selectFeaturesByFilter(l.filter,e);null!=l.symbolizer&&(null!=l.symbolizer.symbol?this.renderer.drawIcons(n,l.symbolizer,this.map.transformation):this.drawFeatures(n,l.symbolizer)),null!=l.textSymbolizer&&this.labelFeatures(n,l.textSymbolizer)}},drawLayer:function(){var e=this.style;if(null==e){if(e=this.getDefaultStyle(),null==e)return;this.style=e}if(rules=e.rules,0!=rules.length){for(var t=0;t<rules.length;t++){var r=rules[t],l=this.selectFeaturesByFilter(r.filter,this.features);null!=r.symbolizer&&(null!=r.symbolizer.symbol?this.renderer.drawIcons(l,r.symbolizer,this.map.transformation):this.drawFeatures(l,r.symbolizer)),null!=r.textSymbolizer&&this.labelFeatures(l,r.textSymbolizer)}this.drawClickLayer()}},getGeomType:function(){var e=this.featureType;if(null==e)return null;var t=e.geomFieldName;if(null==t)return null;var r=e.getFieldIndex(t);if(null==r)return null;var l=e.fields[r];if(null==l)return null;var n=l.geomType;return n},getDefaultStyle:function(){var e=this.getGeomType(),t=null;switch(e){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.Point);var r=new GeoBeans.Rule,l=new GeoBeans.Symbolizer.PointSymbolizer;r.symbolizer=l,t.addRule(r);break;case GeoBeans.Geometry.Type.LINESTRING:case GeoBeans.Geometry.Type.MULTILINESTRING:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.LineString);var r=new GeoBeans.Rule,l=new GeoBeans.Symbolizer.LineSymbolizer;r.symbolizer=l,t.addRule(r);break;case GeoBeans.Geometry.Type.POLYGON:case GeoBeans.Geometry.Type.MULTIPOLYGON:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.Polygon);var r=new GeoBeans.Rule,l=new GeoBeans.Symbolizer.PolygonSymbolizer;r.symbolizer=l,t.addRule(r)}return t},drawFeatures:function(e,t){if(0!=e.length){this.renderer.save(),this.renderer.setSymbolizer(t);for(var r=0,l=e.length;l>r;r++)feature=e[r],null!=t&&"undefined"!=t&&this.renderer.draw(feature,t,this.map.transformation);this.renderer.restore()}},labelFeatures:function(e,t){var r=e.length;if(0!=r){this.renderer.save(),this.renderer.setSymbolizer(t);var l=e[0],n=null,a=t.labelText;if(null==a||0==a.length){var i=t.labelProp;if(null!=i)var s=l.featureType.getFieldIndex(i)}else n=a;for(var u=null,o=null,h=null,c=0,r=e.length;r>c;c++)l=e[c],o=l.geometry,null!=o&&(h=new GeoBeans.PointLabel,h.geometry=o,h.textSymbolizer=t,u=null==n?l.values[s]:n,h.text=u,h.computePosition(this.renderer,this.map.transformation),this.renderer.drawLabel(h));this.renderer.restore()}},drawFeature:function(e,t){for(var r=this.selectRules(e),l=r.length,n=0;l>n;n++){var a=r[n];if((null==t||"undefined"==t)&&(t=a.symbolizer),this.map.renderer.save(),this.map.renderer.setSymbolizer(t),t instanceof GeoBeans.Symbolizer.TextSymbolizer){var i=e.featureType.getFieldIndex(t.field);this.map.renderer.label(e.geometry,e.values[i],t,this.map.transformation)}else this.map.renderer.draw(e,t,this.map.transformation);this.map.renderer.restore()}r=null},clearFeature:function(e){switch(e.geometry.type){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:var t=this.getSymbolizer(e);this.map.renderer.clear(e.geometry,this.map.bgColor,t.size,this.map.transformation);break;default:this.map.renderer.clear(e.geometry,this.map.bgColor,0,this.map.transformation)}},selectFeatures:function(e){if(null==e)return this.features;var t=e.type;if(t==GeoBeans.Filter.Type.FilterComparsion){var r=null,l=null,n=e.expression1;null!=n&&(n.type==GeoBeans.Expression.Type.PropertyName?r=n.name:n.type==GeoBeans.Expression.Type.Literal&&(l=n.value));var a=e.expression2;null!=a&&(a.type==GeoBeans.Expression.Type.PropertyName?r=a.name:a.type==GeoBeans.Expression.Type.Literal&&(l=a.value))}if(null==r||null==l)return this.features;var i=[],s=this.featureType.getFieldIndex(r);if(s>=0)for(var u=null,o=this.features.length,h=0;o>h;++h)u=this.features[h],fvalue=u.values[s],fvalue==l&&i.push(u);return i},selectFeaturesByFilter:function(e,t,r,l){if(null==e)return t;var n=e.type,a=t;switch(n){case GeoBeans.Filter.Type.FilterID:a=this.selectFeaturesByIDFilter(e,t,r,l);break;case GeoBeans.Filter.Type.FilterComparsion:a=this.selectFeaturesByComparsion(e,t,r,l);break;case GeoBeans.Filter.Type.FilterLogic:a=this.selectFeatureByLogic(e,t,r,l);break;case GeoBeans.Filter.Type.FilterSpatial:a=this.selectFeaturesBySpatial(e,t,r,l)}return a},selectFeaturesByIDFilter:function(e){if(null==e)return this.features;var t=e.ids;if(null==t)return this.features;for(var r=[],l=0;l<this.features.length;++l){var n=this.features[l],a=n.fid;-1!=t.indexOf(a)&&r.push(n)}return r},selectFeaturesByComparsion:function(e,t,r,l){if(null==e)return t;var n=null;null!=r&&(n=r),null!=l&&(n+=l);var a=e.operator,i=[],s=null,u=null,o=e.expression1;null!=o&&(o.type==GeoBeans.Expression.Type.PropertyName?s=o.name:o.type==GeoBeans.Expression.Type.Literal&&(u=o.value));var h=e.expression2;switch(null!=h&&(h.type==GeoBeans.Expression.Type.PropertyName?s=h.name:h.type==GeoBeans.Expression.Type.Literal&&(u=h.value)),a){case GeoBeans.ComparisionFilter.OperatorType.ComOprEqual:if(null==s||null==u){i=t;break}var c=this.featureType.getFieldIndex(s);if(-1==c){i=t;break}for(var f=null,y=null,p=0;p<t.length&&(f=t[p],y=f.values[c],y==u&&i.push(f),null==n||i.length!=n);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprNotEqual:if(null==s||null==u){i=t;break}var c=this.featureType.getFieldIndex(s);if(-1==c){i=t;break}for(var f=null,y=null,p=0;p<t.length&&(f=t[p],y=f.values[c],y!=u&&i.push(f),null==n||i.length!=n);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprLessThan:if(null==s||null==u){i=t;break}var c=this.featureType.getFieldIndex(s);if(-1==c){i=t;break}for(var f=null,y=null,p=0;p<t.length&&(f=t[p],y=f.values[c],u>y&&i.push(f),null==n||i.length!=n);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprGreaterThan:if(null==s||null==u){i=t;break}var c=this.featureType.getFieldIndex(s);if(-1==c){i=t;break}for(var f=null,y=null,p=0;p<t.length&&(f=t[p],y=f.values[c],y>u&&i.push(f),null==n||i.length!=n);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprLessThanOrEqual:if(null==s||null==u){i=t;break}var c=this.featureType.getFieldIndex(s);if(-1==c){i=t;break}for(var f=null,y=null,p=0;p<t.length&&(f=t[p],y=f.values[c],u>=y&&i.push(f),null==n||i.length!=n);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprGreaterThanOrEqual:if(null==s||null==u){i=t;break}var c=this.featureType.getFieldIndex(s);if(-1==c){i=t;break}for(var f=null,y=null,p=0;p<t.length&&(f=t[p],y=f.values[c],y>=u&&i.push(f),null==n||i.length!=n);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprIsLike:if(null==s||null==u){i=t;break}var c=this.featureType.getFieldIndex(s);if(-1==c){i=t;break}for(var f=null,y=null,p=0;p<t.length&&(f=t[p],y=f.values[c],y.like(u)&&i.push(f),null==n||i.length!=n);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprIsNull:break;case GeoBeans.ComparisionFilter.OperatorType.ComOprIsBetween:var m=e.expression,v=e.lowerBound,d=e.upperBound,s=m.name,g=v.value,T=d.value;if(null==s||null==g||null==T){i=t;break}var c=this.featureType.getFieldIndex(s);if(-1==c){i=t;break}for(var f=null,y=null,p=0;p<t.length&&(f=t[p],y=f.values[c],y>=g&&T>=y&&i.push(f),null==n||i.length!=n);++p);}var B=null;return B=null!=r&&null!=l?i.slice(l,n):null!=r&&null==l?i.slice(0,r):null==r&&null!=l?i.slice(l):i},selectFeatureByLogic:function(e,t,r,l){if(null==e)return t;var n=null;null!=r&&(n=r),null!=l&&(n+=l);var a=t,i=e.operator;switch(i){case GeoBeans.LogicFilter.OperatorType.LogicOprAnd:a=this.selectFeatureByLogicAnd(e,t,r,l);break;case GeoBeans.LogicFilter.OperatorType.LogicOprOr:a=this.selectFeatureByLogicOr(e,t,r,l);break;case GeoBeans.LogicFilter.OperatorType.LogicOprNot:a=this.selectFeatureByLogicNot(e,t,r,l)}return a},selectFeatureByLogicAnd:function(e,t,r,l){if(null==e)return t;var n=null;null!=r&&(n=r),null!=l&&(n+=l);for(var a=t,i=e.filters,s=0;s<i.length;++s){var u=i[s];a=this.selectFeaturesByFilter(u,a,null,null)}var o=null;return o=null!=r&&null!=l?a.slice(l,n):null!=r&&null==l?a.slice(0,r):null==r&&null!=l?a.slice(l):a},selectFeatureByLogicOr:function(e,t,r,l){if(null==e)return t;var n=null;null!=r&&(n=r),null!=l&&(n+=l);for(var a=[],i=e.filters,s=0;s<i.length;++s){var u=i[s],o=this.selectFeaturesByFilter(u,t,null,null);if(a=this.concatArray(a,o),null!=n&&a.length>=n)break}var h=null;return h=null!=r&&null!=l?a.slice(l,n):null!=r&&null==l?a.slice(0,r):null==r&&null!=l?a.slice(l):a},concatArray:function(e,t){if($.isArray(e)&&$.isArray(t)){for(var r=e.slice(0,e.length),l=0;l<t.length;++l)-1==$.inArray(t[l],r)&&r.push(t[l]);return r}},selectFeatureByLogicNot:function(e,t,r,l){if(null==e)return t;var n=null;null!=r&&(n=r),null!=l&&(n+=l);for(var a=e.filters[0],i=this.selectFeaturesByFilter(a,t,r,l),s=[],u=0;u<t.length&&(-1==$.inArray(t[u],i)&&s.push(t[u]),!(null!=n&&i.length>=n));++u);var o=null;return o=null!=r&&null!=l?s.slice(l,n):null!=r&&null==l?s.slice(0,r):null==r&&null!=l?s.slice(l):s},selectRules:function(e){var t=[];if(null!=this.style)for(var r=this.style.rules.length,l=0;r>l;l++){var n=this.style.rules[l];if(null!=n.filter){var a=n.filter.field,i=null,s=this.featureType.getFieldIndex(a);i=e.values[s],i==n.filter.value&&t.push(n)}else t.push(n)}return t},getSymbolizer:function(e){for(var t=this.selectRules(e),r=t.length,l=0;r>l;l++){var n=t[l],a=n.symbolizer;if(!(a instanceof GeoBeans.Style.TextSymbolizer))return a}return null},selectFeaturesBySpatial:function(e,t,r,l){if(null==e)return t;var n=e.operator,a=t;switch(n){case GeoBeans.SpatialFilter.OperatorType.SpOprBBox:a=this.selectFeaturesByBBoxFilter(e,t,r,l)}return a},selectFeaturesByBBoxFilter:function(e,t,r,l){if(null==e)return t;var n=e.extent,a=(this.getGeomType(),[]),i=null;null!=r&&(i=r),null!=l&&(i+=l);for(var s=0;s<t.length;++s){var u=t[s],o=u.geometry,h=o.extent;if((n.intersects(h)||n.containOther(h))&&a.push(u),null!=i&&a.length==i)break}var c=null;return c=null!=r&&null!=l?a.slice(l,i):null!=r&&null==l?a.slice(0,r):null==r&&null!=l?a.slice(l):a},getFeatureBBoxGet:function(e,t,r){var l=new GeoBeans.BBoxFilter(this.featureType.geomFieldName,e);return this.selectFeaturesByFilter(l,this.features,t,r)},setHitControl:function(e){null!=e&&"undefined"!=e&&(this.hitControl=null,this.hitControl=e)},init:function(){},enableHit:function(e){this.enableHit=e},hit:function(e,t,r){if(null!=this.features){this.map.renderer,this.map.transformation;this.selection=[];var l=0,n=null,a=null,i=this.features.length;for(l=0;i>l;l++)n=this.features[l],a=n.geometry,null!=a&&a.hit(e,t,this.map.tolerance)&&this.selection.push(n);if(this.hitRenderer.clearRect(0,0,this.hitCanvas.height,this.hitCanvas.width),this.map.drawLayersAll(),void 0!=r){var s=new GeoBeans.Geometry.Point(e,t);r(this,this.selection,s)}}},registerHitEvent:function(e){var t=this.map,r=this,l=null,n=null,a=10;this.hitCanvas=document.createElement("canvas"),this.hitCanvas.width=this.canvas.width,this.hitCanvas.height=this.canvas.height,this.hitRenderer=new GeoBeans.Renderer(this.hitCanvas),this.hitEvent=function(i){if(null==l)l=i.layerX,n=i.layerY;else{var s=Math.abs(i.layerX-l)+Math.abs(i.layerY-n);if(s>a){l=i.layerX,n=i.layerY;var u=t.transformation.toMapPoint(i.layerX,i.layerY);r.hit(u.x,u.y,e)}}},t.mapDiv[0].addEventListener("mousemove",this.hitEvent),this.events.addEvent("mousemove",this.hitEvent)},unRegisterHitEvent:function(){this.map.mapDiv[0].removeEventListener("mousemove",this.hitEvent),this.hitRenderer.clearRect(0,0,this.hitCanvas.height,this.hitCanvas.width),this.map.drawLayersAll(),this.hitEvent=null},drawHitFeature:function(e,t){for(var r=this.selectRules(e),l=r.length,n=0;l>n;n++){var a=r[n];if((null==t||"undefined"==t)&&(t=a.symbolizer),this.hitRenderer.save(),this.hitRenderer.setSymbolizer(t),t instanceof GeoBeans.Symbolizer.TextSymbolizer){var i=e.featureType.getFieldIndex(t.field);this.hitRenderer.label(e.geometry,e.values[i],t,this.map.transformation)}else this.hitRenderer.draw(e,t,this.map.transformation);this.hitRenderer.restore()}r=null,this.map.drawLayersAll()},cleanup:function(){this.enableHit=!1,this.map.canvas.removeEventListener("mousemove",this.hitEvent),this.map.canvas.removeEventListener("mousemove",this.hitTooltipEvent)},registerHitTooltipEvent:function(e){var t=this.map,r=this,l=null,n=null,a=10;this.hitTooltipEvent=function(t){if(null==l)l=t.layerX,n=t.layerY;else{var i=Math.abs(t.layerX-l)+Math.abs(t.layerY-n);i>a&&(l=t.layerX,n=t.layerY,r.hitTooltip(t.layerX,t.layerY,e))}},t.canvas.addEventListener("mousemove",this.hitTooltipEvent)},unregisterHitTooltipEvent:function(){this.map.canvas.removeEventListener("mousemove",this.hitTooltipEvent),this.hitTooltipEvent=null},hitTooltip:function(e,t,r){if(null!=this.features&&null!=r){var l=this.map,n=l.transformation.toMapPoint(e,t),a=n.x,i=n.y,s=(this.map.renderer,this.map.transformation,0),u=null,o=null,h=this.features.length;for(s=0;h>s;s++)if(u=this.features[s],o=u.geometry,null!=o&&o.hit(a,i,this.map.tolerance))return void r(this,a,i,u);r(this,a,i,null)}},getBufferTracker:function(){if(null==this.bufferTracker){var e=new GeoBeans.Control.TrackBufferControl,t=this.map.controls.find(e.type);-1==t?(this.bufferTracker=e,this.map.controls.add(this.bufferTracker)):this.bufferTracker=this.map.controls.get(t)}return this.bufferTracker},queryByBufferLine:function(e,t){var r=this.getBufferTracker();r.trackBufferLine(this,e,t,this.callbackQueryByBufferTrack)},queryByBufferCircle:function(e){var t=this.getBufferTracker();t.trackBufferCircle(this,e,this.callbackQueryByBufferTrack)},callbackQueryByBufferTrack:function(e,t,r,l){if(!(null==r||0>t)){var n=e.featureType;if(null!=n){var a=e.workspace;null!=a&&a.queryByBuffer(t,r,n,l)}}},beginTransaction:function(e){var t=this.featureType.getFieldIndex(this.featureType.geomFieldName),r=this.featureType.fields[t],l=r.geomType,n=this.getTransactionTracker();switch(l){case GeoBeans.Geometry.Type.POINT:n.trackPoint(this.transactionCallback,e,this);break;case GeoBeans.Geometry.Type.LINESTRING:n.trackLine(this.transactionCallback,e,this,!1);break;case GeoBeans.Geometry.Type.MULTILINESTRING:n.trackLine(this.transactionCallback,e,this,!0);break;case GeoBeans.Geometry.Type.POLYGON:n.trackPolygon(this.transactionCallback,e,this,!1);break;case GeoBeans.Geometry.Type.MULTIPOLYGON:n.trackPolygon(this.transactionCallback,e,this,!0)}},transactionCallback:function(e,t,r){t(e,r)},transaction:function(e,t,r){this.workspace.transaction(this.featureType,e,t,r)},getTransactionTracker:function(){var e=null,t=this.map.controls.find(GeoBeans.Control.Type.TRACKTRANSACTION);return-1==t?(e=new GeoBeans.Control.TrackControl.TrackTransactionControl,this.map.controls.add(e)):e=this.map.controls.get(t),e},CLASS_NAME:"GeoBeans.Layer.FeatureLayer",registerClickEvent:function(e,t){var r=this.map,l=this;null!=e&&(this.clickStyle=e),this.clickEvent=function(e){console.log("click up");var n=l.map.controls.find(GeoBeans.Control.Type.DRAG_MAP),a=l.map.controls.get(n);if(a.draging)return void console.log("draging");l.clickRenderer.clearRect(),l.map.drawLayersAll();var i=r.transformation.toMapPoint(e.layerX,e.layerY);l.clickHit(i.x,i.y,t)},r.canvas.addEventListener("mouseup",this.clickEvent)},clickHit:function(e,t,r){if(this.map.closeInfoWindow(),null==this.features)return void(null!=r&&r(null));var l=[],n=0,a=null,i=null,s=this.features.length;for(n=0;s>n;n++)a=this.features[n],i=a.geometry,null!=i&&i.hit(e,t,this.map.tolerance)&&l.push(a);if(0==l.length)return this.clickFeature=null,void(null!=r&&r(null));for(var u=l[0],o=u.geometry,h=this.getDistance(e,t,o),n=1;n<l.length;++n){var a=l[n],i=a.geometry,c=this.getDistance(e,t,i);h>c&&(u=a)}null!=r&&(this.clickFeature=u,this.map.drawLayersAll(),r(u,e,t))},getDistance:function(e,t,r){var l=this.getGeomType(),n=null;switch(l){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:r.getCentroid();n=GeoBeans.Utility.getDistance(e,t,r.x,r.y);break;case GeoBeans.Geometry.Type.LINESTRING:case GeoBeans.Geometry.Type.MULTILINESTRING:n=r.distance(e,t);break;case GeoBeans.Geometry.Type.POLYGON:case GeoBeans.Geometry.Type.MULTIPOLYGON:r.getCentroid();n=GeoBeans.Utility.getDistance(e,t,r.x,r.y)}return n},unRegisterClickEvent:function(){this.map.closeInfoWindow(),this.map.canvas.removeEventListener("mouseup",this.clickEvent),this.clickEvent=null,this.clickRenderer.clearRect(),this.clickFeature=null,this.map.drawLayersAll()},drawClickLayer:function(){if(this.clickRenderer.clearRect(),null!=this.clickFeature){var e=this.clickStyle;if(null==e&&(e=this.getDefaultStyle()),null!=e){var t=e.rules;if(0!=t.length)for(var r=0;r<t.length;r++){var l=t[r],n=this.selectFeaturesByFilter(l.filter,[this.clickFeature]);null!=l.symbolizer&&(null!=l.symbolizer.symbol?this.clickRenderer.drawIcons(n,l.symbolizer,this.map.transformation):this.drawClickFeatures(n,l.symbolizer)),null!=l.textSymbolizer&&this.labelClickFeatures(n,l.textSymbolizer)}}}},drawClickFeatures:function(e,t){if(null!=e){this.clickRenderer.save(),this.clickRenderer.setSymbolizer(t);for(var r=0,l=e.length;l>r;r++)feature=e[r],null!=t&&"undefined"!=t&&this.clickRenderer.draw(feature,t,this.map.transformation);this.clickRenderer.restore()}},labelClickFeatures:function(e,t){var r=e.length;if(0!=r){this.clickRenderer.save(),this.clickRenderer.setSymbolizer(t);var l=e[0],n=null,a=t.labelText;if(null==a||0==a.length){var i=t.labelProp;if(null!=i)var s=l.featureType.getFieldIndex(i)}else n=a;for(var u=null,o=null,h=null,c=0,r=e.length;r>c;c++)l=e[c],o=l.geometry,null!=o&&(h=new GeoBeans.PointLabel,h.geometry=o,h.textSymbolizer=t,u=null==n?l.values[s]:n,h.text=u,h.computePosition(this.clickRenderer,this.map.transformation),this.clickRenderer.drawLabel(h));this.clickRenderer.restore()}},getFeatureValue:function(e,t){return null!=e?e.getValue(t):void 0},setFeatureValue:function(e,t,r){null!=e&&(e.setValue(t,r),this.flag=GeoBeans.Layer.Flag.READY)},getFeatureFilter:function(e,t,r,l,n){var a=new Date,i=this.selectFeaturesByFilter(e,this.features,t,r),s=new Date-a;console.log("select feature:"+s),this.map.queryLayer.setFeatures(i),this.map.drawLayersAll(),n(i)}});
GeoBeans.Layer.ChartLayer=GeoBeans.Class(GeoBeans.Layer.FeatureLayer,{baseLayerName:null,baseLayerField:null,option:null,baseLayer:null,initialize:function(e,a,t,n){this.name=e,this.baseLayerName=a,this.baseLayerField=t,this.option=n},destroy:function(){this.baseLayerName=null,this.baseLayerField=null,this.option=null,this.removeLegend(),this.map._removeLegend(this.legendIndex)},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments);var a=this.getFeatures();this.features=a},getFeatures:function(){var e=this.map.getLayer(this.baseLayerName);if(null==e)return null;this.baseLayer=e,this.featureType=this.baseLayer.featureType;var a=e.getFeatures();return a},getMinMaxValue:function(){if(null==this.features)return null;for(var e=null,a=null,t=null,n=this.featureType.getFieldIndex(this.baseLayerField),s=0;s<this.features.length;++s)if(t=this.features[s],null!=t){var i=t.values,l=i[n];null!=l&&(l=parseFloat(l),e=null==e?l:e>l?l:e,a=null==a?l:l>a?l:a)}return{min:e,max:a}},addLegend:function(){},removeLegend:function(){this.map.mapDiv.find(".chart-legend#"+this.name).remove()},showLegend:function(){this.map.mapDiv.find(".chart-legend#"+this.name).css("display","block")},hideLegend:function(){this.map.mapDiv.find(".chart-legend#"+this.name).css("display","none")}});
...
GeoBeans.TileState={LOADED:1,LOADING:2},GeoBeans.Tile=GeoBeans.Class({map:null,image:null,url:null,row:null,col:null,level:null,layer:null,state:null,initialize:function(e,i,l,t,a,s){this.map=e,this.url=i,this.row=t,this.col=a,this.level=s,this.layer=l},loading:function(e,i,l,t){if(null==this.image&&(this.image=new Image,this.image.crossOrigin="anonymous",this.image.src=this.url),this.image.complete&&0!=this.image.height&&0!=this.width)return this.state=GeoBeans.TileState.LOADED,void i(this,e,l,t);var a=this;this.image.onload=function(){a.layer.flag!=GeoBeans.Layer.Flag.LOADED&&(a.state=GeoBeans.TileState.LOADED,i(a,e,l,t))}},draw:function(e,i,l,l){this.layer.imageScale;this.map.level==this.level&&(this.layer.renderer.context.clearRect(e,i,l,l),this.layer.visible&&(this.layer.renderer.drawImage(this.image,e,i,l,l),this.map._updateTile(this.layer,e,i,l,l)))}});
...
GeoBeans.Overlay.Marker=GeoBeans.Class(GeoBeans.Overlay,{image:null,type:GeoBeans.Overlay.Type.MARKER,infoWindow:null,initialize:function(e,a,i,n){GeoBeans.Overlay.prototype.initialize.apply(this,arguments),this.infoWindow=n}});
...
GeoBeans.Symbol=GeoBeans.Class({name:null,icon:null,icon_height:null,icon_width:null,icon_offset_x:null,icon_offset_y:null,scale:null,initialize:function(i,n){this.name=i,this.icon=n},clone:function(){var i=new GeoBeans.Symbol;return null!=this.name&&(i.name=this.name),null!=this.icon&&(i.icon=this.icon),null!=this.icon_height&&(i.icon_height=this.icon_height),null!=this.icon_width&&(i.icon_width=this.icon_width),null!=this.icon_offset_x&&(i.icon_offset_x=this.icon_offset_x),null!=this.icon_offset_y&&(i.icon_offset_y=this.icon_offset_y),null!=this.scale&&(i.scale=this.scale),i}});
