...
GeoBeans.Layer.QSLayer=GeoBeans.Class(GeoBeans.Layer.TileLayer,{AMP_URL:"/QuadServer/maprequest?services=world_image",IMG_WIDTH:256,IMG_HEIGHT:256,MIN_ZOOM_LEVEL:2,MAX_ZOOM_LEVEL:17,FULL_EXTENT:{xmin:-256,ymin:-256,xmax:256,ymax:256},RESOLUTIONS:[1,.5,.25,.125,.0625,.03125,.015625,.0078125,.00390625,.001953125,976563e-9,488281e-9,244141e-9,12207e-8,6103515625e-14,30517578125e-15,152587890625e-16,762939453125e-17,3814697265625e-18,19073486328125e-19],resolution:null,rows:null,cols:null,offset_x:0,offset_y:0,lrow:0,urow:0,lcol:0,rcol:0,initialize:function(e,t){GeoBeans.Layer.TileLayer.prototype.initialize.apply(this,arguments),this.type=GeoBeans.Layer.TileLayer.Type.QS},destroy:function(){GeoBeans.Layer.TileLayer.prototype.destroy.apply(this,arguments)},updateTileCache:function(e){var t,i,a,s,l=e.rmin,o=e.rmax,r=e.cmin,n=e.cmax,h=null,m=this.map.level;for(a=l;o>a;a++)for(s=r;n>s;s++)t=this.getTileID(a,s,m),i=this.url+"&"+t,null==this.cache.getTile(i)&&(h=new GeoBeans.Tile(this.map,i,this,a,s,m,0,0),this.cache.putTile(h))},preDraw:function(){var e=this.map.level,t=this.getMaxLevel(),i=this.getMinLevel();if(e>t||i>e)return this.tiles=[],this.renderer.clearRect(),void(this.snap=null);var a=this.computeTileBound();this.updateTileCache(a);var s=a.rmin,l=a.rmax,o=a.cmin,r=a.cmax,n=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymin);n.x=Math.floor(n.x+.5),n.y=Math.floor(n.y+.5);var h=this.IMG_WIDTH*this.imageScale,m=this.map.resolution,c=this.getResolutionByLevel(this.map.level);m!=c&&(h=this.IMG_WIDTH*this.imageScale*c/m);var u,T,f,y,L;this.map.transformation.toMapPoint(n.x,n.y);this.tiles=[];var e=this.map.level;for(T=n.y-(s+1)*h,f=s;l>f;f++){for(u=n.x+o*h,y=o;r>y;y++){tid=this.getTileID(f,y,e),turl=this.url+"&"+tid,L=this.cache.getTile(turl);var x=new Object;x.tile=L,x.img_size=h,x.x=u,x.y=T,this.tiles.push(x),u+=h}T-=h}},loadingTiles:function(e){for(var t=0;t<this.tiles.length;++t){var i=this.tiles[t].tile;if(null!=i)if(i.state!=GeoBeans.TileState.LOADED)i.loading(e,this.loadTileCallback,this.tiles,t),this.state=GeoBeans.TileLayerState.LOADING;else if(i.state==GeoBeans.TileState.LOADED){var a=this.tiles[t],s=a.img_size,l=a.x,o=a.y;i.draw(l,o,s,s)}}},loadTileCallback:function(e,t,i,a){var s=i[a],l=s.img_size,o=s.x,r=s.y;e.draw(o,r,l,l)},draw:function(){for(var e=0;e<this.tilesLoaded.length;++e){var t=this.tilesLoaded[e],i=t.tile,a=t.img_size,s=t.x,l=t.y;null!=i&&i.draw(s,l,a,a)}},drawCache:function(){var e=this.computeTileBound(),t=e.rmin,i=e.rmax,a=e.cmin,s=e.cmax,l=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymin);l.x=Math.floor(l.x+.5),l.y=Math.floor(l.y+.5);var o,r,n,h,m,c=this.IMG_WIDTH*this.scale,u=this.map.level;for(r=l.y-(t+1)*c,n=t;i>n;n++){for(o=l.x+a*c,h=a;s>h;h++)tid=this.getTileID(n,h,u),turl=this.url+"&"+tid,m=this.cache.getTile(turl),null!=m&&m.draw(o,r,c,c),o+=c;r-=c}},getRows:function(){},getCols:function(){},computeExtent:function(){},computeCenterTileOffset:function(){var e=this.map.center,t=(e.x-this.ORIGIN.x,e.y-this.ORIGIN.y,Math.floor((e.x-this.ORIGIN.x)/this.resolution)),i=Math.floor((e.y-this.ORIGIN.y)/this.resolution);offset_x=t,offset_y=i},getTileID:function(e,t,i){return"col="+t+"&row="+e+"&level="+i},computeTileBound:function(){var e=this.map,t=e.level,i=this.getResolutionByLevel(t),a=i*this.IMG_WIDTH,s=this.getValidView(),l=Math.floor((s.xmin-this.FULL_EXTENT.xmin)/a),o=Math.ceil((s.xmax-this.FULL_EXTENT.xmin)/a),r=Math.floor((s.ymin-this.FULL_EXTENT.ymin)/a),n=Math.ceil((s.ymax-this.FULL_EXTENT.ymin)/a);return{rmin:r-1,rmax:n+1,cmin:l-1,cmax:o+1}}});
