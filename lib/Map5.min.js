...
GeoBeans.Control.ZoomControl=GeoBeans.Class(GeoBeans.Control,{mode:null,initialize:function(){this.type=GeoBeans.Control.Type.ZOOM},destory:function(){this.end()},end:function(){this.cleanup(),this.map.enableDrag(!0)},setMode:function(e){this.mode=e},cleanup:function(){this.map.mapDiv[0].removeEventListener("mousedown",this.onMouseDown),this.map.mapDiv[0].removeEventListener("mousemove",this.onMouseMove),this.map.mapDiv[0].removeEventListener("mouseup",this.onMouseUp),this.onMouseDown=null,this.onMouseMove=null,this.onMouseUp=null},trackRect:function(){var e=this;if(null==this.onMouseDown){this.map.enableDrag(!1);var t=null,a=null,n=function(n){n.preventDefault(),e.map.saveSnap(),t={x:n.layerX,y:n.layerY},e.drawPoints([],n.layerX,n.layerY);var o=function(n){if(n.preventDefault(),null!=t){a={x:n.layerX,y:n.layerY},e.map.restoreSnap();var o=[];o.push(t),o.push({x:a.x,y:t.y}),o.push(a),o.push({x:t.x,y:a.y}),e.drawPolygon(o,t.x,t.y)}},i=function(n){if(n.preventDefault(),null!=a){var s=t.x-a.x,r=t.y-a.y;if(e.map.mapDiv[0].removeEventListener("mousemove",o),e.map.mapDiv[0].removeEventListener("mouseup",i),e.map.restoreSnap(),!(Math.abs(s)<1e-4&&Math.abs(r)<1e-4)){var l=e.buildRect(t,a);e.zoomMap(l),t=null,a=null}}};e.map.mapDiv[0].addEventListener("mousemove",o),e.map.mapDiv[0].addEventListener("mouseup",i),e.onMouseMove=o,e.onMouseUp=i};this.map.mapDiv[0].addEventListener("mousedown",n),this.onMouseDown=n}},drawPolygon:function(e,t,a){var n=this.map.renderer.context;n.save(),n.fillStyle="rgba(255,255,255,0.25)",n.strokeStyle="rgba(0,0,0,1)",n.lineWidth=.5;var o=e.length;for(n.beginPath(),n.moveTo(t,a),i=0;i<o;i++)n.lineTo(e[i].x,e[i].y);n.closePath(),n.fill(),n.stroke(),n.restore()},buildRect:function(e,t){e=this.map.transformation.toMapPoint(e.x,e.y),t=this.map.transformation.toMapPoint(t.x,t.y);var a=e.x>t.x?t.x:e.x,n=e.x>t.x?e.x:t.x,o=e.y>t.y?t.y:e.y,i=e.y>t.y?e.y:t.y,s=new GeoBeans.Envelope(a,o,n,i);return s},drawPoints:function(e,t,a){var n=this.map.renderer.context;n.save();var o=5;n.fillStyle="rgba(255,0,0,0.25)",n.strokeStyle="rgba(255,0,0,0.25)",n.lineWidth=.5,n.beginPath(),n.arc(t,a,o,0,2*Math.PI,!1),n.closePath(),n.fill(),n.stroke();for(var i=e.length,s=0;s<i;s++)n.beginPath(),n.arc(e[s].x,e[s].y,o,0,2*Math.PI,!1),n.closePath(),n.fill(),n.stroke();n.restore()},zoomMap:function(e){"in"==this.mode?this.zoomInMap(e):this.zoomOutMap(e)},zoomInMap:function(e){var t=this.map.viewer,a=e.getWidth()/t.getWidth(),n=e.getHeight()/t.getHeight(),o=a<n?a:n,i=new GeoBeans.Geometry.Point(t.xmin,t.ymax),s=new GeoBeans.Geometry.Point(t.xmax,t.ymin);t.scale(o);var r=e.getCenter();if(this.map.setCenter(r),null!=this.map.baseLayer){var l=this.map.getLevel(t);this.map.drawBackground(),this.map.setLevel(l),this.map.drawLayersSnap_2(o,i,s),console.log(l)}else this.map.drawBackground(),this.map.drawLayersSnap_2(o,i,s),this.map.setViewer(t);this.map.draw()},zoomOutMap:function(e){var t=this.map.viewer,a=t.getWidth()/e.getWidth(),n=t.getHeight()/e.getHeight(),o=a>n?a:n;if(t.scale(o),null!=this.map.baseLayer){var i=this.map.getLevel(t);this.map.drawBackground(),this.map.drawBaseLayerSnap(i),this.map.setLevel(i),console.log(i)}else this.map.drawBackground(),this.map.drawLayersSnap(o),this.map.setViewer(t);this.map.draw()}});
