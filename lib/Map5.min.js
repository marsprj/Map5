...
GeoBeans.Layer.HeatMapLayer=GeoBeans.Class(GeoBeans.Layer,{name:null,container:null,data:null,layer:null,field:null,uniqueValue:null,heatmapInstance:null,div:null,initialize:function(e){this.name=e},setMap:function(e){if(null!=e){this.map=e,this.div=document.createElement("div"),this.div.className="heatmap";var a=e.canvas,t=a.height,n=a.width;this.div.style.cssText="height:"+t+"px;width:"+n+"px;",this.heatmapInstance=h337.create({container:this.div,gradient:{.2:"rgb(251,246,253)",.9:"rgb(231,201,244)",.6:"#AB40DC",.8:"#B241E5",.95:"white"},blur:.1})}},destory:function(){this.name=null,this.layer=null,this.field=null,this.heatmapInstance=null},setLayer:function(e,a,t){null!=e&&(null!=a||null!=t)&&(this.layer=e,this.field=a,this.uniqueValue=t)},getField:function(){return this.field},getUniqueValue:function(){return this.uniqueValue},load:function(){var e=this.layer.featureType;if(null==e)return void(this.flag=GeoBeans.Layer.Flag.LOADED);var a=e.getFieldIndex(this.field);if(0>a&&null==this.uniqueValue)return void(this.flag=GeoBeans.Layer.Flag.LOADED);var t,n,i=null,l=null,u=[],s=null,r=this.layer.map.transformation,h=this.map.getViewer();if(null==h)return void(this.flag=GeoBeans.Layer.Flag.LOADED);var o=this.layer.getFeatureBBoxGet(h);if(null==o)return void(this.flag=GeoBeans.Layer.Flag.LOADED);for(var d=0;d<o.length;++d){var f=o[d],c=f.geometry;c instanceof GeoBeans.Geometry.Point&&(s=r.toScreenPoint(c.x,c.y)),0>a&&null!=this.uniqueValue?(t=this.uniqueValue,l=t,i=t):a>=0&&(t=f.values[a],0==d&&(i=t,l=t),i=Math.max(t,i),l=Math.min(t,l)),n={x:s.x,y:s.y,value:t},u.push(n)}var v={max:i,min:l,data:u};this.heatmapInstance.setData(v),this.canvas=this.div.children[0],this.flag=GeoBeans.Layer.Flag.LOADED}});
