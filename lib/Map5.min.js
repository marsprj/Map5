...
GeoBeans.Control.SrollMapControl=GeoBeans.Class(GeoBeans.Control,{onmousewheel:null,count:0,userHandler:null,initialize:function(e){GeoBeans.Control.prototype.initialize.apply(this,arguments),this.map=e;var a=this;this.type=GeoBeans.Control.Type.SCROLL_MAP;var r=function(r,n){if(a.enabled){r.preventDefault();var t=e.getMaxLevel(),s=e.getMinLevel(),l=e._getTrackOverlayControl();if(l.drawing&&e.restoreSnap(),null!=e.baseLayer){var o=e.level;if(r.wheelDelta>0)if(1!=e.baseLayer.imageScale){var i=1/(1+.2*n);e.viewer.scale(i),o=e.getLevel(e.viewer),e.saveSnap(),e.drawBackground(),e.drawLayersSnap(i),e._setLevel(o),e.draw()}else o+=n,o>t&&(o=t),e.saveSnap(),e.drawBackground(),e.drawBaseLayerSnap(o),e.setLevel(o),e.draw();else if(1!=e.baseLayer.imageScale){var i=1+.2*n;e.viewer.scale(i),o=e.getLevel(e.viewer),e.saveSnap(),e.drawBackground(),e.drawLayersSnap(i),e._setLevel(o),e.draw()}else o-=n,s>o&&(o=s),e.saveSnap(),e.drawBackground(),e.drawBaseLayerSnap(o),e.setLevel(o),e.draw()}else if(r.wheelDelta>0){var i=1/(1+.2*n);e.saveSnap(),e.drawBackground(),e.drawLayersSnap(i),e.viewer.scale(i),e.transformation.update(),e.draw()}else{var i=1+.2*n;e.saveSnap(),e.drawBackground(),e.drawLayersSnap(i),e.viewer.scale(i),e.transformation.update(),e.draw()}e.saveSnap(),l.drawing&&l.drawingEvent()}};this.mousewheel=function(n){a.count=a.count+1;var t=a.count;setTimeout(function(){a.count==t&&(r(n,a.count),a.count=0,null!=a.userHandler&&a.userHandler({level:e.level}))},200)},e.mapDiv[0].addEventListener("mousewheel",this.mousewheel)},destory:function(){this.map.mapDiv[0].removeEventListener("mousewheel",this.mousewheel),GeoBeans.Control.prototype.destory.apply(this,arguments)}});
...
GeoBeans.Control.TrackOverlayControl=GeoBeans.Class(GeoBeans.Control.TrackControl,{drawing:!1,initialize:function(){this.type=GeoBeans.Control.Type.TRACKOVERLAY},destory:function(){},trackMarker:function(a,e){this.map.overlayLayer.setHitOverlayCallback(e);var n=this;this.map.saveSnap(),this.map.enableDrag(!1),this.cleanup();var r=function(r){if(r.preventDefault(),n.map.canvas.style.cursor="default",n.map.enableDrag(!0),null!=e&&void 0!=e){var t=n.map.transformation.toMapPoint(r.layerX,r.layerY),o=n.map.overlayLayer._getOverlayIDByIdentity(),i=new GeoBeans.Overlay.Marker(o,t,a);n.map.addOverlay(i),n.map.draw(),e(i)}n.map.canvas.removeEventListener("mousedown",n.onMouseDown),n.map.canvas.style.cursor="default"},t=function(a){a.preventDefault()};this.onMouseDown=r,this.onMouseMove=t,this.map.canvas.addEventListener("mousemove",t),this.map.canvas.addEventListener("mousedown",r)},trackLine:function(a,e){this.map.overlayLayer.setHitOverlayCallback(e);var n=this,r=[],t=[],o=!1;this.map.saveSnap(),this.map.enableDrag(!1),this.cleanup();var i=function(i){i.preventDefault();for(var s=!1,l=0;l<r.length;++l){var v=r[l],m=v.x,y=v.y;m==i.layerX&&y==i.layerY&&(s=!0)}if(0==s){var p=n.map.transformation.toMapPoint(i.layerX,i.layerY);r.push({x:i.layerX,y:i.layerY,mapX:p.x,mapY:p.y})}n.drawing=!0;var u=function(a){n.map.restoreSnap();var e=n.map.transformation.toMapPoint(a.layerX,a.layerY);n.drawLine(r,e.x,e.y),n.drawPoints(r,e.x,e.y),n.drawingEvent=function(){var e=n.map.transformation.toMapPoint(a.layerX,a.layerY);n.drawLine(r,e.x,e.y),n.drawPoints(r,e.x,e.y)}},c=function(i){if(n.map.enableDrag(!0),n.map.canvas.removeEventListener("mousedown",n.onMouseDown),n.map.canvas.removeEventListener("mousemove",u),n.map.canvas.removeEventListener("dblclick",c),t.length!=r.length){if(0==t.length&&r.forEach(function(a,e){t.push(a)}),i.preventDefault(),n.map.restoreSnap(),null!=e&&"undefined"!=e){var s=n.buildLineString(r),l=n.map.overlayLayer._getOverlayIDByIdentity(),v=new GeoBeans.Overlay.Polyline(l,s,a);n.map.addOverlay(v),n.map.draw(),e(v)}if(null==e)return n.buildLineString(r);t=[],r=[],o=!1,n.drawing=!1}};0==s&&r.push({x:i.layerX,y:i.layerY}),o||(console.log("add-mousemove"),n.map.canvas.addEventListener("mousemove",u),n.map.canvas.addEventListener("dblclick",c),o=!0),n.onMouseDClick=c,n.onMouseMove=u};this.map.canvas.addEventListener("mousedown",i),this.onMouseDown=i},trackPolygon:function(a,e){this.map.overlayLayer.setHitOverlayCallback(e);var n=this,r=[],t=[];this.map.saveSnap(),this.map.enableDrag(!1),this.cleanup();var o=function(o){o.preventDefault();for(var i=!1,s=0;s<r.length;++s){var l=r[s],v=l.x,m=l.y;v==o.layerX&&m==o.layerY&&(i=!0)}if(0==i){var y=n.map.transformation.toMapPoint(o.layerX,o.layerY);r.push({x:o.layerX,y:o.layerY,mapX:y.x,mapY:y.y})}n.drawing=!0;var p=function(a){n.map.restoreSnap();var e=n.map.transformation.toMapPoint(a.layerX,a.layerY);r.length>1?(n.drawPolygon(r,e.x,e.y),n.drawPoints(r,e.x,e.y)):(n.drawLine(r,e.x,e.y),n.drawPoints(r,e.x,e.y)),n.drawingEvent=function(){var e=n.map.transformation.toMapPoint(a.layerX,a.layerY);r.length>1?(n.drawPolygon(r,e.x,e.y),n.drawPoints(r,e.x,e.y)):(n.drawLine(r,e.x,e.y),n.drawPoints(r,e.x,e.y))}},u=function(o){if(o.preventDefault(),n.map.canvas.removeEventListener("mousemove",p),n.map.canvas.removeEventListener("dblclick",u),n.map.canvas.removeEventListener("mousedown",n.onMouseDown),n.map.enableDrag(!0),t.length!=r.length){if(0==t.length&&r.forEach(function(a,e){t.push(a)}),null!=e&&"undefined"!=e&&r.length>=3){var i=n.map.overlayLayer._getOverlayIDByIdentity(),s=n.buildPolygon(r),l=new GeoBeans.Overlay.Polygon(i,s,a);n.map.addOverlay(l),n.map.draw(),e(l)}t=[],r=[]}};n.map.canvas.addEventListener("mousemove",p),n.map.canvas.addEventListener("dblclick",u),n.onMouseMove=p,n.onMouseDBclick=u};this.map.canvas.addEventListener("mousedown",o),this.onMouseDown=o},drawLine:function(a,e,n){var r=this.map.renderer.context;r.save(),r.strokeStyle="rgba(255,0,0,0.25)",r.lineWidth=3,r.beginPath();var t=this.map.transformation.toScreenPoint(e,n);r.moveTo(t.x,t.y);for(var o=a.length,i=o-1;i>=0;i--){var t=this.map.transformation.toScreenPoint(a[i].mapX,a[i].mapY);r.lineTo(t.x,t.y)}r.stroke(),r.restore()},drawPoints:function(a,e,n){var r=this.map.renderer.context;r.save();var t=5;r.fillStyle="rgba(255,0,0,0.25)",r.strokeStyle="rgba(255,0,0,0.25)",r.lineWidth=.5,r.beginPath();var o=this.map.transformation.toScreenPoint(e,n);r.arc(o.x,o.y,t,0,2*Math.PI,!1),r.closePath(),r.fill(),r.stroke();for(var i=a.length,s=0;i>s;s++){r.beginPath();var o=this.map.transformation.toScreenPoint(a[s].mapX,a[s].mapY);r.arc(o.x,o.y,t,0,2*Math.PI,!1),r.closePath(),r.fill(),r.stroke()}r.restore()},drawPolygon:function(a,e,n){var r=this.map.renderer.context;r.save(),r.fillStyle="rgba(255,255,255,0.25)",r.strokeStyle="rgba(0,0,0,1)",r.lineWidth=.5;var t=a.length;r.beginPath();var o=this.map.transformation.toScreenPoint(e,n);for(r.moveTo(o.x,o.y),i=0;i<t;i++){var o=this.map.transformation.toScreenPoint(a[i].mapX,a[i].mapY);r.lineTo(o.x,o.y)}r.closePath(),r.fill(),r.stroke(),r.restore()},buildLineString:function(a){for(var e=null,n=[],r=a.length,t=0;r>t;t++)e=new GeoBeans.Geometry.Point(a[t].mapX,a[t].mapY),n.push(e);return new GeoBeans.Geometry.LineString(n)},buildPolygon:function(a){for(var e=null,n=[],r=a.length,t=0;r>t;t++)e=new GeoBeans.Geometry.Point(a[t].mapX,a[t].mapY),n.push(e);n.push(n[0]);var o=new GeoBeans.Geometry.LinearRing(n);return new GeoBeans.Geometry.Polygon([o])}});
...
GeoBeans.BBoxFilter=GeoBeans.Class(GeoBeans.SpatialFilter,{propName:null,extent:null,initialize:function(e,t){GeoBeans.SpatialFilter.prototype.initialize.apply(this,arguments),this.operator=GeoBeans.SpatialFilter.OperatorType.SpOprBBox,this.propName=e,this.extent=t},setExtent:function(e,t,i,a){}});
...
GeoBeans.Layer.FeatureLayer=GeoBeans.Class(GeoBeans.Layer,{features:null,style:null,geometryType:null,featureType:null,enableHit:!1,selection:null,unselection:null,hitControl:null,hitEvent:null,hitTooltipEvent:null,hitCanvas:null,hitRenderer:null,bufferCanvas:null,bufferRenderer:null,bufferFeatures:null,bufferSymbolizer:null,clickStyle:null,clickFeature:null,clickCanvas:null,clickRenderer:null,bufferTracker:null,initialize:function(e){GeoBeans.Layer.prototype.initialize.apply(this,arguments),this.featureType=null,this.features=null,this.selection=[],this.unselection=[]},destory:function(){this.features=null,this.style=null,this.renderer=null,this.geometryType=null,this.featureType=null,GeoBeans.Layer.prototype.destroy.apply(this,arguments)},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments),this.clickCanvas=document.createElement("canvas"),this.clickCanvas.width=this.canvas.width,this.clickCanvas.height=this.canvas.height,this.clickRenderer=new GeoBeans.Renderer(this.clickCanvas)},addFeature:function(e){null!=e&&(null==this.features&&(this.features=[]),this.features.push(e))},addFeatureObj:function(e,t,r){if(null!=e&&null!=r&&null!=t){var l=new GeoBeans.Feature(this.featureType,e,t,r);this.addFeature(l)}},addFeatures:function(e){if(null!=e&&e instanceof Array)for(var t=0,r=e.length;r>t;t++){var l=e[t];this.features.push(l)}},getFeature:function(e){return 0>e?null:e>=this.features.length?null:this.features[e]},getFeatureByID:function(e){if(null==this.features)return null;for(var t=null,r=0;r<this.features.length;++r)if(t=this.features[r],null!=t&&t.fid==e)return t;return null},setStyle:function(e){this.style=e,this.flag=GeoBeans.Layer.Flag.READY},count:function(){return this.features.length},draw:function(){var e=this.style;if(null!=e&&(rules=e.rules,0!=rules.length))for(var t=0;t<rules.length;t++){var r=rules[t],l=this.selectFeatures(r.filter);this.drawFeatures(l,r.symbolizer)}},load:function(){var e=this.map.viewer;if(null!=e&&null!=this.viewer&&e.equal(this.viewer)&&this.flag==GeoBeans.Layer.Flag.LOADED)return this.flag=GeoBeans.Layer.Flag.LOADED,void this.drawClickLayer();this.viewer=new GeoBeans.Envelope(e.xmin,e.ymin,e.xmax,e.ymax),this.renderer.clearRect();var t=new GeoBeans.BBoxFilter(this.featureType.geomFieldName,this.viewer),r=this.selectFeaturesByFilter(t,this.features);console.log("count:"+r.length),this.drawLayerFeatures(r),this.drawClickLayer(),this.flag=GeoBeans.Layer.Flag.LOADED},drawLayerFeatures:function(e){var t=this.style;if(null==t){if(t=this.getDefaultStyle(),null==t)return;this.style=t}if(rules=t.rules,0!=rules.length)for(var r=0;r<rules.length;r++){var l=rules[r],a=this.selectFeaturesByFilter(l.filter,e);null!=l.symbolizer&&(null!=l.symbolizer.symbol?this.renderer.drawIcons(a,l.symbolizer,this.map.transformation):this.drawFeatures(a,l.symbolizer)),null!=l.textSymbolizer&&this.labelFeatures(a,l.textSymbolizer)}},drawLayer:function(){var e=this.style;if(null==e){if(e=this.getDefaultStyle(),null==e)return;this.style=e}if(rules=e.rules,0!=rules.length){for(var t=0;t<rules.length;t++){var r=rules[t],l=this.selectFeaturesByFilter(r.filter,this.features);null!=r.symbolizer&&(null!=r.symbolizer.symbol?this.renderer.drawIcons(l,r.symbolizer,this.map.transformation):this.drawFeatures(l,r.symbolizer)),null!=r.textSymbolizer&&this.labelFeatures(l,r.textSymbolizer)}this.drawClickLayer()}},getGeomType:function(){var e=this.featureType;if(null==e)return null;var t=e.geomFieldName;if(null==t)return null;var r=e.getFieldIndex(t);if(null==r)return null;var l=e.fields[r];if(null==l)return null;var a=l.geomType;return a},getDefaultStyle:function(){var e=this.getGeomType(),t=null;switch(e){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.Point);var r=new GeoBeans.Rule,l=new GeoBeans.Symbolizer.PointSymbolizer;r.symbolizer=l,t.addRule(r);break;case GeoBeans.Geometry.Type.LINESTRING:case GeoBeans.Geometry.Type.MULTILINESTRING:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.LineString);var r=new GeoBeans.Rule,l=new GeoBeans.Symbolizer.LineSymbolizer;r.symbolizer=l,t.addRule(r);break;case GeoBeans.Geometry.Type.POLYGON:case GeoBeans.Geometry.Type.MULTIPOLYGON:t=new GeoBeans.Style.FeatureStyle("default",GeoBeans.Style.FeatureStyle.GeomType.Polygon);var r=new GeoBeans.Rule,l=new GeoBeans.Symbolizer.PolygonSymbolizer;r.symbolizer=l,t.addRule(r)}return t},drawFeatures:function(e,t){if(0!=e.length){this.renderer.save(),this.renderer.setSymbolizer(t);for(var r=0,l=e.length;l>r;r++)feature=e[r],null!=t&&"undefined"!=t&&this.renderer.draw(feature,t,this.map.transformation);this.renderer.restore()}},labelFeatures:function(e,t){var r=e.length;if(0!=r){this.renderer.save(),this.renderer.setSymbolizer(t);var l=e[0],a=null,n=t.labelText;if(null==n||0==n.length){var i=t.labelProp;if(null!=i)var s=l.featureType.getFieldIndex(i)}else a=n;for(var u=null,o=null,h=null,f=0,r=e.length;r>f;f++)l=e[f],o=l.geometry,null!=o&&(h=new GeoBeans.PointLabel,h.geometry=o,h.textSymbolizer=t,u=null==a?l.values[s]:a,h.text=u,h.computePosition(this.renderer,this.map.transformation),this.renderer.drawLabel(h));this.renderer.restore()}},drawFeature:function(e,t){for(var r=this.selectRules(e),l=r.length,a=0;l>a;a++){var n=r[a];if((null==t||"undefined"==t)&&(t=n.symbolizer),this.map.renderer.save(),this.map.renderer.setSymbolizer(t),t instanceof GeoBeans.Symbolizer.TextSymbolizer){var i=e.featureType.getFieldIndex(t.field);this.map.renderer.label(e.geometry,e.values[i],t,this.map.transformation)}else this.map.renderer.draw(e,t,this.map.transformation);this.map.renderer.restore()}r=null},clearFeature:function(e){switch(e.geometry.type){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:var t=this.getSymbolizer(e);this.map.renderer.clear(e.geometry,this.map.bgColor,t.size,this.map.transformation);break;default:this.map.renderer.clear(e.geometry,this.map.bgColor,0,this.map.transformation)}},selectFeatures:function(e){if(null==e)return this.features;var t=e.type;if(t==GeoBeans.Filter.Type.FilterComparsion){var r=null,l=null,a=e.expression1;null!=a&&(a.type==GeoBeans.Expression.Type.PropertyName?r=a.name:a.type==GeoBeans.Expression.Type.Literal&&(l=a.value));var n=e.expression2;null!=n&&(n.type==GeoBeans.Expression.Type.PropertyName?r=n.name:n.type==GeoBeans.Expression.Type.Literal&&(l=n.value))}if(null==r||null==l)return this.features;var i=[],s=this.featureType.getFieldIndex(r);if(s>=0)for(var u=null,o=this.features.length,h=0;o>h;++h)u=this.features[h],fvalue=u.values[s],fvalue==l&&i.push(u);return i},selectFeaturesByFilter:function(e,t,r,l){if(null==e)return t;var a=e.type,n=t;switch(a){case GeoBeans.Filter.Type.FilterID:n=this.selectFeaturesByIDFilter(e,t,r,l);break;case GeoBeans.Filter.Type.FilterComparsion:n=this.selectFeaturesByComparsion(e,t,r,l);break;case GeoBeans.Filter.Type.FilterLogic:break;case GeoBeans.Filter.Type.FilterSpatial:n=this.selectFeaturesBySpatial(e,t,r,l)}return n},selectFeaturesByIDFilter:function(e){if(null==e)return this.features;var t=e.ids;if(null==t)return this.features;for(var r=[],l=0;l<this.features.length;++l){var a=this.features[l],n=a.fid;-1!=t.indexOf(n)&&r.push(a)}return r},selectFeaturesByComparsion:function(e,t,r,l){if(null==e)return t;var a=null;null!=r&&(a=r),null!=l&&(a+=l);var n=e.operator,i=[],s=null,u=null,o=e.expression1;null!=o&&(o.type==GeoBeans.Expression.Type.PropertyName?s=o.name:o.type==GeoBeans.Expression.Type.Literal&&(u=o.value));var h=e.expression2;switch(null!=h&&(h.type==GeoBeans.Expression.Type.PropertyName?s=h.name:h.type==GeoBeans.Expression.Type.Literal&&(u=h.value)),n){case GeoBeans.ComparisionFilter.OperatorType.ComOprEqual:if(null==s||null==u){i=t;break}var f=this.featureType.getFieldIndex(s);if(-1==f){i=t;break}for(var c=null,y=null,p=0;p<t.length&&(c=t[p],y=c.values[f],y==u&&i.push(c),null==a||i.length!=a);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprNotEqual:if(null==s||null==u){i=t;break}var f=this.featureType.getFieldIndex(s);if(-1==f){i=t;break}for(var c=null,y=null,p=0;p<t.length&&(c=t[p],y=c.values[f],y!=u&&i.push(c),null==a||i.length!=a);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprLessThan:if(null==s||null==u){i=t;break}var f=this.featureType.getFieldIndex(s);if(-1==f){i=t;break}for(var c=null,y=null,p=0;p<t.length&&(c=t[p],y=c.values[f],u>y&&i.push(c),null==a||i.length!=a);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprGreaterThan:if(null==s||null==u){i=t;break}var f=this.featureType.getFieldIndex(s);if(-1==f){i=t;break}for(var c=null,y=null,p=0;p<t.length&&(c=t[p],y=c.values[f],y>u&&i.push(c),null==a||i.length!=a);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprLessThanOrEqual:if(null==s||null==u){i=t;break}var f=this.featureType.getFieldIndex(s);if(-1==f){i=t;break}for(var c=null,y=null,p=0;p<t.length&&(c=t[p],y=c.values[f],u>=y&&i.push(c),null==a||i.length!=a);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprGreaterThanOrEqual:if(null==s||null==u){i=t;break}var f=this.featureType.getFieldIndex(s);if(-1==f){i=t;break}for(var c=null,y=null,p=0;p<t.length&&(c=t[p],y=c.values[f],y>=u&&i.push(c),null==a||i.length!=a);++p);break;case GeoBeans.ComparisionFilter.OperatorType.ComOprIsLike:break;case GeoBeans.ComparisionFilter.OperatorType.ComOprIsNull:break;case GeoBeans.ComparisionFilter.OperatorType.ComOprIsBetween:var m=e.expression,v=e.lowerBound,d=e.upperBound,s=m.name,g=v.value,b=d.value;if(null==s||null==g||null==b){i=t;break}var f=this.featureType.getFieldIndex(s);if(-1==f){i=t;break}for(var c=null,y=null,p=0;p<t.length&&(c=t[p],y=c.values[f],y>=g&&b>=y&&i.push(c),null==a||i.length!=a);++p);}var T=null;return T=null!=r&&null!=l?i.slice(l,a):null!=r&&null==l?i.slice(0,r):null==r&&null!=l?i.slice(l):i},selectRules:function(e){var t=[];if(null!=this.style)for(var r=this.style.rules.length,l=0;r>l;l++){var a=this.style.rules[l];if(null!=a.filter){var n=a.filter.field,i=null,s=this.featureType.getFieldIndex(n);i=e.values[s],i==a.filter.value&&t.push(a)}else t.push(a)}return t},getSymbolizer:function(e){for(var t=this.selectRules(e),r=t.length,l=0;r>l;l++){var a=t[l],n=a.symbolizer;if(!(n instanceof GeoBeans.Style.TextSymbolizer))return n}return null},selectFeaturesBySpatial:function(e,t,r,l){if(null==e)return t;var a=e.operator,n=t;switch(a){case GeoBeans.SpatialFilter.OperatorType.SpOprBBox:n=this.selectFeaturesByBBoxFilter(e,t,r,l)}return n},selectFeaturesByBBoxFilter:function(e,t,r,l){if(null==e)return t;var a=e.extent,n=(this.getGeomType(),[]),i=null;null!=r&&(i=r),null!=l&&(i+=l);for(var s=0;s<t.length;++s){var u=t[s],o=u.geometry,h=o.extent;if((a.intersects(h)||a.containOther(h))&&n.push(u),null!=i&&n.length==i)break}var f=null;return f=null!=r&&null!=l?n.slice(l,i):null!=r&&null==l?n.slice(0,r):null==r&&null!=l?n.slice(l):n},getFeatureBBoxGet:function(e,t,r){var l=new GeoBeans.BBoxFilter(this.featureType.geomFieldName,e);return this.selectFeaturesByFilter(l,this.features,t,r)},setHitControl:function(e){null!=e&&"undefined"!=e&&(this.hitControl=null,this.hitControl=e)},init:function(){},enableHit:function(e){this.enableHit=e},hit:function(e,t,r){if(null!=this.features){this.map.renderer,this.map.transformation;this.selection=[];var l=0,a=null,n=null,i=this.features.length;for(l=0;i>l;l++)a=this.features[l],n=a.geometry,null!=n&&n.hit(e,t,this.map.tolerance)&&this.selection.push(a);if(this.hitRenderer.clearRect(0,0,this.hitCanvas.height,this.hitCanvas.width),this.map.drawLayersAll(),void 0!=r){var s=new GeoBeans.Geometry.Point(e,t);r(this,this.selection,s)}}},registerHitEvent:function(e){var t=this.map,r=this,l=null,a=null,n=10;this.hitCanvas=document.createElement("canvas"),this.hitCanvas.width=this.canvas.width,this.hitCanvas.height=this.canvas.height,this.hitRenderer=new GeoBeans.Renderer(this.hitCanvas),this.hitEvent=function(i){if(null==l)l=i.layerX,a=i.layerY;else{var s=Math.abs(i.layerX-l)+Math.abs(i.layerY-a);if(s>n){l=i.layerX,a=i.layerY;var u=t.transformation.toMapPoint(i.layerX,i.layerY);r.hit(u.x,u.y,e)}}},t.mapDiv[0].addEventListener("mousemove",this.hitEvent),this.events.addEvent("mousemove",this.hitEvent)},unRegisterHitEvent:function(){this.map.mapDiv[0].removeEventListener("mousemove",this.hitEvent),this.hitRenderer.clearRect(0,0,this.hitCanvas.height,this.hitCanvas.width),this.map.drawLayersAll(),this.hitEvent=null},drawHitFeature:function(e,t){for(var r=this.selectRules(e),l=r.length,a=0;l>a;a++){var n=r[a];if((null==t||"undefined"==t)&&(t=n.symbolizer),this.hitRenderer.save(),this.hitRenderer.setSymbolizer(t),t instanceof GeoBeans.Symbolizer.TextSymbolizer){var i=e.featureType.getFieldIndex(t.field);this.hitRenderer.label(e.geometry,e.values[i],t,this.map.transformation)}else this.hitRenderer.draw(e,t,this.map.transformation);this.hitRenderer.restore()}r=null,this.map.drawLayersAll()},cleanup:function(){this.enableHit=!1,this.map.canvas.removeEventListener("mousemove",this.hitEvent),this.map.canvas.removeEventListener("mousemove",this.hitTooltipEvent)},registerHitTooltipEvent:function(e){var t=this.map,r=this,l=null,a=null,n=10;this.hitTooltipEvent=function(t){if(null==l)l=t.layerX,a=t.layerY;else{var i=Math.abs(t.layerX-l)+Math.abs(t.layerY-a);i>n&&(l=t.layerX,a=t.layerY,r.hitTooltip(t.layerX,t.layerY,e))}},t.canvas.addEventListener("mousemove",this.hitTooltipEvent)},unregisterHitTooltipEvent:function(){this.map.canvas.removeEventListener("mousemove",this.hitTooltipEvent),this.hitTooltipEvent=null},hitTooltip:function(e,t,r){if(null!=this.features&&null!=r){var l=this.map,a=l.transformation.toMapPoint(e,t),n=a.x,i=a.y,s=(this.map.renderer,this.map.transformation,0),u=null,o=null,h=this.features.length;for(s=0;h>s;s++)if(u=this.features[s],o=u.geometry,null!=o&&o.hit(n,i,this.map.tolerance))return void r(this,n,i,u);r(this,n,i,null)}},getBufferTracker:function(){if(null==this.bufferTracker){var e=new GeoBeans.Control.TrackBufferControl,t=this.map.controls.find(e.type);-1==t?(this.bufferTracker=e,this.map.controls.add(this.bufferTracker)):this.bufferTracker=this.map.controls.get(t)}return this.bufferTracker},queryByBufferLine:function(e,t){var r=this.getBufferTracker();r.trackBufferLine(this,e,t,this.callbackQueryByBufferTrack)},queryByBufferCircle:function(e){var t=this.getBufferTracker();t.trackBufferCircle(this,e,this.callbackQueryByBufferTrack)},callbackQueryByBufferTrack:function(e,t,r,l){if(!(null==r||0>t)){var a=e.featureType;if(null!=a){var n=e.workspace;null!=n&&n.queryByBuffer(t,r,a,l)}}},drawBufferFeatures:function(e,t){this.bufferFeatures=e,this.bufferSymbolizer=t,this.drawBufferFeaturesCanvas(),this.map.drawLayersAll()},clearBufferFeatures:function(){this.bufferFeatures=null,this.drawBufferFeaturesCanvas(),this.map.drawLayersAll()},drawBufferFeaturesCanvas:function(){if(null==this.bufferCanvas&&(this.bufferCanvas=document.createElement("canvas"),this.bufferCanvas.width=this.canvas.width,this.bufferCanvas.height=this.canvas.height,this.bufferRenderer=new GeoBeans.Renderer(this.bufferCanvas)),this.bufferRenderer.clearRect(0,0,this.bufferCanvas.width,this.bufferCanvas.height),null!=this.bufferFeatures&&0!=this.bufferFeatures.length){this.bufferRenderer.save(),this.bufferRenderer.setSymbolizer(this.bufferSymbolizer);for(var e=0,t=this.bufferFeatures.length;t>e;e++)feature=this.bufferFeatures[e],null!=this.bufferSymbolizer&&"undefined"!=this.bufferSymbolizer&&this.bufferRenderer.draw(feature,this.bufferSymbolizer,this.map.transformation);this.bufferRenderer.restore()}},beginTransaction:function(e){var t=this.featureType.getFieldIndex(this.featureType.geomFieldName),r=this.featureType.fields[t],l=r.geomType,a=this.getTransactionTracker();switch(l){case GeoBeans.Geometry.Type.POINT:a.trackPoint(this.transactionCallback,e,this);break;case GeoBeans.Geometry.Type.LINESTRING:a.trackLine(this.transactionCallback,e,this,!1);break;case GeoBeans.Geometry.Type.MULTILINESTRING:a.trackLine(this.transactionCallback,e,this,!0);break;case GeoBeans.Geometry.Type.POLYGON:a.trackPolygon(this.transactionCallback,e,this,!1);break;case GeoBeans.Geometry.Type.MULTIPOLYGON:a.trackPolygon(this.transactionCallback,e,this,!0)}},transactionCallback:function(e,t,r){t(e,r)},transaction:function(e,t,r){this.workspace.transaction(this.featureType,e,t,r)},getTransactionTracker:function(){var e=null,t=this.map.controls.find(GeoBeans.Control.Type.TRACKTRANSACTION);return-1==t?(e=new GeoBeans.Control.TrackControl.TrackTransactionControl,this.map.controls.add(e)):e=this.map.controls.get(t),e},CLASS_NAME:"GeoBeans.Layer.FeatureLayer",registerClickEvent:function(e,t){var r=this.map,l=this;null!=e&&(this.clickStyle=e),this.clickEvent=function(e){var a=l.map.controls.find(GeoBeans.Control.Type.DRAG_MAP),n=l.map.controls.get(a);if(n.draging)return void console.log("draging");l.clickRenderer.clearRect(),l.map.drawLayersAll();var i=r.transformation.toMapPoint(e.layerX,e.layerY);l.clickHit(i.x,i.y,t)},r.canvas.addEventListener("mouseup",this.clickEvent)},clickHit:function(e,t,r){if(null==this.features)return void(null!=r&&r(null));var l=[],a=0,n=null,i=null,s=this.features.length;for(a=0;s>a;a++)n=this.features[a],i=n.geometry,null!=i&&i.hit(e,t,this.map.tolerance)&&l.push(n);if(0==l.length)return this.clickFeature=null,void(null!=r&&r(null));for(var u=l[0],o=u.geometry,h=this.getDistance(e,t,o),a=1;a<l.length;++a){var n=l[a],i=n.geometry,f=this.getDistance(e,t,i);h>f&&(u=n)}null!=r&&(this.clickFeature=u,this.map.drawLayersAll(),r(u))},getDistance:function(e,t,r){var l=this.getGeomType(),a=null;switch(l){case GeoBeans.Geometry.Type.POINT:case GeoBeans.Geometry.Type.MULTIPOINT:r.getCentroid();a=GeoBeans.Utility.getDistance(e,t,r.x,r.y);break;case GeoBeans.Geometry.Type.LINESTRING:case GeoBeans.Geometry.Type.MULTILINESTRING:a=r.distance(e,t);break;case GeoBeans.Geometry.Type.POLYGON:case GeoBeans.Geometry.Type.MULTIPOLYGON:r.getCentroid();a=GeoBeans.Utility.getDistance(e,t,r.x,r.y)}return a},unRegisterClickEvent:function(){this.map.canvas.removeEventListener("mouseup",this.clickEvent),this.clickEvent=null,this.clickRenderer.clearRect(),this.clickFeature=null,this.map.drawLayersAll()},drawClickLayer:function(){if(this.clickRenderer.clearRect(),null!=this.clickFeature){var e=this.clickStyle;if(null==e&&(e=this.getDefaultStyle()),null!=e){var t=e.rules;if(0!=t.length)for(var r=0;r<t.length;r++){var l=t[r],a=this.selectFeaturesByFilter(l.filter,[this.clickFeature]);null!=l.symbolizer&&(null!=l.symbolizer.symbol?this.clickRenderer.drawIcons(a,l.symbolizer,this.map.transformation):this.drawClickFeatures(a,l.symbolizer)),null!=l.textSymbolizer&&this.labelClickFeatures(a,l.textSymbolizer)}}}},drawClickFeatures:function(e,t){if(null!=e){this.clickRenderer.save(),this.clickRenderer.setSymbolizer(t);for(var r=0,l=e.length;l>r;r++)feature=e[r],null!=t&&"undefined"!=t&&this.clickRenderer.draw(feature,t,this.map.transformation);this.clickRenderer.restore()}},labelClickFeatures:function(e,t){var r=e.length;if(0!=r){this.clickRenderer.save(),this.clickRenderer.setSymbolizer(t);var l=e[0],a=null,n=t.labelText;if(null==n||0==n.length){var i=t.labelProp;if(null!=i)var s=l.featureType.getFieldIndex(i)}else a=n;for(var u=null,o=null,h=null,f=0,r=e.length;r>f;f++)l=e[f],o=l.geometry,null!=o&&(h=new GeoBeans.PointLabel,h.geometry=o,h.textSymbolizer=t,u=null==a?l.values[s]:a,h.text=u,h.computePosition(this.clickRenderer,this.map.transformation),this.clickRenderer.drawLabel(h));this.clickRenderer.restore()}},getFeatureValue:function(e,t){return null!=e?e.getValue(t):void 0},setFeatureValue:function(e,t,r){null!=e&&(e.setValue(t,r),this.flag=GeoBeans.Layer.Flag.READY)},getFeatureFilter:function(e,t,r,l,a){var n=new Date,i=this.selectFeaturesByFilter(e,this.features,t,r),s=new Date-n;console.log("select feature:"+s),this.map.queryLayer.setFeatures(i),this.map.drawLayersAll(),a(i)}});
GeoBeans.Layer.ChartLayer=GeoBeans.Class(GeoBeans.Layer.FeatureLayer,{baseLayerName:null,baseLayerField:null,dbName:null,tableName:null,tableField:null,chartFields:null,chartFeatureType:null,type:null,chartFeatures:null,initialize:function(e,t,a,i,r,n,s){GeoBeans.Layer.FeatureLayer.prototype.initialize.apply(this,arguments),this.baseLayerName=t,this.baseLayerField=a,this.dbName=i,this.tableName=r,this.tableField=n,this.chartFields=s},destroy:function(){this.cleanup()},cleanup:function(){this.removeLegend(),this.name=null,this.baseLayerName=null,this.baseLayerField=null,this.dbName=null,this.tableName=null,this.tableField=null,this.chartFields=null,this.map._removeLegend(this.legendIndex)},setFeatureType:function(e){this.featureType=e},setFeatures:function(e){this.features=e},setMap:function(e){GeoBeans.Layer.prototype.setMap.apply(this,arguments);var t=this.getChartFeatures();null!=t&&(this.chartFeatures=t);var a=this.getBaseLayerExtent();null!=a&&(this.extent=a)},getBaseLayerExtent:function(){var e=this.map.getLayer(this.baseLayerName);if(null!=e){var t=e.getExtent();return t}return null},getChartFeatures:function(){if(null==this.baseLayerName||null==this.baseLayerField||null==this.dbName||null==this.tableName||null==this.tableField)return null;var e=this.map.getLayer(this.baseLayerName);if(null==e)return null;var t=new GeoBeans.WFSWorkspace("tmp",this.map.server,"1.0.0"),a=new GeoBeans.FeatureType(t,this.tableName);this.chartFeatureType=a;var i=(a.getFields(null,this.dbName),a.getFeaturesFilter(null,this.dbName,null,null,null,[this.tableField].concat(this.chartFields))),r=a.getFieldIndex(this.tableField);if(-1==r)return null;var n=e.getFeatureType(),s=n.geomFieldName,l=null;l=this.type==GeoBeans.Layer.ChartLayer.Type.BAR||this.type==GeoBeans.Layer.ChartLayer.Type.PIE||this.type==GeoBeans.Layer.ChartLayer.Type.SYMBOL||this.type==GeoBeans.Layer.ChartLayer.Type.RING?[this.baseLayerField,s]:[this.baseLayerField];var h=n.getFeaturesFilter(this.map.name,null,null,null,null,l),u=(e.getFields(),n.getFieldIndex(this.baseLayerField));if(-1==u)return null;var d=this.getValidChartFeatures(i,r,h,u);return d},getValidChartFeatures:function(e,t,a,i){if(null==e||null==t||null==a||null==i)return null;for(var r=[],n=0;n<e.length;++n){var s=e[n];if(null!=s){var l=s.values;if(null!=l){var h=l[t];if(null!=h)for(var u=0;u<a.length;++u){var d=a[u];if(null!=d){var y=d.values;if(null!=y){var o=y[i];if(null!=o&&o==h){s.geometry=d.geometry,s.gid=d.fid,r.push(s);break}}}}}}}return r},setBaseLayer:function(e){this.baseLayerName=e,this.chartFeatures=this.getChartFeatures()},getBaseLayer:function(){return this.baseLayerName},setBaseLayerField:function(e){this.baseLayerField=e,this.chartFeatures=this.getChartFeatures()},getBaseLayerField:function(){return this.baseLayerField},setDbName:function(e){this.dbName=e,this.chartFeatures=this.getChartFeatures()},getDbName:function(){return this.dbName},setTableName:function(e){this.tableName=e,this.chartFeatures=this.getChartFeatures()},getTableName:function(){return this.tableName},setTableField:function(e){this.tableField=e,this.chartFeatures=this.getChartFeatures()},getTableField:function(){return this.tableField},setChartFields:function(e){this.chartFields=e,this.chartFeatures=this.getChartFeatures()},getChartFields:function(){return this.chartFields},setChartOption:function(e){this.chartOption=e},getChartOption:function(){return this.chartOption},addLegend:function(){},showLegend:function(){this.map.mapDiv.find(".chart-legend#"+this.name).css("display","block")},hideLegend:function(){this.map.mapDiv.find(".chart-legend#"+this.name).css("display","none")},removeLegend:function(){this.map.mapDiv.find(".chart-legend#"+this.name).remove()},setName:function(e){this.removeLegend(),this.name=e,this.addLegend()}}),GeoBeans.Layer.ChartLayer.Type={RANGE:"range",BAR:"bar",PIE:"pie",AQI:"aqi",AQITIMELINE:"aqi_timeline",SYMBOL:"symbol",RANGESYMBOL:"rangesymbol",RING:"ring"};
...
GeoBeans.Layer.BaiduLayer=GeoBeans.Class(GeoBeans.Layer.TileLayer,{BMP_URL:"/bmap/tile/?qt=tile&scaler=1&styles=pl",ORIGIN:{x:0,y:0},FULL_EXTENT:{xmin:-33554432,ymin:-33554432,xmax:33554432,ymax:33554432},IMG_WIDTH:256,IMG_HEIGHT:256,MIN_ZOOM_LEVEL:3,MAX_ZOOM_LEVEL:19,RESOLUTIONS:[131072,65536,32768,16384,8192,4096,2048,1024,512,256,128,64,32,16,8,4,2,1,.5],initialize:function(t){GeoBeans.Layer.TileLayer.prototype.initialize.apply(this,arguments)},destory:function(){GeoBeans.Layer.TileLayerLayer.prototype.destroy.apply(this,arguments)},computeTileBound:function(){var t=this.map,i=(t.level,t.resolution),e=i*this.IMG_WIDTH,a=this.getValidView(),l=Math.floor((a.xmin-0)/e),s=Math.ceil((a.xmax-0)/e),r=Math.floor(a.ymin/e),o=Math.ceil(a.ymax/e);return{rmin:r,rmax:o,cmin:l,cmax:s}},updateTileCache:function(t){var i,e,a,l,s=t.rmin,r=t.rmax,o=t.cmin,n=t.cmax,h=null,m=this.map.level;for(a=s;r>a;a++)for(l=o;n>l;l++)i="x="+l+"&y="+a+"&z="+m,e=this.BMP_URL+"&"+i,null==this.cache.getTile(e)&&(h=new GeoBeans.Tile(this.map,e,this,l,a,m,0,0),this.cache.putTile(h))},draw:function(){var t=this.computeTileBound();this.updateTileCache(t);var i=t.rmin,e=t.rmax,a=t.cmin,l=t.cmax,s=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymax);s.x=Math.floor(s.x+.5),s.y=Math.floor(s.y+.5);var r,o,n,h,m,T=this.IMG_WIDTH*this.scale,c=this.map.level;for(o=s.y+i*T,n=i;e>n;n++){for(r=s.x+a*T,h=a;l>h;h++)tid=this.getTileID(n,h,c),turl=this.BMP_URL+"&"+tid,m=this.cache.getTile(turl),null!=m&&m.draw(r,o,T,T),r+=T;o+=T}},drawCache:function(){var t=this.computeTileBound(),i=t.rmin,e=t.rmax,a=t.cmin,l=t.cmax,s=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymax);s.x=Math.floor(s.x+.5),s.y=Math.floor(s.y+.5);var r,o,n,h,m,T=this.IMG_WIDTH*this.scale,c=this.map.level;for(o=s.y+i*T,n=i;e>n;n++){for(r=s.x+a*T,h=a;l>h;h++)tid=this.getTileID(n,h,c),turl=this.BMP_URL+"&"+tid,m=this.cache.getTile(turl),null!=m&&m.draw(r,o,T,T),r+=T;o+=T}},preDraw:function(){var t=this.computeTileBound();this.updateTileCache(t);var i=t.rmin,e=t.rmax,a=t.cmin,l=t.cmax,s=this.map.resolution,r=s*this.IMG_WIDTH,o=Math.floor(this.FULL_EXTENT.ymax/r),n=Math.floor(this.FULL_EXTENT.xmin/r),h=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymax);h.x=Math.floor(h.x+.5),h.y=Math.floor(h.y+.5);var m,T,c,u,x,L=this.IMG_WIDTH*this.scale;this.tiles=[];var y=this.map.level;for(T=h.y+(o-e)*L,c=e-1;c>=i;c--){for(m=h.x+(a-n)*L,u=a;l>u;u++){tid=this.getTileID(c,u,y),turl=this.BMP_URL+"&"+tid,x=this.cache.getTile(turl);var f=new Object;f.tile=x,f.img_size=L,f.x=m,f.y=T,this.tiles.push(f),console.log(tid+":x:"+f.x+",y:"+f.y),m+=L}T+=L}},loadingTiles:function(t){for(var i=0;i<this.tiles.length;++i){var e=this.tiles[i].tile;if(null!=e)if(e.state!=GeoBeans.TileState.LOADED)e.loading(t,this.loadTileCallback,this.tiles,i),this.state=GeoBeans.TileLayerState.LOADING;else if(e.state==GeoBeans.TileState.LOADED){var a=this.tiles[i],l=a.img_size,s=a.x,r=a.y;e.draw(s,r,l,l)}}for(var i=0;i<this.tiles.length;++i){var o=this.tiles[i];if(o.tile.state!=GeoBeans.TileState.LOADED)return}t(this.map)},loadTileCallback:function(t,i,e,a){var l=e[a],s=l.img_size,r=l.x,o=l.y;t.draw(r,o,s,s);for(var n=0;n<e.length;++n){var h=e[n];if(h.tile.state!=GeoBeans.TileState.LOADED)return}i(t.map)},getTileID:function(t,i,e){return"x="+i+"&y="+t+"&z="+e}});

GeoBeans.Layer.QSLayer=GeoBeans.Class(GeoBeans.Layer.TileLayer,{AMP_URL:"/QuadServer/maprequest?services=world_image",IMG_WIDTH:256,IMG_HEIGHT:256,MIN_ZOOM_LEVEL:2,MAX_ZOOM_LEVEL:17,FULL_EXTENT:{xmin:-256,ymin:-256,xmax:256,ymax:256},RESOLUTIONS:[1,.5,.25,.125,.0625,.03125,.015625,.0078125,.00390625,.001953125,976563e-9,488281e-9,244141e-9,12207e-8,6103515625e-14,30517578125e-15,152587890625e-16,762939453125e-17,3814697265625e-18,19073486328125e-19],resolution:null,rows:null,cols:null,offset_x:0,offset_y:0,lrow:0,urow:0,lcol:0,rcol:0,initialize:function(e,t){GeoBeans.Layer.TileLayer.prototype.initialize.apply(this,arguments),this.type=GeoBeans.Layer.TileLayer.Type.QS},destroy:function(){GeoBeans.Layer.TileLayer.prototype.destroy.apply(this,arguments)},updateTileCache:function(e){var t,i,a,l,s=e.rmin,r=e.rmax,n=e.cmin,o=e.cmax,h=null,m=this.map.level;for(a=s;r>a;a++)for(l=n;o>l;l++)t=this.getTileID(a,l,m),i=this.url+"&"+t,null==this.cache.getTile(i)&&(h=new GeoBeans.Tile(this.map,i,this,a,l,m,0,0),this.cache.putTile(h))},preDraw:function(){var e=this.map.level,t=this.getMaxLevel(),i=this.getMinLevel();if(e>t||i>e)return this.tiles=[],this.renderer.clearRect(),void(this.snap=null);var a=this.computeTileBound();this.updateTileCache(a);var l=a.rmin,s=a.rmax,r=a.cmin,n=a.cmax,o=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymin);o.x=Math.floor(o.x+.5),o.y=Math.floor(o.y+.5);var h,m,c,u,T,f=this.IMG_WIDTH*this.imageScale;this.map.transformation.toMapPoint(o.x,o.y);this.tiles=[];var e=this.map.level;for(m=o.y-(l+1)*f,c=l;s>c;c++){for(h=o.x+r*f,u=r;n>u;u++){tid=this.getTileID(c,u,e),turl=this.url+"&"+tid,T=this.cache.getTile(turl);var y=new Object;y.tile=T,y.img_size=f,y.x=h,y.y=m,this.tiles.push(y),h+=f}m-=f}},loadingTiles:function(e){for(var t=0;t<this.tiles.length;++t){var i=this.tiles[t].tile;if(null!=i)if(i.state!=GeoBeans.TileState.LOADED)i.loading(e,this.loadTileCallback,this.tiles,t),this.state=GeoBeans.TileLayerState.LOADING;else if(i.state==GeoBeans.TileState.LOADED){var a=this.tiles[t],l=a.img_size,s=a.x,r=a.y;i.draw(s,r,l,l)}}},loadTileCallback:function(e,t,i,a){var l=i[a],s=l.img_size,r=l.x,n=l.y;e.draw(r,n,s,s)},draw:function(){for(var e=0;e<this.tilesLoaded.length;++e){var t=this.tilesLoaded[e],i=t.tile,a=t.img_size,l=t.x,s=t.y;null!=i&&i.draw(l,s,a,a)}},drawCache:function(){var e=this.computeTileBound(),t=e.rmin,i=e.rmax,a=e.cmin,l=e.cmax,s=this.map.transformation.toScreenPoint(this.FULL_EXTENT.xmin,this.FULL_EXTENT.ymin);s.x=Math.floor(s.x+.5),s.y=Math.floor(s.y+.5);var r,n,o,h,m,c=this.IMG_WIDTH*this.scale,u=this.map.level;for(n=s.y-(t+1)*c,o=t;i>o;o++){for(r=s.x+a*c,h=a;l>h;h++)tid=this.getTileID(o,h,u),turl=this.url+"&"+tid,m=this.cache.getTile(turl),null!=m&&m.draw(r,n,c,c),r+=c;n-=c}},getRows:function(){},getCols:function(){},computeExtent:function(){},computeCenterTileOffset:function(){var e=this.map.center,t=(e.x-this.ORIGIN.x,e.y-this.ORIGIN.y,Math.floor((e.x-this.ORIGIN.x)/this.resolution)),i=Math.floor((e.y-this.ORIGIN.y)/this.resolution);offset_x=t,offset_y=i},getTileID:function(e,t,i){return"col="+t+"&row="+e+"&level="+i},computeTileBound:function(){var e=this.map,t=e.level,i=this.getResolutionByLevel(t),a=i*this.IMG_WIDTH,l=this.getValidView(),s=Math.floor((l.xmin-this.FULL_EXTENT.xmin)/a),r=Math.ceil((l.xmax-this.FULL_EXTENT.xmin)/a),n=Math.floor((l.ymin-this.FULL_EXTENT.ymin)/a),o=Math.ceil((l.ymax-this.FULL_EXTENT.ymin)/a);return{rmin:n-1,rmax:o+1,cmin:s-1,cmax:r+1}}});
