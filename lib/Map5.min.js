...
GeoBeans.Layer.SymbolChartLayer=GeoBeans.Class(GeoBeans.Layer.ChartLayer,{chartOption:null,levelMap:null,legendPadding:4,maxSymbolRadius:30,minMax:null,initialize:function(e,t,l,a,i,n,r,s){GeoBeans.Layer.ChartLayer.prototype.initialize.apply(this,arguments),this.type=GeoBeans.Layer.ChartLayer.Type.SYMBOL,this.chartOption=s},setMap:function(e){GeoBeans.Layer.ChartLayer.prototype.setMap.apply(this,arguments),this.registerHitEvent(this.onFeatureHit)},cleanup:function(){this.chartOption=null,this.levelMap=null,this.minMax=null},load:function(){null==this.features&&(this.features=this.chartFeatures),this.renderer.clearRect(),this.drawLayer(),this.removeLegend(),this.addLegend(),this.visible?this.showLegend():this.hideLegend(),this.flag=GeoBeans.Layer.Flag.LOADED},getStyle:function(){var e=new GeoBeans.Style.FeatureStyle("symbol",GeoBeans.Style.FeatureStyle.GeomType.Polygon),t=[],l=new GeoBeans.Rule,a=new GeoBeans.Symbolizer.PolygonSymbolizer,i=this.chartOption.color;return null!=i&&(a.fill.color=this.chartOption.color),l.symbolizer=a,t.push(l),e.rules=t,e},getSymbolizer:function(){var e=new GeoBeans.Symbolizer.PolygonSymbolizer,t=this.chartOption.color;null!=t&&e.fill.color.setByHex(t,1);var l=this.chartOption.opacity;null!=l?e.fill.color.setOpacity(l):e.fill.color.setOpacity(1);var a=this.chartOption.border;null!=a&&e.stroke.color.setByHex(a,1);var i=this.chartOption.borderOpacity;return null!=i?e.stroke.color.setOpacity(i):e.stroke.color.setOpacity(1),e},drawLayer:function(){if(null!=this.chartOption){var e=this.chartOption.byLevel;e?this.drawLayerByLevel():this.drawLayerByValue()}},drawLayerByLevel:function(){if(null!=this.chartOption){var e=this.chartOption.level,t=this.getMinMaxValue();this.minMax=t;var l=t.min,a=t.max,i=this.chartOption.maxsize,n=(this.chartFields[0],this.chartFeatureType),r=n.getFieldIndex(this.chartFields),s=this.getSymbolizer();this.renderer.setSymbolizer(s);var h=null,o=null,u=null,d=null,c=null,m=null,v=this.getLevelMap(i,e,l,a);this.levelMap=v;for(var y=0;y<this.chartFeatures.length;++y)h=this.chartFeatures[y],null!=h&&(o=h.values,null!=o&&(u=o[r],null!=u&&(d=h.geometry,c=this.getRadiusByLevelMap(parseFloat(u),v),console.log(c),m=new GeoBeans.Geometry.Circle(d,c),h.circle=m,this.renderer.drawGeometry(m,s,this.map.transformation))))}},drawLayerByValue:function(){var e=this.getMinMaxValue();this.minMax=e;var t=(e.min,e.max),l=(this.chartFields[0],this.chartFeatureType),a=l.getFieldIndex(this.chartFields),i=this.getSymbolizer();this.renderer.setSymbolizer(i);for(var n=null,r=null,s=null,h=null,o=null,u=null,d=0;d<this.chartFeatures.length;++d)n=this.chartFeatures[d],null!=n&&(r=n.values,null!=r&&(s=r[a],null!=s&&(h=n.geometry,o=parseFloat(s)/t*this.chartOption.maxsize,u=new GeoBeans.Geometry.Circle(h,o),n.circle=u,this.renderer.drawGeometry(u,i,this.map.transformation))))},getMinMaxValue:function(){if(null==this.chartFeatures)return null;for(var e=null,t=(this.chartFields[0],this.chartFeatureType),l=t.getFieldIndex(this.chartFields[0]),a=null,i=null,n=null,r=null,s=0;s<this.chartFeatures.length;++s)e=this.chartFeatures[s],null!=e&&(a=e.values,null!=a&&(r=a[l],null!=r&&(r=parseFloat(r),i=null==i?r:i>r?r:i,n=null==n?r:r>n?r:n)));return{min:i,max:n}},getLevelMap:function(e,t,l,a){if(null!=e&&null!=t&&null!=l&&null!=a){for(var i=(a-l)/t,n=[],r=0;t>r;++r){var s=l+r*i,h=l+(r+1)*i,o=Math.pow(1.2,r+1-t)*e,u={min:s,max:h,radius:o};n.push(u)}return n}},getRadiusByLevelMap:function(e,t){if(null==e||null==t)return null;for(var l=null,a=null,i=null,n=0;n<t.length;++n)if(l=t[n],null!=l){if(a=l.min,i=l.max,0==n&&e==a)return l.radius;if(e>a&&i>=e)return l.radius}return null},addLegend:function(){if(null!=this.chartOption){var e=this.chartOption.byLevel;e?this.addLegendByLevel():this.addLegendByValue()}},addLegendByLevel:function(){if(null!=this.chartOption){var e=this.chartOption.maxsize,t=(this.chartOption.level,2*this.maxSymbolRadius),l=this.getLegendCanvasHeightByLevel(this.levelMap,this.maxSymbolRadius,e);if(null!=l){var a="<div class='chart-legend chart-symbol-legend' id='"+this.name+"'>";a+='<div class="chart-legend-title"><h5>'+this.name+"</h5></div>",a+="<div class='chart-legend-canvas'><canvas width='"+t+"' height='"+l+"'></canvas></div>",a+="<div class='chart-legend-value' style='font-size:12px;ling-height:12px'></div>",a+="</div>",this.map.mapDiv.append(a);var i="",n=this.map.mapDiv.find("#"+this.name+" canvas"),r=new GeoBeans.Renderer(n[0]),s=this.getSymbolizer();r.setSymbolizer(s);for(var h=r.context,o=0,u=null,d=null,c=null,m=null,v=null,y=null,p=0,g=null,f=0;f<this.levelMap.length;++f)if(u=this.levelMap[f],null!=u){m=u.min,v=u.max,m=m.toFixed(2),v=v.toFixed(2),y=m+"~"+v,d=u.radius,c=d/e*this.maxSymbolRadius,o+=c,null==g&&(g=-8.495),p=o-g-16.99,g=o,i+="<div class='chart-legend-label' style='padding-top:"+p+"px'>"+y+"</div>";var x=new GeoBeans.Geometry.Point(this.maxSymbolRadius,o);o+=c+this.legendPadding,h.beginPath(),h.arc(x.x,x.y,c,0,2*Math.PI,!0),null!=s.fill&&h.fill(),null!=s.stroke&&h.stroke(),h.closePath()}this.map.mapDiv.find("#"+this.name+".chart-legend .chart-legend-value").html(i)}}},getLegendCanvasHeightByLevel:function(e,t,l){if(null==e||null==t||null==l)return null;for(var a=0,i=null,n=null,r=e.length-1;r>=0;--r)if(i=e[r],null!=i){n=i.radius;var s=n/l*t;a+=2*s+this.legendPadding}return a=Math.ceil(a)},addLegendByValue:function(){if(null!=this.chartOption){var e=this.minMax;if(null!=e){var t=e.min,l=e.max,a=(this.chartOption.maxsize,t/l*this.maxSymbolRadius),i=a;8.5>a&&(i=8.5);var n=2*this.maxSymbolRadius,r=2*(this.maxSymbolRadius+i)+this.legendPadding,s="<div class='chart-legend chart-symbol-legend' id='"+this.name+"'>";s+='<div class="chart-legend-title"><h5>'+this.name+"</h5></div>",s+="<div class='chart-legend-canvas'><canvas width='"+n+"' height='"+r+"'></canvas></div>",s+="<div class='chart-legend-value' style='font-size:12px;ling-height:12px'></div>",s+="</div>",this.map.mapDiv.append(s);var h=this.map.mapDiv.find("#"+this.name+" canvas"),o=new GeoBeans.Renderer(h[0]),u=this.getSymbolizer();o.setSymbolizer(u);var d=o.context,c=new GeoBeans.Geometry.Point(this.maxSymbolRadius,i);d.beginPath(),d.arc(c.x,c.y,a,0,2*Math.PI,!0),null!=u.fill&&d.fill(),null!=u.stroke&&d.stroke(),d.closePath(),d.beginPath();var m=this.maxSymbolRadius+2*i+this.legendPadding,v=new GeoBeans.Geometry.Point(this.maxSymbolRadius,m);d.arc(v.x,v.y,this.maxSymbolRadius,0,2*Math.PI,!0),null!=u.fill&&d.fill(),null!=u.stroke&&d.stroke(),d.closePath();var y="",p=i-8.5,g=v.y-c.y-16.99;y+="<div class='chart-legend-label' style='padding-top:"+p+"px'>"+t+"</div>",y+="<div class='chart-legend-label' style='padding-top:"+g+"px'>"+l+"</div>",this.map.mapDiv.find("#"+this.name+".chart-legend .chart-legend-value").html(y)}}},onFeatureHit:function(e,t,l){if(console.log(t.length),"pointer"==document.body.style.cursor)return void e.map.closeInfoWindow();if(0==t.length)e.map.closeInfoWindow();else{var a=t[0],i=(a.chartValue,e.chartFeatureType);if(null==i)return;var n=a.values;if(null==n)return;var r=i.getFieldIndex(e.chartFields[0]),s=n[r],h=i.getFieldIndex(e.tableField),o=n[h],u="<div>"+s+"</div>",d={title:o,width:100,height:40},c=new GeoBeans.InfoWindow(u,d),m=a.circle.center;e.map.openInfoWindow(c,m)}},hit:function(e,t,l){if(null!=this.chartFeatures){this.map.renderer,this.map.transformation;this.selection=[];var a=0,i=null,n=null,r=this.features.length;for(a=0;r>a;a++)i=this.features[a],n=i.circle,null!=n&&n.hit(e,t,this.map.tolerance)&&this.selection.push(i);if(this.hitRenderer.clearRect(0,0,this.hitCanvas.height,this.hitCanvas.width),this.map.drawLayersAll(),void 0!=l){var s=new GeoBeans.Geometry.Point(e,t);l(this,this.selection,s)}}}});
