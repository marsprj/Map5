...
GeoBeans.GeoJsonReader=GeoBeans.Class({initialize:function(){},read:function(n,e){this.layerName=n,this.load(e)},load:function(n){var e=this;$.ajax({url:n,dataType:"json",async:!1,beforeSend:function(n){},success:function(n,o){e.readJson(n)},complete:function(n,e){},error:function(n,e){console.log(e)}})},readJson:function(n){if(null==n)return null;var e=n.type;return console.log(e),null}});
